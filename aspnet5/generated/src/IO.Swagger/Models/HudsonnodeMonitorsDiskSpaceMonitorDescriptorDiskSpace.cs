...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace :  IEquatable<HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace>
    {
        ...
        public HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace(string Class = default(string), int? Timestamp = default(int?), string Path = default(string), int? Size = default(int?))
        {
            this.Class = Class;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace)obj);
        }
