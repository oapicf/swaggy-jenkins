...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/HudsonmodelAllView', 'model/HudsonmodelFreeStyleProject', 'model/JenkinsmodelUnlabeledLoadStatistics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HudsonmodelAllView'), require('./HudsonmodelFreeStyleProject'), require('./JenkinsmodelUnlabeledLoadStatistics'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.HudsonmodelHudson = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.HudsonmodelAllView, root.SwaggyJenkins.HudsonmodelFreeStyleProject, root.SwaggyJenkins.JenkinsmodelUnlabeledLoadStatistics);
  }
}(this, function(ApiClient, HudsonmodelAllView, HudsonmodelFreeStyleProject, JenkinsmodelUnlabeledLoadStatistics) {
  'use strict';
