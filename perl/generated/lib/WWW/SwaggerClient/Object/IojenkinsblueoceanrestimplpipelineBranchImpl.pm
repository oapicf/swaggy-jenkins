...
#
package WWW::SwaggerClient::Object::IojenkinsblueoceanrestimplpipelineBranchImpl;
...
__PACKAGE__->method_documentation({
    ...
    'parameters' => {
    	datatype => 'ARRAY[HudsonmodelStringParameterDefinition]',
    ...
    'permissions' => {
    	datatype => 'IojenkinsblueoceanrestimplpipelineBranchImplPermissions',
