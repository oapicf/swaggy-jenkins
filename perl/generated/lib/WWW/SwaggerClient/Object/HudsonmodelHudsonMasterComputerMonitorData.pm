...
#
package WWW::SwaggerClient::Object::HudsonmodelHudsonMasterComputerMonitorData;
...
__PACKAGE__->method_documentation({
    'hudson/node_monitors/swap_space_monitor' => {
    	datatype => 'HudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2',
    ...
    'hudson/node_monitors/temporary_space_monitor' => {
    	datatype => 'HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace',
    ...
    'hudson/node_monitors/response_time_monitor' => {
    	datatype => 'HudsonnodeMonitorsResponseTimeMonitorData',
    ...
    'hudson/node_monitors/clock_monitor' => {
    	datatype => 'HudsonutilClockDifference',
...
__PACKAGE__->swagger_types( {
    'hudson/node_monitors/swap_space_monitor' => 'HudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2',
    'hudson/node_monitors/temporary_space_monitor' => 'HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace',
    'hudson/node_monitors/disk_space_monitor' => 'HudsonnodeMonitorsDiskSpaceMonitorDescriptorDiskSpace',
    'hudson/node_monitors/architecture_monitor' => 'string',
    'hudson/node_monitors/response_time_monitor' => 'HudsonnodeMonitorsResponseTimeMonitorData',
    'hudson/node_monitors/clock_monitor' => 'HudsonutilClockDifference',
    '_class' => 'string'
} );
