...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SwaggyjenkinsPipelineRunartifacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SwaggyjenkinsPipelineRunartifacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.SwaggyjenkinsPipelineRun = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.SwaggyjenkinsPipelineRunartifacts);
  }
}(this, function(ApiClient, SwaggyjenkinsPipelineRunartifacts) {
  'use strict';
  ...
  /**
   * The SwaggyjenkinsPipelineRun model module.
   * @module model/SwaggyjenkinsPipelineRun
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>SwaggyjenkinsPipelineRun</code>.
   * @alias module:model/SwaggyjenkinsPipelineRun
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggyjenkinsPipelineRun</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggyjenkinsPipelineRun} obj Optional instance to populate.
   * @return {module:model/SwaggyjenkinsPipelineRun} The populated <code>SwaggyjenkinsPipelineRun</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('artifacts')) {
        obj['artifacts'] = ApiClient.convertToType(data['artifacts'], [SwaggyjenkinsPipelineRunartifacts]);
      }
  ...
  /**
   * @member {Array.<module:model/SwaggyjenkinsPipelineRunartifacts>} artifacts
   */
