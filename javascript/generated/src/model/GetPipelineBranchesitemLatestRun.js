...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggyJenkins.GetPipelineBranchesitemLatestRun = factory(root.SwaggyJenkins.ApiClient);
  }
  ...
  /**
   * The GetPipelineBranchesitemLatestRun model module.
   * @module model/GetPipelineBranchesitemLatestRun
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>GetPipelineBranchesitemLatestRun</code>.
   * @alias module:model/GetPipelineBranchesitemLatestRun
   * @class
   */
  ...
  /**
   * Constructs a <code>GetPipelineBranchesitemLatestRun</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPipelineBranchesitemLatestRun} obj Optional instance to populate.
   * @return {module:model/GetPipelineBranchesitemLatestRun} The populated <code>GetPipelineBranchesitemLatestRun</code> instance.
   */
