...
/*
 * SWGSwaggyjenkinsPipeline_latestRun.h
 * 
 * 
 */

#ifndef SWGSwaggyjenkinsPipeline_latestRun_H_
#define SWGSwaggyjenkinsPipeline_latestRun_H_
...
class SWGSwaggyjenkinsPipeline_latestRun: public SWGObject {
public:
    SWGSwaggyjenkinsPipeline_latestRun();
    SWGSwaggyjenkinsPipeline_latestRun(QString* json);
    virtual ~SWGSwaggyjenkinsPipeline_latestRun();
    void init();
    void cleanup();
    ...
    SWGSwaggyjenkinsPipeline_latestRun* fromJson(QString &jsonString);

    QList<SWGSwaggyjenkinsPipeline_latestRunartifacts*>* getArtifacts();
    void setArtifacts(QList<SWGSwaggyjenkinsPipeline_latestRunartifacts*>* artifacts);
...
private:
    QList<SWGSwaggyjenkinsPipeline_latestRunartifacts*>* artifacts;
...
#endif /* SWGSwaggyjenkinsPipeline_latestRun_H_ */
