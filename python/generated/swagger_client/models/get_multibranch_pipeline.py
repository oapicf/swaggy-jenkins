...
class GetMultibranchPipeline(object):
    """
    ...
    def __init__(self, display_name=None, estimated_duration_in_millis=None, latest_run=None, name=None, organization=None, weather_score=None, branch_names=None, number_of_failing_branches=None, number_of_failing_pull_requests=None, number_of_successful_branches=None, number_of_successful_pull_requests=None, total_number_of_branches=None, total_number_of_pull_requests=None, source_path=None, _class=None):
        """
    ...
    def source_path(self):
        """
        Gets the source_path of this GetMultibranchPipeline.

        :return: The source_path of this GetMultibranchPipeline.
        :rtype: str
        """
    ...
    def source_path(self, source_path):
        """
        Sets the source_path of this GetMultibranchPipeline.

        :param source_path: The source_path of this GetMultibranchPipeline.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, GetMultibranchPipeline):
            return False
