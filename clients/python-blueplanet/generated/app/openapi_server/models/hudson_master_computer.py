...
from app.openapi_server.models.hudson_master_computerexecutors import HudsonMasterComputerexecutors  # noqa: F401,E501
from app.openapi_server.models.hudson_master_computermonitor_data import HudsonMasterComputermonitorData  # noqa: F401,E501
from app.openapi_server.models.label1 import Label1  # noqa: F401,E501
...
class HudsonMasterComputer(Model):
    ...
    def __init__(self, _class: str=None, display_name: str=None, executors: List[HudsonMasterComputerexecutors]=None, icon: str=None, icon_class_name: str=None, idle: bool=None, jnlp_agent: bool=None, launch_supported: bool=None, load_statistics: Label1=None, manual_launch_allowed: bool=None, monitor_data: HudsonMasterComputermonitorData=None, num_executors: int=None, offline: bool=None, offline_cause: str=None, offline_cause_reason: str=None, temporarily_offline: bool=None):  # noqa: E501
