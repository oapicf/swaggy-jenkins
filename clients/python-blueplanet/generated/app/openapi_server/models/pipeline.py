...
from app.openapi_server.models.pipelinelatest_run import PipelinelatestRun  # noqa: F401,E501
...
class Pipeline(Model):
    ...
    def __init__(self, _class: str=None, organization: str=None, name: str=None, display_name: str=None, full_name: str=None, weather_score: int=None, estimated_duration_in_millis: int=None, latest_run: PipelinelatestRun=None):  # noqa: E501
