...
path = path.Replace("{" + "queue" + "}", ApiClient.ParameterToString(queue));
 ...
 if (maxExpiryTimeInMins != null) queryParams.Add("maxExpiryTimeInMins", ApiClient.ParameterToString(maxExpiryTimeInMins)); // query parameter
        ...
        public Organisations GetOrganisations ()
        {
            ...
            return (Organisations) ApiClient.Deserialize(response.Content, typeof(Organisations), response.Headers);
        }
...
path = path.Replace("{" + "pipeline" + "}", ApiClient.ParameterToString(pipeline));
            ...
            return (PipelineActivities) ApiClient.Deserialize(response.Content, typeof(PipelineActivities), response.Headers);
        }
...
path = path.Replace("{" + "pipeline" + "}", ApiClient.ParameterToString(pipeline));
            ...
            return (PipelineQueue) ApiClient.Deserialize(response.Content, typeof(PipelineQueue), response.Headers);
        }
...
path = path.Replace("{" + "node" + "}", ApiClient.ParameterToString(node));
            ...
            return (PipelineRunNodeSteps) ApiClient.Deserialize(response.Content, typeof(PipelineRunNodeSteps), response.Headers);
        }
...
path = path.Replace("{" + "run" + "}", ApiClient.ParameterToString(run));
            ...
            return (PipelineRunNodes) ApiClient.Deserialize(response.Content, typeof(PipelineRunNodes), response.Headers);
        }
...
path = path.Replace("{" + "pipeline" + "}", ApiClient.ParameterToString(pipeline));
            ...
            return (PipelineRuns) ApiClient.Deserialize(response.Content, typeof(PipelineRuns), response.Headers);
        }
        ...
        public Pipelines GetPipelines (string organization)
        {
            ...
            return (Pipelines) ApiClient.Deserialize(response.Content, typeof(Pipelines), response.Headers);
        }
...
path = path.Replace("{" + "scm" + "}", ApiClient.ParameterToString(scm));
        ...
        /// <param name="pageNumber">Page number</param> 
        /// <returns>ScmOrganisations</returns>            
        public ScmOrganisations GetSCMOrganisationRepositories (string organization, string scm, string scmOrganisation, string credentialId, int? pageSize, int? pageNumber)
        {
...
path = path.Replace("{" + "scmOrganisation" + "}", ApiClient.ParameterToString(scmOrganisation));
 ...
 if (pageNumber != null) queryParams.Add("pageNumber", ApiClient.ParameterToString(pageNumber)); // query parameter
            ...
            return (ScmOrganisations) ApiClient.Deserialize(response.Content, typeof(ScmOrganisations), response.Headers);
        }
...
path = path.Replace("{" + "user" + "}", ApiClient.ParameterToString(user));
        ...
        public UserFavorites GetUserFavorites (string user)
        {
            ...
            return (UserFavorites) ApiClient.Deserialize(response.Content, typeof(UserFavorites), response.Headers);
        }
