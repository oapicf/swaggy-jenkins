...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IBaseRemoteAccessApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class BaseRemoteAccessApi : IBaseRemoteAccessApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseRemoteAccessApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public BaseRemoteAccessApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public BaseRemoteAccessApi(String basePath)
        {
