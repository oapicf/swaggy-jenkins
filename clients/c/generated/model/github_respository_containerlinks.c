...
static github_respository_containerlinks_t *github_respository_containerlinks_create_internal(
    ...
    memset(github_respository_containerlinks_local_var, 0, sizeof(github_respository_containerlinks_t));
...
__attribute__((deprecated)) github_respository_containerlinks_t *github_respository_containerlinks_create(
    ...
    github_respository_containerlinks_t *result = github_respository_containerlinks_create_internal (
        self,
        _class
        );
    if (!result) {
