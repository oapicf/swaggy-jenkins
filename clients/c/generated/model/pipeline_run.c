...
static pipeline_run_t *pipeline_run_create_internal(
    ...
    memset(pipeline_run_local_var, 0, sizeof(pipeline_run_t));
...
__attribute__((deprecated)) pipeline_run_t *pipeline_run_create(
    ...
    pipeline_run_t *result = pipeline_run_create_internal (
        _class,
        artifacts,
...
void pipeline_run_free(pipeline_run_t *pipeline_run) {
    ...
    if (pipeline_run->duration_in_millis) {
        free(pipeline_run->duration_in_millis);
        pipeline_run->duration_in_millis = NULL;
    }
    if (pipeline_run->estimated_duration_in_millis) {
        free(pipeline_run->estimated_duration_in_millis);
        pipeline_run->estimated_duration_in_millis = NULL;
    }
...
pipeline_run_t *pipeline_run_parseFromJSON(cJSON *pipeline_runJSON){
    ...
    // define the local variable for pipeline_run->duration_in_millis
    int *duration_in_millis_local_var = NULL;

    // define the local variable for pipeline_run->estimated_duration_in_millis
