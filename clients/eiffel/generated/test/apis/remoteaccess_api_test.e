...
feature -- Test routines
    ...
    test_post_create_item
        ...
        do
            ...
            -- api.post_create_item(l_name, l_var_from, l_mode, l_body, l_jenkins__crumb, l_content__type)
            assert ("not_implemented", False)
        end
    ...
    test_post_create_view
        ...
        do
            ...
            -- api.post_create_view(l_name, l_body, l_jenkins__crumb, l_content__type)
            assert ("not_implemented", False)
        end
