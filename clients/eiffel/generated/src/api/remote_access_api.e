...
feature -- API Access
	...
	post_create_item (name: STRING_32; var_from: detachable STRING_32; mode: detachable STRING_32; body: detachable STRING_32; jenkins__crumb: detachable STRING_32; content__type: detachable STRING_32)
			...
			-- 
			-- argument: var_from Existing job to copy from (optional)
			-- 
			-- argument: mode Set to &#39;copy&#39; for copying an existing job (optional)
			-- 
			-- argument: body Job configuration in config.xml format (optional)
			-- 
			-- argument: jenkins__crumb CSRF protection token (optional)
			-- 
			-- argument: content__type Content type header application/xml (optional)
			-- 
			-- 
		local
  			l_path: STRING
