...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {HTTP_BASIC_AUTH}, "jenkins_auth")
			is_basic_auth_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("header", "Authorization"), "jwt_auth")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "http://localhost"
			-- default base path.
