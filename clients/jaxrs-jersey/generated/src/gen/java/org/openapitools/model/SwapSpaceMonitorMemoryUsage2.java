...
public class SwapSpaceMonitorMemoryUsage2   {
   ...
   **/
  @JsonProperty(value = "availablePhysicalMemory")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "availableSwapSpace")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "totalPhysicalMemory")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "totalSwapSpace")
  @ApiModelProperty(value = "")
