...
public class ComputerApiTest {
    ...
    @Test
    public void getComputerTestJson() throws Exception {
        String contentType = "application/json";
        String accept = "application/json";
        String url = API_URL + "/computer/api/json";
        HttpRequest httpRequest = Unirest.get(url);
        httpRequest = httpRequest.header("Accept", accept);
        httpRequest = httpRequest.queryString("depth", "1");
    ...
    @Test
    public void getComputerTestXml() throws Exception {
