...
public class CrumbIssuerApiTest {
    private static final String API_URL = "http://127.0.0.1:8080/api/v1";

    @Test
    public void getCrumbTestJson() throws Exception {
        String contentType = "application/json";
        String accept = "application/json";
        String url = API_URL + "/crumbIssuer/api/json";
    ...
    @Test
    public void getCrumbTestXml() throws Exception {
