...
OAIFreeStyleProjecthealthReport::OAIFreeStyleProjecthealthReport(const QString &json) {
...
void OAIFreeStyleProjecthealthReport::fromJson(const QString &jsonString) {
