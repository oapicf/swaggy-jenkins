...
OAIDefaultCrumbIssuer::OAIDefaultCrumbIssuer(const QString &json) {
...
void OAIDefaultCrumbIssuer::fromJson(const QString &jsonString) {
...
void OAIDefaultCrumbIssuer::fromJsonObject(QJsonObject json) {
    ...
    m_crumb_isValid = ::OpenAPI::fromJsonValue(m_crumb, json[QString("crumb")]);
    m_crumb_isSet = !json[QString("crumb")].isNull() && m_crumb_isValid;

    m_crumb_request_field_isValid = ::OpenAPI::fromJsonValue(m_crumb_request_field, json[QString("crumbRequestField")]);
...
QJsonObject OAIDefaultCrumbIssuer::asJsonObject() const {
    ...
    if (m_crumb_isSet) {
        obj.insert(QString("crumb"), ::OpenAPI::toJsonValue(m_crumb));
    }
    if (m_crumb_request_field_isSet) {
        obj.insert(QString("crumbRequestField"), ::OpenAPI::toJsonValue(m_crumb_request_field));
    }
    return obj;
}
...
QString OAIDefaultCrumbIssuer::getCrumbRequestField() const {
    return m_crumb_request_field;
}
void OAIDefaultCrumbIssuer::setCrumbRequestField(const QString &crumb_request_field) {
    m_crumb_request_field = crumb_request_field;
    m_crumb_request_field_isSet = true;
}
