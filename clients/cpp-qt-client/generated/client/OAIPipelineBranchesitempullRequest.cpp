...
OAIPipelineBranchesitempullRequest::OAIPipelineBranchesitempullRequest(const QString &json) {
...
void OAIPipelineBranchesitempullRequest::fromJson(const QString &jsonString) {
