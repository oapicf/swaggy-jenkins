...
OAISwapSpaceMonitorMemoryUsage2::OAISwapSpaceMonitorMemoryUsage2(const QString &json) {
...
void OAISwapSpaceMonitorMemoryUsage2::fromJson(const QString &jsonString) {
...
void OAISwapSpaceMonitorMemoryUsage2::fromJsonObject(QJsonObject json) {
    ...
    m_available_physical_memory_isValid = ::OpenAPI::fromJsonValue(m_available_physical_memory, json[QString("availablePhysicalMemory")]);
    m_available_physical_memory_isSet = !json[QString("availablePhysicalMemory")].isNull() && m_available_physical_memory_isValid;

    m_available_swap_space_isValid = ::OpenAPI::fromJsonValue(m_available_swap_space, json[QString("availableSwapSpace")]);
    m_available_swap_space_isSet = !json[QString("availableSwapSpace")].isNull() && m_available_swap_space_isValid;

    m_total_physical_memory_isValid = ::OpenAPI::fromJsonValue(m_total_physical_memory, json[QString("totalPhysicalMemory")]);
    m_total_physical_memory_isSet = !json[QString("totalPhysicalMemory")].isNull() && m_total_physical_memory_isValid;

    m_total_swap_space_isValid = ::OpenAPI::fromJsonValue(m_total_swap_space, json[QString("totalSwapSpace")]);
...
QJsonObject OAISwapSpaceMonitorMemoryUsage2::asJsonObject() const {
    ...
    if (m_available_physical_memory_isSet) {
        obj.insert(QString("availablePhysicalMemory"), ::OpenAPI::toJsonValue(m_available_physical_memory));
    }
    if (m_available_swap_space_isSet) {
        obj.insert(QString("availableSwapSpace"), ::OpenAPI::toJsonValue(m_available_swap_space));
    }
    if (m_total_physical_memory_isSet) {
        obj.insert(QString("totalPhysicalMemory"), ::OpenAPI::toJsonValue(m_total_physical_memory));
    }
    if (m_total_swap_space_isSet) {
        obj.insert(QString("totalSwapSpace"), ::OpenAPI::toJsonValue(m_total_swap_space));
    }
    return obj;
}
...
qint32 OAISwapSpaceMonitorMemoryUsage2::getAvailablePhysicalMemory() const {
    return m_available_physical_memory;
}
void OAISwapSpaceMonitorMemoryUsage2::setAvailablePhysicalMemory(const qint32 &available_physical_memory) {
    m_available_physical_memory = available_physical_memory;
    m_available_physical_memory_isSet = true;
}
...
qint32 OAISwapSpaceMonitorMemoryUsage2::getAvailableSwapSpace() const {
    return m_available_swap_space;
}
void OAISwapSpaceMonitorMemoryUsage2::setAvailableSwapSpace(const qint32 &available_swap_space) {
    m_available_swap_space = available_swap_space;
    m_available_swap_space_isSet = true;
}
...
qint32 OAISwapSpaceMonitorMemoryUsage2::getTotalPhysicalMemory() const {
    return m_total_physical_memory;
}
void OAISwapSpaceMonitorMemoryUsage2::setTotalPhysicalMemory(const qint32 &total_physical_memory) {
    m_total_physical_memory = total_physical_memory;
    m_total_physical_memory_isSet = true;
}
...
qint32 OAISwapSpaceMonitorMemoryUsage2::getTotalSwapSpace() const {
    return m_total_swap_space;
}
void OAISwapSpaceMonitorMemoryUsage2::setTotalSwapSpace(const qint32 &total_swap_space) {
    m_total_swap_space = total_swap_space;
    m_total_swap_space_isSet = true;
}
