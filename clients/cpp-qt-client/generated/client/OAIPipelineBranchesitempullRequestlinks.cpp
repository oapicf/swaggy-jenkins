...
OAIPipelineBranchesitempullRequestlinks::OAIPipelineBranchesitempullRequestlinks(const QString &json) {
...
void OAIPipelineBranchesitempullRequestlinks::fromJson(const QString &jsonString) {
