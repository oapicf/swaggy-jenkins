...
OAIExtensionClassContainerImpl1map::OAIExtensionClassContainerImpl1map(const QString &json) {
...
void OAIExtensionClassContainerImpl1map::fromJson(const QString &jsonString) {
...
void OAIExtensionClassContainerImpl1map::fromJsonObject(QJsonObject json) {
    ...
    m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl_isValid = ::OpenAPI::fromJsonValue(m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl, json[QString("io.jenkins.blueocean.service.embedded.rest.PipelineImpl")]);
    ...
    m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl_isValid = ::OpenAPI::fromJsonValue(m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl, json[QString("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl")]);
...
QJsonObject OAIExtensionClassContainerImpl1map::asJsonObject() const {
    QJsonObject obj;
    if (m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl.isSet()) {
        obj.insert(QString("io.jenkins.blueocean.service.embedded.rest.PipelineImpl"), ::OpenAPI::toJsonValue(m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl));
    }
    if (m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl.isSet()) {
        obj.insert(QString("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"), ::OpenAPI::toJsonValue(m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl));
    }
    if (m__class_isSet) {
...
OAIExtensionClassImpl OAIExtensionClassContainerImpl1map::getIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl() const {
    return m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl;
}
void OAIExtensionClassContainerImpl1map::setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl(const OAIExtensionClassImpl &io_jenkins_blueocean_service_embedded_rest_pipeline_impl) {
    m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl = io_jenkins_blueocean_service_embedded_rest_pipeline_impl;
    m_io_jenkins_blueocean_service_embedded_rest_pipeline_impl_isSet = true;
}
...
OAIExtensionClassImpl OAIExtensionClassContainerImpl1map::getIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl() const {
    return m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl;
}
void OAIExtensionClassContainerImpl1map::setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl(const OAIExtensionClassImpl &io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl) {
    m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl = io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl;
    m_io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl_isSet = true;
}
