...
#ifndef OAIPipelineActivity_H
#define OAIPipelineActivity_H
...
class OAIPipelineActivity : public OAIObject {
public:
    OAIPipelineActivity();
    OAIPipelineActivity(const QString &json);
    ~OAIPipelineActivity() override;
    ...
    QList<OAIPipelineActivityartifacts> getArtifacts() const;
    void setArtifacts(const QList<OAIPipelineActivityartifacts> &artifacts);
...
private:
    ...
    QList<OAIPipelineActivityartifacts> m_artifacts;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPipelineActivity)

#endif // OAIPipelineActivity_H
