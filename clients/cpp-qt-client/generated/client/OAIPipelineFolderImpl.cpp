...
OAIPipelineFolderImpl::OAIPipelineFolderImpl(const QString &json) {
...
void OAIPipelineFolderImpl::fromJson(const QString &jsonString) {
...
void OAIPipelineFolderImpl::fromJsonObject(QJsonObject json) {
    ...
    m_number_of_folders_isValid = ::OpenAPI::fromJsonValue(m_number_of_folders, json[QString("numberOfFolders")]);
    m_number_of_folders_isSet = !json[QString("numberOfFolders")].isNull() && m_number_of_folders_isValid;

    m_number_of_pipelines_isValid = ::OpenAPI::fromJsonValue(m_number_of_pipelines, json[QString("numberOfPipelines")]);
...
QJsonObject OAIPipelineFolderImpl::asJsonObject() const {
    ...
    if (m_number_of_folders_isSet) {
        obj.insert(QString("numberOfFolders"), ::OpenAPI::toJsonValue(m_number_of_folders));
    }
    if (m_number_of_pipelines_isSet) {
        obj.insert(QString("numberOfPipelines"), ::OpenAPI::toJsonValue(m_number_of_pipelines));
    }
    return obj;
}
...
qint32 OAIPipelineFolderImpl::getNumberOfFolders() const {
    return m_number_of_folders;
}
void OAIPipelineFolderImpl::setNumberOfFolders(const qint32 &number_of_folders) {
    m_number_of_folders = number_of_folders;
    m_number_of_folders_isSet = true;
}
...
qint32 OAIPipelineFolderImpl::getNumberOfPipelines() const {
    return m_number_of_pipelines;
}
void OAIPipelineFolderImpl::setNumberOfPipelines(const qint32 &number_of_pipelines) {
    m_number_of_pipelines = number_of_pipelines;
    m_number_of_pipelines_isSet = true;
}
