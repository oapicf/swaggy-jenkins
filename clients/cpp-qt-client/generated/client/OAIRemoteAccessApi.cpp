...
void OAIRemoteAccessApi::getComputer(const qint32 &depth) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("depth")).append(querySuffix).append(QUrl::toPercentEncoding(depth));
    }
...
void OAIRemoteAccessApi::postJobBuild(const QString &name, const QString &json, const ::OpenAPI::OptionalParam<QString> &token, const ::OpenAPI::OptionalParam<QString> &jenkins_crumb) {
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("json")).append(querySuffix).append(QUrl::toPercentEncoding(json));
    }
    if (token.hasValue())
    {
        queryStyle = "form";
