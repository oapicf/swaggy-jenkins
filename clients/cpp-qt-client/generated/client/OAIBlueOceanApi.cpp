...
void OAIBlueOceanApi::getJsonWebToken(const ::OpenAPI::OptionalParam<qint32> &expiry_time_in_mins, const ::OpenAPI::OptionalParam<qint32> &max_expiry_time_in_mins) {
    ...
    if (expiry_time_in_mins.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("expiryTimeInMins")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(expiry_time_in_mins.stringValue())));
    }
    if (max_expiry_time_in_mins.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("maxExpiryTimeInMins")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(max_expiry_time_in_mins.stringValue())));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
...
void OAIBlueOceanApi::getPipelineRunLog(const QString &organization, const QString &pipeline, const QString &run, const ::OpenAPI::OptionalParam<qint32> &start, const ::OpenAPI::OptionalParam<bool> &download) {
    ...
    if (download.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("download")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(download.stringValue())));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
...
void OAIBlueOceanApi::getSCMOrganisationRepositories(const QString &organization, const QString &scm, const QString &scm_organisation, const ::OpenAPI::OptionalParam<QString> &credential_id, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page_number) {
    ...
    if (credential_id.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("credentialId")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(credential_id.stringValue())));
    }
    ...
    if (page_number.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("pageNumber")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(page_number.stringValue())));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
...
void OAIBlueOceanApi::putPipelineRun(const QString &organization, const QString &pipeline, const QString &run, const ::OpenAPI::OptionalParam<QString> &blocking, const ::OpenAPI::OptionalParam<qint32> &time_out_in_secs) {
    ...
    if (blocking.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("blocking")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(blocking.stringValue())));
    }
    if (time_out_in_secs.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("timeOutInSecs")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(time_out_in_secs.stringValue())));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
