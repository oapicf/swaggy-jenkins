...
OAIHudsonMasterComputerexecutors::OAIHudsonMasterComputerexecutors(const QString &json) {
...
void OAIHudsonMasterComputerexecutors::fromJson(const QString &jsonString) {
...
void OAIHudsonMasterComputerexecutors::fromJsonObject(QJsonObject json) {
    ...
    m_current_executable_isValid = ::OpenAPI::fromJsonValue(m_current_executable, json[QString("currentExecutable")]);
    ...
    m_likely_stuck_isValid = ::OpenAPI::fromJsonValue(m_likely_stuck, json[QString("likelyStuck")]);
...
QJsonObject OAIHudsonMasterComputerexecutors::asJsonObject() const {
    QJsonObject obj;
    if (m_current_executable.isSet()) {
        obj.insert(QString("currentExecutable"), ::OpenAPI::toJsonValue(m_current_executable));
    }
    if (m_idle_isSet) {
        obj.insert(QString("idle"), ::OpenAPI::toJsonValue(m_idle));
    }
    if (m_likely_stuck_isSet) {
        obj.insert(QString("likelyStuck"), ::OpenAPI::toJsonValue(m_likely_stuck));
    }
    if (m_number_isSet) {
