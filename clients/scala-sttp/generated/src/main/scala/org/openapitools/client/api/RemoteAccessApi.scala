...
): Request[Either[ResponseException[String, Exception], ComputerSet], Nothing] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], Hudson], Nothing] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], FreeStyleProject], Nothing] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], FreeStyleBuild], Nothing] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], Queue], Nothing] =
    basicRequest
...
): Request[Either[ResponseException[String, Exception], ListView], Nothing] =
    basicRequest
