...
class BlueOceanApi(baseUrl: String) {
   ...
   */
  def deletePipelineQueueItem(username: String, password: String)(organization: String, pipeline: String, queue: String): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param organization Name of the organization
   */
  def getAuthenticatedUser(username: String, password: String)(organization: String): Request[Either[ResponseException[String], User]] =
    basicRequest
   ...
   */
  def getClasses(username: String, password: String)(`class`: String): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   */
  def getJsonWebKey(key: Int): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   */
  def getJsonWebToken(expiryTimeInMins: Option[Int] = None, maxExpiryTimeInMins: Option[Int] = None): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   * @param organization Name of the organization
   */
  def getOrganisation(username: String, password: String)(organization: String): Request[Either[ResponseException[String], Organisation]] =
    basicRequest
   ...
   *   jenkins_auth (http)
   */
  def getOrganisations(username: String, password: String)(): Request[Either[ResponseException[String], Seq[Organisation]]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def getPipeline(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], Pipeline]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def getPipelineActivities(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], Seq[PipelineActivity]]] =
    basicRequest
   ...
   */
  def getPipelineBranch(username: String, password: String)(organization: String, pipeline: String, branch: String): Request[Either[ResponseException[String], BranchImpl]] =
    basicRequest
   ...
   */
  def getPipelineBranchRun(username: String, password: String)(organization: String, pipeline: String, branch: String, run: String): Request[Either[ResponseException[String], PipelineRun]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def getPipelineBranches(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], MultibranchPipeline]] =
    basicRequest
   ...
   */
  def getPipelineFolder(username: String, password: String)(organization: String, folder: String): Request[Either[ResponseException[String], PipelineFolderImpl]] =
    basicRequest
   ...
   * @param folder Name of the folder
   */
  def getPipelineFolderPipeline(username: String, password: String)(organization: String, pipeline: String, folder: String): Request[Either[ResponseException[String], PipelineImpl]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def getPipelineQueue(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], Seq[QueueItemImpl]]] =
    basicRequest
   ...
   * @param run Name of the run
   */
  def getPipelineRun(username: String, password: String)(organization: String, pipeline: String, run: String): Request[Either[ResponseException[String], PipelineRun]] =
    basicRequest
   ...
   */
  def getPipelineRunLog(username: String, password: String)(organization: String, pipeline: String, run: String, start: Option[Int] = None, download: Option[Boolean] = None): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   */
  def getPipelineRunNode(username: String, password: String)(organization: String, pipeline: String, run: String, node: String): Request[Either[ResponseException[String], PipelineRunNode]] =
    basicRequest
   ...
   */
  def getPipelineRunNodeStep(username: String, password: String)(organization: String, pipeline: String, run: String, node: String, step: String): Request[Either[ResponseException[String], PipelineStepImpl]] =
    basicRequest
   ...
   * @param step Name of the step
   */
  def getPipelineRunNodeStepLog(username: String, password: String)(organization: String, pipeline: String, run: String, node: String, step: String): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   * @param node Name of the node
   */
  def getPipelineRunNodeSteps(username: String, password: String)(organization: String, pipeline: String, run: String, node: String): Request[Either[ResponseException[String], Seq[PipelineStepImpl]]] =
    basicRequest
   ...
   * @param run Name of the run
   */
  def getPipelineRunNodes(username: String, password: String)(organization: String, pipeline: String, run: String): Request[Either[ResponseException[String], Seq[PipelineRunNode]]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def getPipelineRuns(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], Seq[PipelineRun]]] =
    basicRequest
   ...
   * @param organization Name of the organization
   */
  def getPipelines(username: String, password: String)(organization: String): Request[Either[ResponseException[String], Seq[Pipeline]]] =
    basicRequest
   ...
   */
  def getSCM(username: String, password: String)(organization: String, scm: String): Request[Either[ResponseException[String], GithubScm]] =
    basicRequest
   ...
   */
  def getSCMOrganisationRepositories(username: String, password: String)(organization: String, scm: String, scmOrganisation: String, credentialId: Option[String] = None, pageSize: Option[Int] = None, pageNumber: Option[Int] = None): Request[Either[ResponseException[String], Seq[GithubOrganization]]] =
    basicRequest
   ...
   * @param credentialId Credential ID
   */
  def getSCMOrganisationRepository(username: String, password: String)(organization: String, scm: String, scmOrganisation: String, repository: String, credentialId: Option[String] = None): Request[Either[ResponseException[String], Seq[GithubOrganization]]] =
    basicRequest
   ...
   * @param credentialId Credential ID
   */
  def getSCMOrganisations(username: String, password: String)(organization: String, scm: String, credentialId: Option[String] = None): Request[Either[ResponseException[String], Seq[GithubOrganization]]] =
    basicRequest
   ...
   */
  def getUser(username: String, password: String)(organization: String, user: String): Request[Either[ResponseException[String], User]] =
    basicRequest
   ...
   * @param user Name of the user
   */
  def getUserFavorites(username: String, password: String)(user: String): Request[Either[ResponseException[String], Seq[FavoriteImpl]]] =
    basicRequest
   ...
   * @param organization Name of the organization
   */
  def getUsers(username: String, password: String)(organization: String): Request[Either[ResponseException[String], User]] =
    basicRequest
   ...
   * @param run Name of the run
   */
  def postPipelineRun(username: String, password: String)(organization: String, pipeline: String, run: String): Request[Either[ResponseException[String], QueueItemImpl]] =
    basicRequest
   ...
   * @param pipeline Name of the pipeline
   */
  def postPipelineRuns(username: String, password: String)(organization: String, pipeline: String): Request[Either[ResponseException[String], QueueItemImpl]] =
    basicRequest
   ...
   */
  def putPipelineFavorite(username: String, password: String)(organization: String, pipeline: String, body: Boolean): Request[Either[ResponseException[String], FavoriteImpl]] =
    basicRequest
   ...
   */
  def putPipelineRun(username: String, password: String)(organization: String, pipeline: String, run: String, blocking: Option[String] = None, timeOutInSecs: Option[Int] = None): Request[Either[ResponseException[String], PipelineRun]] =
    basicRequest
   ...
   */
  def search(username: String, password: String)(`q`: String): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   */
  def searchClasses(username: String, password: String)(`q`: String): Request[Either[ResponseException[String], String]] =
    basicRequest
