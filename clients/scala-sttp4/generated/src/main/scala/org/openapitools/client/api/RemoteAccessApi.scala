...
class RemoteAccessApi(baseUrl: String) {
   ...
   */
  def getComputer(username: String, password: String)(depth: Int): Request[Either[ResponseException[String], ComputerSet]] =
    basicRequest
   ...
   *   jenkins_auth (http)
   */
  def getJenkins(username: String, password: String)(): Request[Either[ResponseException[String], Hudson]] =
    basicRequest
   ...
   */
  def getJob(username: String, password: String)(name: String): Request[Either[ResponseException[String], FreeStyleProject]] =
    basicRequest
   ...
   * @param name Name of the job
   */
  def getJobConfig(username: String, password: String)(name: String): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   * @param name Name of the job
   */
  def getJobLastBuild(username: String, password: String)(name: String): Request[Either[ResponseException[String], FreeStyleBuild]] =
    basicRequest
   ...
   */
  def getJobProgressiveText(username: String, password: String)(name: String, number: String, start: String): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   *   jenkins_auth (http)
   */
  def getQueue(username: String, password: String)(): Request[Either[ResponseException[String], Queue]] =
    basicRequest
   ...
   */
  def getQueueItem(username: String, password: String)(number: String): Request[Either[ResponseException[String], Queue]] =
    basicRequest
   ...
   */
  def getView(username: String, password: String)(name: String): Request[Either[ResponseException[String], ListView]] =
    basicRequest
   ...
   * @param name Name of the view
   */
  def getViewConfig(username: String, password: String)(name: String): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   *   jenkins_auth (http)
   */
  def headJenkins(username: String, password: String)(): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   */
  def postCreateItem(username: String, password: String)(name: String, from: Option[String] = None, mode: Option[String] = None, jenkinsCrumb: Option[String] = None, contentType: Option[String] = None, body: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   */
  def postCreateView(username: String, password: String)(name: String, jenkinsCrumb: Option[String] = None, contentType: Option[String] = None, body: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobBuild(username: String, password: String)(name: String, json: String, token: Option[String] = None, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobConfig(username: String, password: String)(name: String, body: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobDelete(username: String, password: String)(name: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobDisable(username: String, password: String)(name: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobEnable(username: String, password: String)(name: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postJobLastBuildStop(username: String, password: String)(name: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param jenkinsCrumb CSRF protection token
   */
  def postViewConfig(username: String, password: String)(name: String, body: String, jenkinsCrumb: Option[String] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
