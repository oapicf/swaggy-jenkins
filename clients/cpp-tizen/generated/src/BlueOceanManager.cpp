...
static bool getJsonWebKeyProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::string, Error, void* )
	= reinterpret_cast<void(*)(std::string, Error, void* )> (voidHandler);
...
static bool getJsonWebKeyHelper(char * accessToken,
	int key, 
	void(* handler)(std::string, Error, void* )
	, void* userData, bool isAsync)
{
	...
	url.insert(pos, stringify(&key, "int"));
	...
	if(!isAsync){
		...
		requestInfo = new(nothrow) RequestInfo (BlueOceanManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getJsonWebKeyProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool BlueOceanManager::getJsonWebKeyAsync(char * accessToken,
	int key, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
	return getJsonWebKeyHelper(accessToken,
	key, 
	handler, userData, true);
}

bool BlueOceanManager::getJsonWebKeySync(char * accessToken,
	int key, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
...
static bool getJsonWebTokenProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::string, Error, void* )
	= reinterpret_cast<void(*)(std::string, Error, void* )> (voidHandler);
...
static bool getJsonWebTokenHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	itemAtq = stringify(&expiryTimeInMins, "int");
	queryParams.insert(pair<string, string>("expiryTimeInMins", itemAtq));
	if( itemAtq.empty()==true){
		queryParams.erase("expiryTimeInMins");
	}


	itemAtq = stringify(&maxExpiryTimeInMins, "int");
	queryParams.insert(pair<string, string>("maxExpiryTimeInMins", itemAtq));
	if( itemAtq.empty()==true){
		queryParams.erase("maxExpiryTimeInMins");
	}
	...
	if(!isAsync){
		...
		requestInfo = new(nothrow) RequestInfo (BlueOceanManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), getJsonWebTokenProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool BlueOceanManager::getJsonWebTokenAsync(char * accessToken,
	int expiryTimeInMins, int maxExpiryTimeInMins, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
	return getJsonWebTokenHelper(accessToken,
	expiryTimeInMins, maxExpiryTimeInMins, 
	handler, userData, true);
}

bool BlueOceanManager::getJsonWebTokenSync(char * accessToken,
	int expiryTimeInMins, int maxExpiryTimeInMins, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
