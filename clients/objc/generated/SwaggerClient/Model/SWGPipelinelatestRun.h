...
@protocol SWGPipelinelatestRunartifacts;
@class SWGPipelinelatestRunartifacts;



@protocol SWGPipelinelatestRun
@end

@interface SWGPipelinelatestRun : SWGObject


@property(nonatomic) NSArray<SWGPipelinelatestRunartifacts>* artifacts;
