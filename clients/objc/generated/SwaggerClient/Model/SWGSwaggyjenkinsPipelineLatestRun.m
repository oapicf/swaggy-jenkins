...
@implementation SWGSwaggyjenkinsPipelineLatestRun
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"artifacts", @"durationInMillis", @"estimatedDurationInMillis", @"enQueueTime", @"endTime", @"_id", @"organization", @"pipeline", @"result", @"runSummary", @"startTime", @"state", @"type", @"commitId", @"class"];
