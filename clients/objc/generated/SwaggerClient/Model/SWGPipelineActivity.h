...
@protocol SWGPipelineActivityartifacts;
@class SWGPipelineActivityartifacts;



@protocol SWGPipelineActivity
@end

@interface SWGPipelineActivity : SWGObject


@property(nonatomic) NSString* class;

@property(nonatomic) NSArray<SWGPipelineActivityartifacts>* artifacts;
