...
@protocol SWGSwaggyjenkinsPipelineLatestRun
@end

@interface SWGSwaggyjenkinsPipelineLatestRun : SWGObject


@property(nonatomic) NSArray<SWGSwaggyjenkinsPipelineLatestRunartifacts>* artifacts;
