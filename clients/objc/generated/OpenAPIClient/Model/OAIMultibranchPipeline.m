...
@implementation OAIMultibranchPipeline
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"displayName", @"estimatedDurationInMillis", @"latestRun", @"name", @"organization", @"weatherScore", @"branchNames", @"numberOfFailingBranches", @"numberOfFailingPullRequests", @"numberOfSuccessfulBranches", @"numberOfSuccessfulPullRequests", @"totalNumberOfBranches", @"totalNumberOfPullRequests", @"_class"];
