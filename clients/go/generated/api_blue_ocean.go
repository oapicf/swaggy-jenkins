...
func (a *BlueOceanApiService) DeletePipelineQueueItemExecute(r ApiDeletePipelineQueueItemRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"pipeline"+"}", url.PathEscape(parameterToString(r.pipeline, "")), -1)
...
func (a *BlueOceanApiService) GetClassesExecute(r ApiGetClassesRequest) (string, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"class"+"}", url.PathEscape(parameterToString(r.class, "")), -1)
...
func (a *BlueOceanApiService) GetJsonWebTokenExecute(r ApiGetJsonWebTokenRequest) (string, *http.Response, error) {
	...
	if r.expiryTimeInMins != nil {
		localVarQueryParams.Add("expiryTimeInMins", parameterToString(*r.expiryTimeInMins, ""))
	}
	if r.maxExpiryTimeInMins != nil {
		localVarQueryParams.Add("maxExpiryTimeInMins", parameterToString(*r.maxExpiryTimeInMins, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *BlueOceanApiService) GetPipelineBranchRunExecute(r ApiGetPipelineBranchRunRequest) (*PipelineRun, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"pipeline"+"}", url.PathEscape(parameterToString(r.pipeline, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"branch"+"}", url.PathEscape(parameterToString(r.branch, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"run"+"}", url.PathEscape(parameterToString(r.run, "")), -1)
...
func (a *BlueOceanApiService) GetPipelineFolderExecute(r ApiGetPipelineFolderRequest) (*PipelineFolderImpl, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"organization"+"}", url.PathEscape(parameterToString(r.organization, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"folder"+"}", url.PathEscape(parameterToString(r.folder, "")), -1)
...
func (a *BlueOceanApiService) GetSCMExecute(r ApiGetSCMRequest) (*GithubScm, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"organization"+"}", url.PathEscape(parameterToString(r.organization, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"scm"+"}", url.PathEscape(parameterToString(r.scm, "")), -1)
...
func (a *BlueOceanApiService) GetSCMOrganisationRepositoriesExecute(r ApiGetSCMOrganisationRepositoriesRequest) ([]GithubOrganization, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"organization"+"}", url.PathEscape(parameterToString(r.organization, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"scm"+"}", url.PathEscape(parameterToString(r.scm, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"scmOrganisation"+"}", url.PathEscape(parameterToString(r.scmOrganisation, "")), -1)
...
func (a *BlueOceanApiService) GetSCMOrganisationRepositoryExecute(r ApiGetSCMOrganisationRepositoryRequest) ([]GithubOrganization, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"scm"+"}", url.PathEscape(parameterToString(r.scm, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"scmOrganisation"+"}", url.PathEscape(parameterToString(r.scmOrganisation, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repository"+"}", url.PathEscape(parameterToString(r.repository, "")), -1)
...
func (a *BlueOceanApiService) PutPipelineRunExecute(r ApiPutPipelineRunRequest) (*PipelineRun, *http.Response, error) {
	...
	if r.blocking != nil {
		localVarQueryParams.Add("blocking", parameterToString(*r.blocking, ""))
	}
	if r.timeOutInSecs != nil {
		localVarQueryParams.Add("timeOutInSecs", parameterToString(*r.timeOutInSecs, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
