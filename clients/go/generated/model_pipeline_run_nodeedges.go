...
// checks if the PipelineRunNodeedges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PipelineRunNodeedges{}
...
func (o PipelineRunNodeedges) ToMap() (map[string]interface{}, error) {
