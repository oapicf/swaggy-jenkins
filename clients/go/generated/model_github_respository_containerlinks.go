...
// checks if the GithubRespositoryContainerlinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GithubRespositoryContainerlinks{}
...
func (o GithubRespositoryContainerlinks) ToMap() (map[string]interface{}, error) {
