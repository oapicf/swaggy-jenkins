...
import {
    ...
    PipelineActivityartifactsToJSONTyped,
 ...
 */
export function instanceOfPipelineActivity(value: object): value is PipelineActivity {
    return true;
}
...
export function PipelineActivityToJSON(json: any): PipelineActivity {
    return PipelineActivityToJSONTyped(json, false);
}

export function PipelineActivityToJSONTyped(value?: PipelineActivity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
