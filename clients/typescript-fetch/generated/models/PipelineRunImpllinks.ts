 ...
 */
export function instanceOfPipelineRunImpllinks(value: object): value is PipelineRunImpllinks {
    return true;
}
...
export function PipelineRunImpllinksToJSON(json: any): PipelineRunImpllinks {
    return PipelineRunImpllinksToJSONTyped(json, false);
}

export function PipelineRunImpllinksToJSONTyped(value?: PipelineRunImpllinks | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
