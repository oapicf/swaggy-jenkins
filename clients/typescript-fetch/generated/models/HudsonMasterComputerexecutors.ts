 ...
 */
export function instanceOfHudsonMasterComputerexecutors(value: object): value is HudsonMasterComputerexecutors {
    return true;
}
...
export function HudsonMasterComputerexecutorsToJSON(json: any): HudsonMasterComputerexecutors {
    return HudsonMasterComputerexecutorsToJSONTyped(json, false);
}

export function HudsonMasterComputerexecutorsToJSONTyped(value?: HudsonMasterComputerexecutors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
