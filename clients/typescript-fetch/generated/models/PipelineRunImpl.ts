...
import {
    ...
    PipelineRunImpllinksToJSONTyped,
 ...
 */
export function instanceOfPipelineRunImpl(value: object): value is PipelineRunImpl {
    return true;
}
...
export function PipelineRunImplToJSON(json: any): PipelineRunImpl {
    return PipelineRunImplToJSONTyped(json, false);
}

export function PipelineRunImplToJSONTyped(value?: PipelineRunImpl | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
