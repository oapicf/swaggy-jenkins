 ...
 */
export function instanceOfPipelineStepImpllinks(value: object): value is PipelineStepImpllinks {
    return true;
}
...
export function PipelineStepImpllinksToJSON(json: any): PipelineStepImpllinks {
    return PipelineStepImpllinksToJSONTyped(json, false);
}

export function PipelineStepImpllinksToJSONTyped(value?: PipelineStepImpllinks | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
