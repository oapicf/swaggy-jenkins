...
export class RemoteAccessApi extends runtime.BaseAPI {
     ...
     */
    async getComputerRaw(requestParameters: GetComputerRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ComputerSet>> {
     ...
     * Retrieve computer details
     */
    async getComputer(requestParameters: GetComputerRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ComputerSet> {
     ...
     */
    async getJenkinsRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Hudson>> {
        const queryParameters: any = {};
     ...
     * Retrieve Jenkins details
     */
    async getJenkins(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Hudson> {
     ...
     */
    async getJobRaw(requestParameters: GetJobRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<FreeStyleProject>> {
     ...
     * Retrieve job details
     */
    async getJob(requestParameters: GetJobRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<FreeStyleProject> {
     ...
     */
    async getJobConfigRaw(requestParameters: GetJobConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve job configuration
     */
    async getJobConfig(requestParameters: GetJobConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<string> {
     ...
     */
    async getJobLastBuildRaw(requestParameters: GetJobLastBuildRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<FreeStyleBuild>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve job\'s last build details
     */
    async getJobLastBuild(requestParameters: GetJobLastBuildRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<FreeStyleBuild> {
     ...
     */
    async getJobProgressiveTextRaw(requestParameters: GetJobProgressiveTextRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve job\'s build progressive text output
     */
    async getJobProgressiveText(requestParameters: GetJobProgressiveTextRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async getQueueRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Queue>> {
        const queryParameters: any = {};
     ...
     * Retrieve queue details
     */
    async getQueue(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Queue> {
     ...
     */
    async getQueueItemRaw(requestParameters: GetQueueItemRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Queue>> {
        if (requestParameters.number === null || requestParameters.number === undefined) {
     ...
     * Retrieve queued item details
     */
    async getQueueItem(requestParameters: GetQueueItemRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Queue> {
     ...
     */
    async getViewRaw(requestParameters: GetViewRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ListView>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve view details
     */
    async getView(requestParameters: GetViewRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ListView> {
     ...
     */
    async getViewConfigRaw(requestParameters: GetViewConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Retrieve view configuration
     */
    async getViewConfig(requestParameters: GetViewConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<string> {
     ...
     */
    async headJenkinsRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Retrieve Jenkins headers
     */
    async headJenkins(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async postCreateItemRaw(requestParameters: PostCreateItemRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Create a new job using job configuration, or copied from an existing job
     */
    async postCreateItem(requestParameters: PostCreateItemRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async postCreateViewRaw(requestParameters: PostCreateViewRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Create a new view using view configuration
     */
    async postCreateView(requestParameters: PostCreateViewRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Build a job
     */
    async postJobBuildRaw(requestParameters: PostJobBuildRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Build a job
     */
    async postJobBuild(requestParameters: PostJobBuildRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async postJobConfigRaw(requestParameters: PostJobConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update job configuration
     */
    async postJobConfig(requestParameters: PostJobConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Delete a job
     */
    async postJobDeleteRaw(requestParameters: PostJobDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Delete a job
     */
    async postJobDelete(requestParameters: PostJobDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Disable a job
     */
    async postJobDisableRaw(requestParameters: PostJobDisableRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Disable a job
     */
    async postJobDisable(requestParameters: PostJobDisableRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Enable a job
     */
    async postJobEnableRaw(requestParameters: PostJobEnableRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Enable a job
     */
    async postJobEnable(requestParameters: PostJobEnableRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Stop a job
     */
    async postJobLastBuildStopRaw(requestParameters: PostJobLastBuildStopRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Stop a job
     */
    async postJobLastBuildStop(requestParameters: PostJobLastBuildStopRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async postViewConfigRaw(requestParameters: PostViewConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update view configuration
     */
    async postViewConfig(requestParameters: PostViewConfigRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
