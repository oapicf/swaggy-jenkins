...
import io.swagger.client.model.HudsonmodelFreeStyleProject;
    ...
    [XmlRootNode(name="HudsonmodelQueueBlockedItem")]
    public class HudsonmodelQueueBlockedItem {
        ...
        public var why: String = null;
                [XmlElement(name="buildableStartMilliseconds")]
        public var buildableStartMilliseconds: Number = NaN;

    public function toString(): String {
        var str: String = "HudsonmodelQueueBlockedItem: ";
        str += " (class: " + class + ")";
        str += " (actions: " + actions + ")";
        str += " (blocked: " + blocked + ")";
        ...
        str += " (url: " + url + ")";
        str += " (why: " + why + ")";
        str += " (buildableStartMilliseconds: " + buildableStartMilliseconds + ")";
        return str;
    }
