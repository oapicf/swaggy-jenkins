...
public struct GithubRepository: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        links = try container.decodeIfPresent(GithubRepositorylinks.self, forKey: .links)
        defaultBranch = try container.decodeIfPresent(String.self, forKey: .defaultBranch)
        description = try container.decodeIfPresent(String.self, forKey: .description)
        name = try container.decodeIfPresent(String.self, forKey: .name)
        permissions = try container.decodeIfPresent(GithubRepositorypermissions.self, forKey: .permissions)
