...
from swaggyjenkins.models.cause_user_id_cause import CauseUserIdCause  # noqa: E501
...
class TestCauseUserIdCause(unittest.TestCase):
    ...
    def testCauseUserIdCause(self):
        ...
        # model = swaggyjenkins.models.cause_user_id_cause.CauseUserIdCause()  # noqa: E501
        pass
