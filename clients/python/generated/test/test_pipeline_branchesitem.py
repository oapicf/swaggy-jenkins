...
from swaggyjenkins.models.pipeline_branchesitem import PipelineBranchesitem  # noqa: E501
...
class TestPipelineBranchesitem(unittest.TestCase):
    ...
    def testPipelineBranchesitem(self):
        ...
        # model = swaggyjenkins.models.pipeline_branchesitem.PipelineBranchesitem()  # noqa: E501
        pass
