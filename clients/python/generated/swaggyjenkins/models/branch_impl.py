...
class BranchImpl(object):
    ...
    def __init__(self, _class=None, display_name=None, estimated_duration_in_millis=None, full_display_name=None, full_name=None, name=None, organization=None, parameters=None, permissions=None, weather_score=None, pull_request=None, links=None, latest_run=None):  # noqa: E501
