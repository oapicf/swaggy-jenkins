...
web::json::value ExtensionClassContainerImpl1map::toJson() const
{
    ...
    if(m_Io_jenkins_blueocean_service_embedded_rest_PipelineImplIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl"))] = ModelBase::toJson(m_Io_jenkins_blueocean_service_embedded_rest_PipelineImpl);
    }
    if(m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"))] = ModelBase::toJson(m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImpl);
    }
    if(m__classIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl")));
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl")));
        if(!fieldValue.is_null())
        {
...
void ExtensionClassContainerImpl1map::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Io_jenkins_blueocean_service_embedded_rest_PipelineImplIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl")), m_Io_jenkins_blueocean_service_embedded_rest_PipelineImpl));
    }
    if(m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl")), m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImpl));
    }
    if(m__classIsSet)
    {
...
bool ExtensionClassContainerImpl1map::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl"))))
    {
        std::shared_ptr<ExtensionClassImpl> refVal_setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.PipelineImpl"))), refVal_setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl );
        setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl(refVal_setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"))))
    {
        std::shared_ptr<ExtensionClassImpl> refVal_setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"))), refVal_setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl );
        setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl(refVal_setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl);
    }
