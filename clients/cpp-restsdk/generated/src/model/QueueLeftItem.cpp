...
bool QueueLeftItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        bool refVal_setCancelled;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("cancelled"))), refVal_setCancelled );
        setCancelled(refVal_setCancelled);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("executable"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_setExecutable;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("executable"))), refVal_setExecutable );
        setExecutable(refVal_setExecutable);
    }
    return ok;
}
