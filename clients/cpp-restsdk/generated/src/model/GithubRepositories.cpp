...
web::json::value GithubRepositories::toJson() const
{
    ...
    if(m_LastPageIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("lastPage"))] = ModelBase::toJson(m_LastPage);
    }
    if(m_NextPageIsSet)
    {
...
bool GithubRepositories::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("lastPage"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("lastPage")));
        if(!fieldValue.is_null())
        {
...
void GithubRepositories::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_LastPageIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("lastPage")), m_LastPage));
    }
    if(m_NextPageIsSet)
    {
...
bool GithubRepositories::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("lastPage"))))
    {
        int32_t refVal_setLastPage;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("lastPage"))), refVal_setLastPage );
        setLastPage(refVal_setLastPage);
    }
