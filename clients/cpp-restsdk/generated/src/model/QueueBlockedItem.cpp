...
web::json::value QueueBlockedItem::toJson() const
{
    ...
    if(m_BuildableStartMillisecondsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds"))] = ModelBase::toJson(m_BuildableStartMilliseconds);
    }
...
bool QueueBlockedItem::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds")));
        if(!fieldValue.is_null())
        {
...
void QueueBlockedItem::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_BuildableStartMillisecondsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds")), m_BuildableStartMilliseconds));
    }
}
...
bool QueueBlockedItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds"))))
    {
        int32_t refVal_setBuildableStartMilliseconds;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("buildableStartMilliseconds"))), refVal_setBuildableStartMilliseconds );
        setBuildableStartMilliseconds(refVal_setBuildableStartMilliseconds);
    }
    return ok;
}
