...
bool GithubRepository::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GithubRepositorylinks> refVal__links;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("defaultBranch"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_defaultBranch;
            ok &= ModelBase::fromJson(fieldValue, refVal_defaultBranch);
            setDefaultBranch(refVal_defaultBranch);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("permissions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GithubRepositorypermissions> refVal_permissions;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("private"))))
    {
        ...
        {
            bool refVal_private;
            ok &= ModelBase::fromJson(fieldValue, refVal_private);
            setRPrivate(refVal_private);
        }
    }
...
bool GithubRepository::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_defaultBranch;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("defaultBranch"))), refVal_defaultBranch );
        setDefaultBranch(refVal_defaultBranch);
    }
    ...
    {
        bool refVal_private;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("private"))), refVal_private );
        setRPrivate(refVal_private);
    }
