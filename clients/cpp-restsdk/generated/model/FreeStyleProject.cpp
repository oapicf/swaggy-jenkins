...
bool FreeStyleProject::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("actions"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FreeStyleProjectactions>> refVal_actions;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("displayNameOrNull"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_displayNameOrNull;
            ok &= ModelBase::fromJson(fieldValue, refVal_displayNameOrNull);
            setDisplayNameOrNull(refVal_displayNameOrNull);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("builds"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FreeStyleBuild>> refVal_builds;
            ok &= ModelBase::fromJson(fieldValue, refVal_builds);
            setBuilds(refVal_builds);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("firstBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FreeStyleBuild> refVal_firstBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_firstBuild);
            setFirstBuild(refVal_firstBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("healthReport"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FreeStyleProjecthealthReport>> refVal_healthReport;
            ok &= ModelBase::fromJson(fieldValue, refVal_healthReport);
            setHealthReport(refVal_healthReport);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("inQueue"))))
    {
        ...
        {
            bool refVal_inQueue;
            ok &= ModelBase::fromJson(fieldValue, refVal_inQueue);
            setInQueue(refVal_inQueue);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("keepDependencies"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            bool refVal_keepDependencies;
            ok &= ModelBase::fromJson(fieldValue, refVal_keepDependencies);
            setKeepDependencies(refVal_keepDependencies);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FreeStyleBuild> refVal_lastBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastBuild);
            setLastBuild(refVal_lastBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastCompletedBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FreeStyleBuild> refVal_lastCompletedBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastCompletedBuild);
            setLastCompletedBuild(refVal_lastCompletedBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastFailedBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_lastFailedBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastFailedBuild);
            setLastFailedBuild(refVal_lastFailedBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastStableBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FreeStyleBuild> refVal_lastStableBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastStableBuild);
            setLastStableBuild(refVal_lastStableBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastSuccessfulBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<FreeStyleBuild> refVal_lastSuccessfulBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastSuccessfulBuild);
            setLastSuccessfulBuild(refVal_lastSuccessfulBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastUnstableBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_lastUnstableBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastUnstableBuild);
            setLastUnstableBuild(refVal_lastUnstableBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("lastUnsuccessfulBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_lastUnsuccessfulBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_lastUnsuccessfulBuild);
            setLastUnsuccessfulBuild(refVal_lastUnsuccessfulBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("nextBuildNumber"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            int32_t refVal_nextBuildNumber;
            ok &= ModelBase::fromJson(fieldValue, refVal_nextBuildNumber);
            setNextBuildNumber(refVal_nextBuildNumber);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("queueItem"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_queueItem;
            ok &= ModelBase::fromJson(fieldValue, refVal_queueItem);
            setQueueItem(refVal_queueItem);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("concurrentBuild"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            bool refVal_concurrentBuild;
            ok &= ModelBase::fromJson(fieldValue, refVal_concurrentBuild);
            setConcurrentBuild(refVal_concurrentBuild);
        }
    }
    if(val.has_field(utility::conversions::to_string_t(U("scm"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<NullSCM> refVal_scm;
            ok &= ModelBase::fromJson(fieldValue, refVal_scm);
            setScm(refVal_scm);
        }
    }
    return ok;
...
bool FreeStyleProject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_displayNameOrNull;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("displayNameOrNull"))), refVal_displayNameOrNull );
        setDisplayNameOrNull(refVal_displayNameOrNull);
    }
    ...
    {
        std::vector<std::shared_ptr<FreeStyleBuild>> refVal_builds;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("builds"))), refVal_builds );
        setBuilds(refVal_builds);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("firstBuild"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_firstBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("firstBuild"))), refVal_firstBuild );
        setFirstBuild(refVal_firstBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("healthReport"))))
    {
        std::vector<std::shared_ptr<FreeStyleProjecthealthReport>> refVal_healthReport;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("healthReport"))), refVal_healthReport );
        setHealthReport(refVal_healthReport);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("inQueue"))))
    {
        bool refVal_inQueue;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("inQueue"))), refVal_inQueue );
        setInQueue(refVal_inQueue);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("keepDependencies"))))
    {
        bool refVal_keepDependencies;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("keepDependencies"))), refVal_keepDependencies );
        setKeepDependencies(refVal_keepDependencies);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastBuild"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_lastBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastBuild"))), refVal_lastBuild );
        setLastBuild(refVal_lastBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastCompletedBuild"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_lastCompletedBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastCompletedBuild"))), refVal_lastCompletedBuild );
        setLastCompletedBuild(refVal_lastCompletedBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastFailedBuild"))))
    {
        utility::string_t refVal_lastFailedBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastFailedBuild"))), refVal_lastFailedBuild );
        setLastFailedBuild(refVal_lastFailedBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastStableBuild"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_lastStableBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastStableBuild"))), refVal_lastStableBuild );
        setLastStableBuild(refVal_lastStableBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastSuccessfulBuild"))))
    {
        std::shared_ptr<FreeStyleBuild> refVal_lastSuccessfulBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastSuccessfulBuild"))), refVal_lastSuccessfulBuild );
        setLastSuccessfulBuild(refVal_lastSuccessfulBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastUnstableBuild"))))
    {
        utility::string_t refVal_lastUnstableBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastUnstableBuild"))), refVal_lastUnstableBuild );
        setLastUnstableBuild(refVal_lastUnstableBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("lastUnsuccessfulBuild"))))
    {
        utility::string_t refVal_lastUnsuccessfulBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("lastUnsuccessfulBuild"))), refVal_lastUnsuccessfulBuild );
        setLastUnsuccessfulBuild(refVal_lastUnsuccessfulBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("nextBuildNumber"))))
    {
        int32_t refVal_nextBuildNumber;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("nextBuildNumber"))), refVal_nextBuildNumber );
        setNextBuildNumber(refVal_nextBuildNumber);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("queueItem"))))
    {
        utility::string_t refVal_queueItem;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("queueItem"))), refVal_queueItem );
        setQueueItem(refVal_queueItem);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("concurrentBuild"))))
    {
        bool refVal_concurrentBuild;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("concurrentBuild"))), refVal_concurrentBuild );
        setConcurrentBuild(refVal_concurrentBuild);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(U("scm"))))
    {
        std::shared_ptr<NullSCM> refVal_scm;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("scm"))), refVal_scm );
        setScm(refVal_scm);
    }
    return ok;
}
