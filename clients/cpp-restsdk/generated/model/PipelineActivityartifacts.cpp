...
void PipelineActivityartifacts::fromJson(web::json::value& val)
{
...
void PipelineActivityartifacts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
void PipelineActivityartifacts::setName(utility::string_t value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
void PipelineActivityartifacts::setUrl(utility::string_t value)
{
    m_Url = value;
    m_UrlIsSet = true;
}
...
void PipelineActivityartifacts::setClass(utility::string_t value)
{
    m__class = value;
    m__classIsSet = true;
}
bool PipelineActivityartifacts::_classIsSet() const
{
