...
bool GithubContent::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("sha"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_sha;
            ok &= ModelBase::fromJson(fieldValue, refVal_sha);
            setSha(refVal_sha);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("base64Data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_base64Data;
            ok &= ModelBase::fromJson(fieldValue, refVal_base64Data);
            setBase64Data(refVal_base64Data);
        }
    }
    return ok;
}
...
bool GithubContent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_sha;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("sha"))), refVal_sha );
        setSha(refVal_sha);
    }
    ...
    {
        utility::string_t refVal_repo;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("repo"))), refVal_repo );
        setRepo(refVal_repo);
    }
    ...
    {
        utility::string_t refVal_base64Data;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("base64Data"))), refVal_base64Data );
        setBase64Data(refVal_base64Data);
    }
    return ok;
}
