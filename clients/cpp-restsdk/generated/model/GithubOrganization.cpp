...
bool GithubOrganization::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("_links"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GithubOrganizationlinks> refVal__links;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jenkinsOrganizationPipeline"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            bool refVal_jenkinsOrganizationPipeline;
            ok &= ModelBase::fromJson(fieldValue, refVal_jenkinsOrganizationPipeline);
            setJenkinsOrganizationPipeline(refVal_jenkinsOrganizationPipeline);
        }
    }
...
bool GithubOrganization::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        bool refVal_jenkinsOrganizationPipeline;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("jenkinsOrganizationPipeline"))), refVal_jenkinsOrganizationPipeline );
        setJenkinsOrganizationPipeline(refVal_jenkinsOrganizationPipeline);
    }
