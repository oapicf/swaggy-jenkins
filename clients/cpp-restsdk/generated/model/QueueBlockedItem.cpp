...
bool QueueBlockedItem::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("buildableStartMilliseconds"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            int32_t refVal_buildableStartMilliseconds;
            ok &= ModelBase::fromJson(fieldValue, refVal_buildableStartMilliseconds);
            setBuildableStartMilliseconds(refVal_buildableStartMilliseconds);
        }
    }
    return ok;
}
...
bool QueueBlockedItem::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        int32_t refVal_buildableStartMilliseconds;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("buildableStartMilliseconds"))), refVal_buildableStartMilliseconds );
        setBuildableStartMilliseconds(refVal_buildableStartMilliseconds);
    }
    return ok;
}
