...
public:
    ...
    void unsetLatestRun();
    void setLatestRun(const std::shared_ptr<PipelineBranchesitemlatestRun>& value);
    ...
    void setPullRequest(const std::shared_ptr<PipelineBranchesitempullRequest>& value);
