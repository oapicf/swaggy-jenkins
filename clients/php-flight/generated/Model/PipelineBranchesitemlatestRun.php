...
class PipelineBranchesitemlatestRun  implements \JsonSerializable
{
        /**
     * @var int|null
     ...
     */
    public function __construct(?int $durationInMillis, ?int $estimatedDurationInMillis, ?string $enQueueTime, ?string $endTime, ?string $id, ?string $organization, ?string $pipeline, ?string $result, ?string $runSummary, ?string $startTime, ?string $state, ?string $type, ?string $commitId, ?string $class)
    {
