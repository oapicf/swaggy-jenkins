...
PipelineBranchesitemlatestRun::PipelineBranchesitemlatestRun(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineBranchesitemlatestRun::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineBranchesitemlatestRun::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineBranchesitemlatestRun");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineBranchesitemlatestRun::toJsonObject_internal() const
{
...
void PipelineBranchesitemlatestRun::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PipelineBranchesitemlatestRun>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineBranchesitemlatestRun>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineBranchesitemlatestRun>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineBranchesitemlatestRun>>>::fromJsonValue(boost::json::parse(json));
}
