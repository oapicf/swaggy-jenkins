...
GithubOrganizationlinks::GithubOrganizationlinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubOrganizationlinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubOrganizationlinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubOrganizationlinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubOrganizationlinks::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_RepositoriesIsSet) {
            object["repositories"] = JsonValueConverter<std::shared_ptr<Link>>::toJsonValue(getRepositories());
        }
        if (m_SelfIsSet) {
...
void GithubOrganizationlinks::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m__classIsSet = false;
    {
        ...
        if (RepositoriesIt != object.end()) {
            setRepositories(JsonValueConverter<std::shared_ptr<Link>>::fromJsonValue(RepositoriesIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GithubOrganizationlinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubOrganizationlinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubOrganizationlinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubOrganizationlinks>>>::fromJsonValue(boost::json::parse(json));
}
