...
NullSCM::NullSCM(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NullSCM::toJsonString(bool prettyJson /* = false */) const
{
...
void NullSCM::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NullSCM::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NullSCM::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NullSCM");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NullSCM::toJsonObject_internal() const
{
...
void NullSCM::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    {
...
std::string NullSCM::get_Class() const
{
    return m__class;
}

void NullSCM::set_Class(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NullSCM>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NullSCM>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NullSCM>>>::fromJsonValue(boost::json::parse(json));
}
