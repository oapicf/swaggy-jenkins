...
CauseUserIdCause::CauseUserIdCause(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value CauseUserIdCause::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CauseUserIdCause::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CauseUserIdCause");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CauseUserIdCause::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ShortDescriptionIsSet) {
            object["shortDescription"] = JsonValueConverter<std::string>::toJsonValue(getShortDescription());
        }
        if (m_UserIdIsSet) {
            object["userId"] = JsonValueConverter<std::string>::toJsonValue(getUserId());
        }
        if (m_UserNameIsSet) {
...
void CauseUserIdCause::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    ...
    {
        const auto ShortDescriptionIt = object.find("shortDescription");
        if (ShortDescriptionIt != object.end()) {
            setShortDescription(JsonValueConverter<std::string>::fromJsonValue(ShortDescriptionIt->value()));
        }
    }
    {
        const auto UserIdIt = object.find("userId");
        if (UserIdIt != object.end()) {
            setUserId(JsonValueConverter<std::string>::fromJsonValue(UserIdIt->value()));
        }
    }
    {
...
void CauseUserIdCause::setShortDescription(std::string value)
{
    ...
    m_ShortDescription = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CauseUserIdCause>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CauseUserIdCause>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CauseUserIdCause>>>::fromJsonValue(boost::json::parse(json));
}
