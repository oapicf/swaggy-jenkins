...
GithubFile::GithubFile(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubFile::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubFile::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubFile");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubFile::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ContentIsSet) {
            object["content"] = JsonValueConverter<std::shared_ptr<GithubContent>>::toJsonValue(getContent());
        }
        if (m__classIsSet) {
...
void GithubFile::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m__classIsSet = false;
    {
        ...
        if (ContentIt != object.end()) {
            setContent(JsonValueConverter<std::shared_ptr<GithubContent>>::fromJsonValue(ContentIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubFile>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubFile>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubFile>>>::fromJsonValue(boost::json::parse(json));
}
