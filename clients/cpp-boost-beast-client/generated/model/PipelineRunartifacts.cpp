...
PipelineRunartifacts::PipelineRunartifacts(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineRunartifacts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineRunartifacts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineRunartifacts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineRunartifacts::toJsonObject_internal() const
{
...
void PipelineRunartifacts::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_SizeIsSet = false;
    m_UrlIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PipelineRunartifacts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunartifacts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineRunartifacts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunartifacts>>>::fromJsonValue(boost::json::parse(json));
}
