...
ClassesByClass::ClassesByClass(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ClassesByClass::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ClassesByClass::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ClassesByClass::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ClassesByClass");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ClassesByClass::toJsonObject_internal() const
{
...
void ClassesByClass::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ClassesByClass>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ClassesByClass>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ClassesByClass>>>::fromJsonValue(boost::json::parse(json));
}
