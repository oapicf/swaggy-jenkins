...
StringParameterValue::StringParameterValue(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string StringParameterValue::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value StringParameterValue::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void StringParameterValue::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for StringParameterValue");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object StringParameterValue::toJsonObject_internal() const
{
...
void StringParameterValue::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_NameIsSet = false;
    m_ValueIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<StringParameterValue>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<StringParameterValue>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<StringParameterValue>>>::fromJsonValue(boost::json::parse(json));
}
