...
InputStepImpl::InputStepImpl(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value InputStepImpl::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InputStepImpl::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InputStepImpl");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InputStepImpl::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<InputStepImpllinks>>::toJsonValue(get_Links());
        }
        if (m_IdIsSet) {
        ...
        if (m_OkIsSet) {
            object["ok"] = JsonValueConverter<std::string>::toJsonValue(getOk());
        }
        ...
        if (m_SubmitterIsSet) {
            object["submitter"] = JsonValueConverter<std::string>::toJsonValue(getSubmitter());
        }
    return object;
}

void InputStepImpl::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    m_IdIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<InputStepImpllinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
    ...
    {
        const auto OkIt = object.find("ok");
        if (OkIt != object.end()) {
            setOk(JsonValueConverter<std::string>::fromJsonValue(OkIt->value()));
        }
    }
    {
    ...
    {
        const auto SubmitterIt = object.find("submitter");
        if (SubmitterIt != object.end()) {
            setSubmitter(JsonValueConverter<std::string>::fromJsonValue(SubmitterIt->value()));
        }
    }
}
...
void InputStepImpl::setSubmitter(std::string value)
{
    ...
    m_Submitter = std::move(value);
    m_SubmitterIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<InputStepImpl>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InputStepImpl>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InputStepImpl>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InputStepImpl>>>::fromJsonValue(boost::json::parse(json));
}
