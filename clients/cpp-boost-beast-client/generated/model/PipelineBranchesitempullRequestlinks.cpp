...
PipelineBranchesitempullRequestlinks::PipelineBranchesitempullRequestlinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PipelineBranchesitempullRequestlinks::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PipelineBranchesitempullRequestlinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineBranchesitempullRequestlinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineBranchesitempullRequestlinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineBranchesitempullRequestlinks::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_SelfIsSet) {
            object["self"] = JsonValueConverter<std::string>::toJsonValue(getSelf());
        }
        if (m__classIsSet) {
...
void PipelineBranchesitempullRequestlinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
        ...
        if (SelfIt != object.end()) {
            setSelf(JsonValueConverter<std::string>::fromJsonValue(SelfIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PipelineBranchesitempullRequestlinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineBranchesitempullRequestlinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineBranchesitempullRequestlinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineBranchesitempullRequestlinks>>>::fromJsonValue(boost::json::parse(json));
}
