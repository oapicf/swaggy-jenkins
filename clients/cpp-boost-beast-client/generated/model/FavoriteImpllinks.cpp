...
FavoriteImpllinks::FavoriteImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value FavoriteImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FavoriteImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FavoriteImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FavoriteImpllinks::toJsonObject_internal() const
{
...
void FavoriteImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FavoriteImpllinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FavoriteImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FavoriteImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FavoriteImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
