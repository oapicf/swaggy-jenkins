...
GithubRespositoryContainerlinks::GithubRespositoryContainerlinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GithubRespositoryContainerlinks::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value GithubRespositoryContainerlinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubRespositoryContainerlinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubRespositoryContainerlinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubRespositoryContainerlinks::toJsonObject_internal() const
{
...
void GithubRespositoryContainerlinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GithubRespositoryContainerlinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubRespositoryContainerlinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubRespositoryContainerlinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubRespositoryContainerlinks>>>::fromJsonValue(boost::json::parse(json));
}
