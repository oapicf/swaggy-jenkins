...
GithubOrganization::GithubOrganization(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubOrganization::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubOrganization::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubOrganization");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubOrganization::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<GithubOrganizationlinks>>::toJsonValue(get_Links());
        }
        if (m_JenkinsOrganizationPipelineIsSet) {
            object["jenkinsOrganizationPipeline"] = JsonValueConverter<bool>::toJsonValue(isJenkinsOrganizationPipeline());
        }
        if (m_NameIsSet) {
...
void GithubOrganization::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<GithubOrganizationlinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
        const auto JenkinsOrganizationPipelineIt = object.find("jenkinsOrganizationPipeline");
        if (JenkinsOrganizationPipelineIt != object.end()) {
            setJenkinsOrganizationPipeline(JsonValueConverter<bool>::fromJsonValue(JenkinsOrganizationPipelineIt->value()));
        }
    }
    {
...
void GithubOrganization::setJenkinsOrganizationPipeline(bool value)
{
    ...
    m_JenkinsOrganizationPipeline = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubOrganization>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubOrganization>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubOrganization>>>::fromJsonValue(boost::json::parse(json));
}
