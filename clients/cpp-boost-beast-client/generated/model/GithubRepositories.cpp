...
GithubRepositories::GithubRepositories(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubRepositories::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubRepositories::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubRepositories");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubRepositories::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<GithubRepositorieslinks>>::toJsonValue(get_Links());
        }
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<GithubRepository>>>::toJsonValue(getItems());
        }
        if (m_LastPageIsSet) {
            object["lastPage"] = JsonValueConverter<int32_t>::toJsonValue(getLastPage());
        }
        if (m_NextPageIsSet) {
            object["nextPage"] = JsonValueConverter<int32_t>::toJsonValue(getNextPage());
        }
        if (m_PageSizeIsSet) {
            object["pageSize"] = JsonValueConverter<int32_t>::toJsonValue(getPageSize());
        }
    return object;
}

void GithubRepositories::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    m_ItemsIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<GithubRepositorieslinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<GithubRepository>>>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
        const auto LastPageIt = object.find("lastPage");
        if (LastPageIt != object.end()) {
            setLastPage(JsonValueConverter<int32_t>::fromJsonValue(LastPageIt->value()));
        }
    }
    {
        const auto NextPageIt = object.find("nextPage");
        if (NextPageIt != object.end()) {
            setNextPage(JsonValueConverter<int32_t>::fromJsonValue(NextPageIt->value()));
        }
    }
    {
        const auto PageSizeIt = object.find("pageSize");
        if (PageSizeIt != object.end()) {
            setPageSize(JsonValueConverter<int32_t>::fromJsonValue(PageSizeIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubRepositories>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubRepositories>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubRepositories>>>::fromJsonValue(boost::json::parse(json));
}
