...
DiskSpaceMonitorDescriptorDiskSpace::DiskSpaceMonitorDescriptorDiskSpace(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DiskSpaceMonitorDescriptorDiskSpace::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DiskSpaceMonitorDescriptorDiskSpace::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DiskSpaceMonitorDescriptorDiskSpace");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DiskSpaceMonitorDescriptorDiskSpace::toJsonObject_internal() const
{
...
void DiskSpaceMonitorDescriptorDiskSpace::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DiskSpaceMonitorDescriptorDiskSpace>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DiskSpaceMonitorDescriptorDiskSpace>>>::fromJsonValue(boost::json::parse(json));
}
