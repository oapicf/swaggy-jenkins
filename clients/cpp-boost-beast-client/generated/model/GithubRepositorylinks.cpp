...
GithubRepositorylinks::GithubRepositorylinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GithubRepositorylinks::toJsonString(bool prettyJson /* = false */) const
{
...
void GithubRepositorylinks::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GithubRepositorylinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubRepositorylinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubRepositorylinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubRepositorylinks::toJsonObject_internal() const
{
...
void GithubRepositorylinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string GithubRepositorylinks::get_Class() const
{
    return m__class;
}

void GithubRepositorylinks::set_Class(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GithubRepositorylinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubRepositorylinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubRepositorylinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubRepositorylinks>>>::fromJsonValue(boost::json::parse(json));
}
