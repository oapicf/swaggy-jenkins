...
GithubScmlinks::GithubScmlinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubScmlinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubScmlinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubScmlinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubScmlinks::toJsonObject_internal() const
{
...
void GithubScmlinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GithubScmlinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubScmlinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubScmlinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubScmlinks>>>::fromJsonValue(boost::json::parse(json));
}
