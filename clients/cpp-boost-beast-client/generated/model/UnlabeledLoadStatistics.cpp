...
UnlabeledLoadStatistics::UnlabeledLoadStatistics(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value UnlabeledLoadStatistics::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UnlabeledLoadStatistics::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UnlabeledLoadStatistics");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UnlabeledLoadStatistics::toJsonObject_internal() const
{
...
void UnlabeledLoadStatistics::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UnlabeledLoadStatistics>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UnlabeledLoadStatistics>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UnlabeledLoadStatistics>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UnlabeledLoadStatistics>>>::fromJsonValue(boost::json::parse(json));
}
