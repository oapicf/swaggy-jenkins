...
ExtensionClassImpllinks::ExtensionClassImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ExtensionClassImpllinks::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ExtensionClassImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ExtensionClassImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ExtensionClassImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ExtensionClassImpllinks::toJsonObject_internal() const
{
...
void ExtensionClassImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ExtensionClassImpllinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ExtensionClassImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
