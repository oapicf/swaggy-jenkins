...
PipelineRunImpllinks::PipelineRunImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineRunImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineRunImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineRunImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineRunImpllinks::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_NodesIsSet) {
            object["nodes"] = JsonValueConverter<std::shared_ptr<Link>>::toJsonValue(getNodes());
        }
        if (m_LogIsSet) {
            object["log"] = JsonValueConverter<std::shared_ptr<Link>>::toJsonValue(getLog());
        }
        if (m_SelfIsSet) {
        ...
        if (m_StepsIsSet) {
            object["steps"] = JsonValueConverter<std::shared_ptr<Link>>::toJsonValue(getSteps());
        }
        if (m__classIsSet) {
...
void PipelineRunImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_NodesIsSet = false;
    m_LogIsSet = false;
    m_SelfIsSet = false;
    ...
    m__classIsSet = false;
    {
        const auto NodesIt = object.find("nodes");
        if (NodesIt != object.end()) {
            setNodes(JsonValueConverter<std::shared_ptr<Link>>::fromJsonValue(NodesIt->value()));
        }
    }
    {
        const auto LogIt = object.find("log");
        if (LogIt != object.end()) {
            setLog(JsonValueConverter<std::shared_ptr<Link>>::fromJsonValue(LogIt->value()));
        }
    }
    {
    ...
    {
        const auto StepsIt = object.find("steps");
        if (StepsIt != object.end()) {
            setSteps(JsonValueConverter<std::shared_ptr<Link>>::fromJsonValue(StepsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineRunImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
