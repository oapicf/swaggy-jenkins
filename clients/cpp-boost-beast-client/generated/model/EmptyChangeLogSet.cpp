...
EmptyChangeLogSet::EmptyChangeLogSet(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value EmptyChangeLogSet::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EmptyChangeLogSet::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EmptyChangeLogSet");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EmptyChangeLogSet::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_KindIsSet) {
            object["kind"] = JsonValueConverter<std::string>::toJsonValue(getKind());
        }
    return object;
}

void EmptyChangeLogSet::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_KindIsSet = false;
    {
    ...
    }
    {
        ...
        if (KindIt != object.end()) {
            setKind(JsonValueConverter<std::string>::fromJsonValue(KindIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EmptyChangeLogSet>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EmptyChangeLogSet>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EmptyChangeLogSet>>>::fromJsonValue(boost::json::parse(json));
}
