...
PipelinelatestRunartifacts::PipelinelatestRunartifacts(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelinelatestRunartifacts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelinelatestRunartifacts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelinelatestRunartifacts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelinelatestRunartifacts::toJsonObject_internal() const
{
...
void PipelinelatestRunartifacts::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_SizeIsSet = false;
    m_UrlIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PipelinelatestRunartifacts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelinelatestRunartifacts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelinelatestRunartifacts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelinelatestRunartifacts>>>::fromJsonValue(boost::json::parse(json));
}
