...
PipelineRunNodeedges::PipelineRunNodeedges(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineRunNodeedges::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineRunNodeedges::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineRunNodeedges");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineRunNodeedges::toJsonObject_internal() const
{
...
void PipelineRunNodeedges::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PipelineRunNodeedges>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNodeedges>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineRunNodeedges>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNodeedges>>>::fromJsonValue(boost::json::parse(json));
}
