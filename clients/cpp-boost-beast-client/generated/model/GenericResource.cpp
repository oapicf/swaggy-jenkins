...
GenericResource::GenericResource(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GenericResource::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenericResource::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenericResource");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenericResource::toJsonObject_internal() const
{
...
void GenericResource::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenericResource>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenericResource>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenericResource>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenericResource>>>::fromJsonValue(boost::json::parse(json));
}
