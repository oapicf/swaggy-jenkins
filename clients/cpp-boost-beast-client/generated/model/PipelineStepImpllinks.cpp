...
PipelineStepImpllinks::PipelineStepImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PipelineStepImpllinks::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PipelineStepImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineStepImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineStepImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineStepImpllinks::toJsonObject_internal() const
{
...
void PipelineStepImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineStepImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineStepImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineStepImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
