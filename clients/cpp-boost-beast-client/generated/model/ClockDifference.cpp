...
ClockDifference::ClockDifference(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ClockDifference::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ClockDifference::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ClockDifference");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ClockDifference::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_DiffIsSet) {
            object["diff"] = JsonValueConverter<int32_t>::toJsonValue(getDiff());
        }
    return object;
}

void ClockDifference::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_DiffIsSet = false;
    {
    ...
    {
        const auto DiffIt = object.find("diff");
        if (DiffIt != object.end()) {
            setDiff(JsonValueConverter<int32_t>::fromJsonValue(DiffIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ClockDifference>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ClockDifference>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ClockDifference>>>::fromJsonValue(boost::json::parse(json));
}
