...
FavoriteImpl::FavoriteImpl(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FavoriteImpl::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value FavoriteImpl::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FavoriteImpl::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FavoriteImpl");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FavoriteImpl::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<FavoriteImpllinks>>::toJsonValue(get_Links());
        }
        if (m_ItemIsSet) {
            object["item"] = JsonValueConverter<std::shared_ptr<PipelineImpl>>::toJsonValue(getItem());
        }
    return object;
}

void FavoriteImpl::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    m_ItemIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<FavoriteImpllinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
        const auto ItemIt = object.find("item");
        if (ItemIt != object.end()) {
            setItem(JsonValueConverter<std::shared_ptr<PipelineImpl>>::fromJsonValue(ItemIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FavoriteImpl>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FavoriteImpl>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FavoriteImpl>>>::fromJsonValue(boost::json::parse(json));
}
