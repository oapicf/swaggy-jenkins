...
FreeStyleProjectactions::FreeStyleProjectactions(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FreeStyleProjectactions::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value FreeStyleProjectactions::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FreeStyleProjectactions::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FreeStyleProjectactions");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FreeStyleProjectactions::toJsonObject_internal() const
{
...
void FreeStyleProjectactions::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FreeStyleProjectactions>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FreeStyleProjectactions>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FreeStyleProjectactions>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FreeStyleProjectactions>>>::fromJsonValue(boost::json::parse(json));
}
