...
PipelineRun::PipelineRun(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineRun::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineRun::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineRun");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineRun::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ArtifactsIsSet) {
            object["artifacts"] = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunartifacts>>>::toJsonValue(getArtifacts());
        }
...
void PipelineRun::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    ...
    }
    {
        ...
        if (ArtifactsIt != object.end()) {
            setArtifacts(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunartifacts>>>::fromJsonValue(ArtifactsIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineRun>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineRun>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineRun>>>::fromJsonValue(boost::json::parse(json));
}
