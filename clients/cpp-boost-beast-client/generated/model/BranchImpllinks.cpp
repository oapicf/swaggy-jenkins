...
BranchImpllinks::BranchImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BranchImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BranchImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BranchImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BranchImpllinks::toJsonObject_internal() const
{
...
void BranchImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BranchImpllinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BranchImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BranchImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BranchImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
