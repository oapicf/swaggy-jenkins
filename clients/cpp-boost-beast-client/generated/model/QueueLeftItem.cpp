...
QueueLeftItem::QueueLeftItem(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value QueueLeftItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QueueLeftItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QueueLeftItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QueueLeftItem::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_BlockedIsSet) {
            object["blocked"] = JsonValueConverter<bool>::toJsonValue(isBlocked());
        }
        if (m_BuildableIsSet) {
        ...
        if (m_InQueueSinceIsSet) {
            object["inQueueSince"] = JsonValueConverter<int32_t>::toJsonValue(getInQueueSince());
        }
        if (m_ParamsIsSet) {
            object["params"] = JsonValueConverter<std::string>::toJsonValue(getParams());
        }
        if (m_StuckIsSet) {
            object["stuck"] = JsonValueConverter<bool>::toJsonValue(isStuck());
        }
        if (m_TaskIsSet) {
            object["task"] = JsonValueConverter<std::shared_ptr<FreeStyleProject>>::toJsonValue(getTask());
        }
        if (m_UrlIsSet) {
            object["url"] = JsonValueConverter<std::string>::toJsonValue(getUrl());
        }
        if (m_WhyIsSet) {
            object["why"] = JsonValueConverter<std::string>::toJsonValue(getWhy());
        }
        if (m_CancelledIsSet) {
            object["cancelled"] = JsonValueConverter<bool>::toJsonValue(isCancelled());
        }
        if (m_ExecutableIsSet) {
            object["executable"] = JsonValueConverter<std::shared_ptr<FreeStyleBuild>>::toJsonValue(getExecutable());
        }
    return object;
}

void QueueLeftItem::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    ...
    {
        const auto BlockedIt = object.find("blocked");
        if (BlockedIt != object.end()) {
            setBlocked(JsonValueConverter<bool>::fromJsonValue(BlockedIt->value()));
        }
    }
    {
    ...
    {
        const auto InQueueSinceIt = object.find("inQueueSince");
        if (InQueueSinceIt != object.end()) {
            setInQueueSince(JsonValueConverter<int32_t>::fromJsonValue(InQueueSinceIt->value()));
        }
    }
    {
        const auto ParamsIt = object.find("params");
        if (ParamsIt != object.end()) {
            setParams(JsonValueConverter<std::string>::fromJsonValue(ParamsIt->value()));
        }
    }
    {
        const auto StuckIt = object.find("stuck");
        if (StuckIt != object.end()) {
            setStuck(JsonValueConverter<bool>::fromJsonValue(StuckIt->value()));
        }
    }
    {
        const auto TaskIt = object.find("task");
        if (TaskIt != object.end()) {
            setTask(JsonValueConverter<std::shared_ptr<FreeStyleProject>>::fromJsonValue(TaskIt->value()));
        }
    }
    {
    ...
    {
        const auto WhyIt = object.find("why");
        if (WhyIt != object.end()) {
            setWhy(JsonValueConverter<std::string>::fromJsonValue(WhyIt->value()));
        }
    }
    {
        const auto CancelledIt = object.find("cancelled");
        if (CancelledIt != object.end()) {
            setCancelled(JsonValueConverter<bool>::fromJsonValue(CancelledIt->value()));
        }
    }
    {
        const auto ExecutableIt = object.find("executable");
        if (ExecutableIt != object.end()) {
            setExecutable(JsonValueConverter<std::shared_ptr<FreeStyleBuild>>::fromJsonValue(ExecutableIt->value()));
        }
    }
}
...
void QueueLeftItem::setExecutable(std::shared_ptr<FreeStyleBuild> value)
{
    ...
    m_Executable = std::move(value);
    m_ExecutableIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QueueLeftItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QueueLeftItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QueueLeftItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QueueLeftItem>>>::fromJsonValue(boost::json::parse(json));
}
