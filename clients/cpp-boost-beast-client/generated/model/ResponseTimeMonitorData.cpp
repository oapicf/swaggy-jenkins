...
ResponseTimeMonitorData::ResponseTimeMonitorData(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ResponseTimeMonitorData::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ResponseTimeMonitorData::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ResponseTimeMonitorData");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ResponseTimeMonitorData::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_AverageIsSet) {
            object["average"] = JsonValueConverter<int32_t>::toJsonValue(getAverage());
        }
    return object;
}

void ResponseTimeMonitorData::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    ...
    {
        const auto AverageIt = object.find("average");
        if (AverageIt != object.end()) {
            setAverage(JsonValueConverter<int32_t>::fromJsonValue(AverageIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ResponseTimeMonitorData>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ResponseTimeMonitorData>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ResponseTimeMonitorData>>>::fromJsonValue(boost::json::parse(json));
}
