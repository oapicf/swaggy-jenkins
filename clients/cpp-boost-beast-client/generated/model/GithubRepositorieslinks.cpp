...
GithubRepositorieslinks::GithubRepositorieslinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value GithubRepositorieslinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GithubRepositorieslinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GithubRepositorieslinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GithubRepositorieslinks::toJsonObject_internal() const
{
...
void GithubRepositorieslinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GithubRepositorieslinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GithubRepositorieslinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GithubRepositorieslinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GithubRepositorieslinks>>>::fromJsonValue(boost::json::parse(json));
}
