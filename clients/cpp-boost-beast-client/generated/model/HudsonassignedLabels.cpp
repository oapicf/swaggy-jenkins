...
HudsonassignedLabels::HudsonassignedLabels(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HudsonassignedLabels::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value HudsonassignedLabels::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HudsonassignedLabels::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HudsonassignedLabels");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HudsonassignedLabels::toJsonObject_internal() const
{
...
void HudsonassignedLabels::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<HudsonassignedLabels>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HudsonassignedLabels>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HudsonassignedLabels>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HudsonassignedLabels>>>::fromJsonValue(boost::json::parse(json));
}
