...
ListView::ListView(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ListView::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ListView::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ListView");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ListView::toJsonObject_internal() const
{
...
void ListView::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ListView>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ListView>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ListView>>>::fromJsonValue(boost::json::parse(json));
}
