...
Organisation::Organisation(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Organisation::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Organisation::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Organisation");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Organisation::toJsonObject_internal() const
{
...
void Organisation::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_NameIsSet = false;
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Organisation>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Organisation>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Organisation>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Organisation>>>::fromJsonValue(boost::json::parse(json));
}
