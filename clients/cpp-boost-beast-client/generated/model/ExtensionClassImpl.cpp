...
ExtensionClassImpl::ExtensionClassImpl(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ExtensionClassImpl::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ExtensionClassImpl::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ExtensionClassImpl");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ExtensionClassImpl::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<ExtensionClassImpllinks>>::toJsonValue(get_Links());
        }
        if (m_ClassesIsSet) {
            object["classes"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getClasses());
        }
    return object;
}

void ExtensionClassImpl::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<ExtensionClassImpllinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
        const auto ClassesIt = object.find("classes");
        if (ClassesIt != object.end()) {
            setClasses(JsonValueConverter<std::vector<std::string>>::fromJsonValue(ClassesIt->value()));
        }
    }
}
...
void ExtensionClassImpl::setClasses(std::vector<std::string> value)
{
    ...
    m_Classes = std::move(value);
    m_ClassesIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ExtensionClassImpl>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassImpl>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ExtensionClassImpl>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassImpl>>>::fromJsonValue(boost::json::parse(json));
}
