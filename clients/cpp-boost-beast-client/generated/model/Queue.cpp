...
Queue::Queue(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Queue::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Queue::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Queue");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Queue::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<std::vector<std::shared_ptr<QueueBlockedItem>>>::toJsonValue(getItems());
        }
    return object;
}

void Queue::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_ItemsIsSet = false;
    {
    ...
    }
    {
        ...
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<std::vector<std::shared_ptr<QueueBlockedItem>>>::fromJsonValue(ItemsIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Queue>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Queue>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Queue>>>::fromJsonValue(boost::json::parse(json));
}
