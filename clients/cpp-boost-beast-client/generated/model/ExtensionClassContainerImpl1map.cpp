...
ExtensionClassContainerImpl1map::ExtensionClassContainerImpl1map(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ExtensionClassContainerImpl1map::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ExtensionClassContainerImpl1map::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ExtensionClassContainerImpl1map");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ExtensionClassContainerImpl1map::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Io_jenkins_blueocean_service_embedded_rest_PipelineImplIsSet) {
            object["io.jenkins.blueocean.service.embedded.rest.PipelineImpl"] = JsonValueConverter<std::shared_ptr<ExtensionClassImpl>>::toJsonValue(getIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl());
        }
        if (m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIsSet) {
            object["io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl"] = JsonValueConverter<std::shared_ptr<ExtensionClassImpl>>::toJsonValue(getIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl());
        }
        if (m__classIsSet) {
...
void ExtensionClassContainerImpl1map::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m__classIsSet = false;
    {
        const auto Io_jenkins_blueocean_service_embedded_rest_PipelineImplIt = object.find("io.jenkins.blueocean.service.embedded.rest.PipelineImpl");
        if (Io_jenkins_blueocean_service_embedded_rest_PipelineImplIt != object.end()) {
            setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl(JsonValueConverter<std::shared_ptr<ExtensionClassImpl>>::fromJsonValue(Io_jenkins_blueocean_service_embedded_rest_PipelineImplIt->value()));
        }
    }
    {
        const auto Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIt = object.find("io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl");
        if (Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIt != object.end()) {
            setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl(JsonValueConverter<std::shared_ptr<ExtensionClassImpl>>::fromJsonValue(Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImplIt->value()));
        }
    }
    {
...
void ExtensionClassContainerImpl1map::setIoJenkinsBlueoceanServiceEmbeddedRestPipelineImpl(std::shared_ptr<ExtensionClassImpl> value)
{
    ...
    m_Io_jenkins_blueocean_service_embedded_rest_PipelineImpl = std::move(value);
...
void ExtensionClassContainerImpl1map::setIoJenkinsBlueoceanServiceEmbeddedRestMultiBranchPipelineImpl(std::shared_ptr<ExtensionClassImpl> value)
{
    ...
    m_Io_jenkins_blueocean_service_embedded_rest_MultiBranchPipelineImpl = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassContainerImpl1map>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ExtensionClassContainerImpl1map>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ExtensionClassContainerImpl1map>>>::fromJsonValue(boost::json::parse(json));
}
