...
DefaultCrumbIssuer::DefaultCrumbIssuer(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value DefaultCrumbIssuer::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DefaultCrumbIssuer::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DefaultCrumbIssuer");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DefaultCrumbIssuer::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_CrumbIsSet) {
            object["crumb"] = JsonValueConverter<std::string>::toJsonValue(getCrumb());
        }
        if (m_CrumbRequestFieldIsSet) {
            object["crumbRequestField"] = JsonValueConverter<std::string>::toJsonValue(getCrumbRequestField());
        }
    return object;
}

void DefaultCrumbIssuer::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_CrumbIsSet = false;
    ...
    {
        const auto CrumbIt = object.find("crumb");
        if (CrumbIt != object.end()) {
            setCrumb(JsonValueConverter<std::string>::fromJsonValue(CrumbIt->value()));
        }
    }
    {
        const auto CrumbRequestFieldIt = object.find("crumbRequestField");
        if (CrumbRequestFieldIt != object.end()) {
            setCrumbRequestField(JsonValueConverter<std::string>::fromJsonValue(CrumbRequestFieldIt->value()));
        }
    }
}
...
void DefaultCrumbIssuer::setCrumbRequestField(std::string value)
{
    ...
    m_CrumbRequestField = std::move(value);
    m_CrumbRequestFieldIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DefaultCrumbIssuer>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DefaultCrumbIssuer>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DefaultCrumbIssuer>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DefaultCrumbIssuer>>>::fromJsonValue(boost::json::parse(json));
}
