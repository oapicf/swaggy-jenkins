...
Label1::Label1(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Label1::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value Label1::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Label1::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Label1");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Label1::toJsonObject_internal() const
{
...
void Label1::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Label1>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Label1>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Label1>>>::fromJsonValue(boost::json::parse(json));
}
