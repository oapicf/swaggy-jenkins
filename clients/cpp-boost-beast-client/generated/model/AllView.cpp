...
AllView::AllView(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value AllView::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AllView::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AllView");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AllView::toJsonObject_internal() const
{
...
void AllView::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m_NameIsSet = false;
    m_UrlIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AllView>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AllView>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AllView>>>::fromJsonValue(boost::json::parse(json));
}
