...
PipelineRunNode::PipelineRunNode(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value PipelineRunNode::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineRunNode::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineRunNode");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineRunNode::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_EdgesIsSet) {
            object["edges"] = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNodeedges>>>::toJsonValue(getEdges());
        }
        if (m_IdIsSet) {
...
void PipelineRunNode::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    ...
    {
        const auto EdgesIt = object.find("edges");
        if (EdgesIt != object.end()) {
            setEdges(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNodeedges>>>::fromJsonValue(EdgesIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNode>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineRunNode>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineRunNode>>>::fromJsonValue(boost::json::parse(json));
}
