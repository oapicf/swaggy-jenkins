...
PipelineStepImpl::PipelineStepImpl(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PipelineStepImpl::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PipelineStepImpl::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PipelineStepImpl::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PipelineStepImpl");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PipelineStepImpl::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m__linksIsSet) {
            object["_links"] = JsonValueConverter<std::shared_ptr<PipelineStepImpllinks>>::toJsonValue(get_Links());
        }
        ...
        if (m_InputIsSet) {
            object["input"] = JsonValueConverter<std::shared_ptr<InputStepImpl>>::toJsonValue(getInput());
        }
        if (m_ResultIsSet) {
...
void PipelineStepImpl::fromJsonObject_internal(boost::json::object const& object)
{
    m__classIsSet = false;
    m__linksIsSet = false;
    ...
    }
    {
        ...
        if (_linksIt != object.end()) {
            set_Links(JsonValueConverter<std::shared_ptr<PipelineStepImpllinks>>::fromJsonValue(_linksIt->value()));
        }
    }
    {
    ...
    {
        const auto InputIt = object.find("input");
        if (InputIt != object.end()) {
            setInput(JsonValueConverter<std::shared_ptr<InputStepImpl>>::fromJsonValue(InputIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PipelineStepImpl>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PipelineStepImpl>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PipelineStepImpl>>>::fromJsonValue(boost::json::parse(json));
}
