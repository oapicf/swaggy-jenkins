...
InputStepImpllinks::InputStepImpllinks(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value InputStepImpllinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InputStepImpllinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InputStepImpllinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InputStepImpllinks::toJsonObject_internal() const
{
...
void InputStepImpllinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_SelfIsSet = false;
    m__classIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InputStepImpllinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InputStepImpllinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InputStepImpllinks>>>::fromJsonValue(boost::json::parse(json));
}
