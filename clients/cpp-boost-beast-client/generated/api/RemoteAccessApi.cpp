...
RemoteAccessApiException::RemoteAccessApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status RemoteAccessApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<ComputerSet>
RemoteAccessApi::getComputer(
    const int32_t& depth) {
    std::string serializedRequestBody;
    std::string path = m_context + "/computer/api/json";
    ...
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "depth",
            serializeQueryParameterValue(depth));
    ...
    std::shared_ptr<ComputerSet> deserializedResponse = std::make_shared<ComputerSet>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ComputerSet>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw RemoteAccessApiException(statusCode, "Authentication failed - incorrect username and/or password");
    }
    if (statusCode == boost::beast::http::status(403)) {
        throw RemoteAccessApiException(statusCode, "Jenkins requires authentication - please set username and password");
    }
    throw RemoteAccessApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<Hudson>
RemoteAccessApi::getJenkins(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/json";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<Hudson> deserializedResponse = std::make_shared<Hudson>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Hudson>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<FreeStyleProject>
RemoteAccessApi::getJob(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/api/json";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<FreeStyleProject> deserializedResponse = std::make_shared<FreeStyleProject>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<FreeStyleProject>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(404)) {
        throw RemoteAccessApiException(statusCode, "Job cannot be found on Jenkins instance");
    }
    throw RemoteAccessApiException(statusCode, "Unexpected HTTP status code");
}
std::string
RemoteAccessApi::getJobConfig(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/config.xml";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
...
RemoteAccessApi::postJobConfig(
    ...
    replacePathParameter(path, "name", name);
    // headers
    headers.emplace("Jenkins-Crumb", serializeHeaderParameterValue(jenkinsCrumb));

    static const std::vector<std::string> acceptTypes{ "*/*", };
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw RemoteAccessApiException(statusCode, "An error has occurred - error message is embedded inside the HTML response");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw RemoteAccessApiException(statusCode, "Authentication failed - incorrect username and/or password");
    }
...
std::shared_ptr<FreeStyleBuild>
RemoteAccessApi::getJobLastBuild(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/lastBuild/api/json";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    ...
    std::shared_ptr<FreeStyleBuild> deserializedResponse = std::make_shared<FreeStyleBuild>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<FreeStyleBuild>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
RemoteAccessApi::getJobProgressiveText(
    const std::string& name, const std::string& number, const std::string& start) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/{number}/logText/progressiveText";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    replacePathParameter(path, "number", number);
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
...
RemoteAccessApi::getQueue(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/queue/api/json";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<Queue> deserializedResponse = std::make_shared<Queue>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Queue>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Queue>
RemoteAccessApi::getQueueItem(
    const std::string& number) {
    std::string serializedRequestBody;
    std::string path = m_context + "/queue/item/{number}/api/json";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "number", number);
...
RemoteAccessApi::getView(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/view/{name}/api/json";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    ...
    std::shared_ptr<ListView> deserializedResponse = std::make_shared<ListView>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ListView>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(404)) {
        throw RemoteAccessApiException(statusCode, "View cannot be found on Jenkins instance");
    }
    throw RemoteAccessApiException(statusCode, "Unexpected HTTP status code");
}
std::string
RemoteAccessApi::getViewConfig(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/view/{name}/config.xml";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
...
void
RemoteAccessApi::postViewConfig(
    const std::string& name, const std::string& body, const std::string& jenkinsCrumb) {
    std::string serializedRequestBody;
    std::string path = m_context + "/view/{name}/config.xml";
    std::map<std::string, std::string> headers;
...
void
RemoteAccessApi::postCreateItem(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/createItem";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    ...
    if (mode) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "mode",
            serializeQueryParameterValue(*mode));
    }
    path += queryParameterStream.str();
    // headers
    headers.emplace("Jenkins-Crumb", serializeHeaderParameterValue(jenkinsCrumb));
    headers.emplace("Content-Type", serializeHeaderParameterValue(contentType));
...
RemoteAccessApi::postJobBuild(
    ...
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "json",
            serializeQueryParameterValue(json));
    if (token) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "token",
            serializeQueryParameterValue(*token));
    }
    path += queryParameterStream.str();
    // headers
    headers.emplace("Jenkins-Crumb", serializeHeaderParameterValue(jenkinsCrumb));
...
void
RemoteAccessApi::postJobDelete(
    const std::string& name, const std::string& jenkinsCrumb) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/doDelete";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    // headers
...
void
RemoteAccessApi::postJobDisable(
    const std::string& name, const std::string& jenkinsCrumb) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/disable";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    // headers
...
void
RemoteAccessApi::postJobEnable(
    const std::string& name, const std::string& jenkinsCrumb) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/enable";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    // headers
...
void
RemoteAccessApi::postJobLastBuildStop(
    const std::string& name, const std::string& jenkinsCrumb) {
    std::string serializedRequestBody;
    std::string path = m_context + "/job/{name}/lastBuild/stop";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    // headers
...
std::string RemoteAccessApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void RemoteAccessApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void RemoteAccessApi::handleStdException(const std::exception&) {
    throw;
}

void RemoteAccessApi::handleUncaughtException() {
    throw;
}
