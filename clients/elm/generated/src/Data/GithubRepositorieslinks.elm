...
module Data.GithubRepositorieslinks exposing (GithubRepositorieslinks, githubRepositorieslinksDecoder, githubRepositorieslinksEncoder)
...
githubRepositorieslinksDecoder : Decoder GithubRepositorieslinks
githubRepositorieslinksDecoder =
    decode GithubRepositorieslinks
        |> optional "self" (Decode.nullable linkDecoder) Nothing
        |> optional "_class" (Decode.nullable Decode.string) Nothing



githubRepositorieslinksEncoder : GithubRepositorieslinks -> Encode.Value
githubRepositorieslinksEncoder model =
    Encode.object
