...
module Data.GithubRepositorylinks exposing (GithubRepositorylinks, githubRepositorylinksDecoder, githubRepositorylinksEncoder)
...
githubRepositorylinksDecoder : Decoder GithubRepositorylinks
githubRepositorylinksDecoder =
    decode GithubRepositorylinks
        |> optional "self" (Decode.nullable linkDecoder) Nothing
        |> optional "_class" (Decode.nullable Decode.string) Nothing



githubRepositorylinksEncoder : GithubRepositorylinks -> Encode.Value
githubRepositorylinksEncoder model =
    Encode.object
