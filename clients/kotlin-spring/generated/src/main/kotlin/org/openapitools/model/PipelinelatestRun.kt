...
data class PipelinelatestRun(
    ...
    @get:JsonProperty("artifacts") val artifacts: kotlin.collections.List<PipelinelatestRunartifacts>? = null,
    ...
    @field:JsonInclude(JsonInclude.Include.NON_NULL)
    @field:JsonSetter(nulls = Nulls.SKIP)
    @param:JsonProperty("enQueueTime")
