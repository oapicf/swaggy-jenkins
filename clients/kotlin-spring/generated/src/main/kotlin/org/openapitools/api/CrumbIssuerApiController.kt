...
import org.openapitools.api.CrumbIssuerApiController.Companion.BASE_PATH
...
class CrumbIssuerApiController() {
    ...
    @RequestMapping(
        ...
        value = [PATH_GET_CRUMB /* "/crumbIssuer/api/json" */],
    ...
    companion object {
        ...
        const val PATH_GET_CRUMB: String = "/crumbIssuer/api/json"
    }
}
