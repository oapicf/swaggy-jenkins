...
class CreateItemApiController() {
    ...
    fun postCreateItem(@NotNull  @RequestParam(value = "name", required = true) name: kotlin.String
, @RequestParam(value = "from", required = false) from: kotlin.String?
, @RequestParam(value = "mode", required = false) mode: kotlin.String?
