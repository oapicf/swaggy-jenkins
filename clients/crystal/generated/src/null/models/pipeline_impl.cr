...
module 
  class PipelineImpl
    ...
    def initialize(@_class : String?, @display_name : String?, @estimated_duration_in_millis : Int32?, @full_name : String?, @latest_run : String?, @name : String?, @organization : String?, @weather_score : Int32?, @_links : PipelineImpllinks?)
    end
