...
module 
  class PipelineStepImpl
    ...
    def initialize(@_class : String?, @_links : PipelineStepImpllinks?, @display_name : String?, @duration_in_millis : Int32?, @id : String?, @input : InputStepImpl?, @result : String?, @start_time : String?, @state : String?)
    end
