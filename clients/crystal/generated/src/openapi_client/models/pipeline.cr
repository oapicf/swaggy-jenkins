...
module OpenAPIClient
  class Pipeline
    ...
    @[JSON::Field(key: "latestRun", type: PipelinelatestRun?, nillable: true, emit_null: false)]
    property latest_run : PipelinelatestRun?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_class : String? = nil, @organization : String? = nil, @name : String? = nil, @display_name : String? = nil, @full_name : String? = nil, @weather_score : Int32? = nil, @estimated_duration_in_millis : Int32? = nil, @latest_run : PipelinelatestRun? = nil)
    end
