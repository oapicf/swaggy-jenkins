...
module OpenAPIClient
  class Pipeline
    ...
    def initialize(@_class : String?, @organization : String?, @name : String?, @display_name : String?, @full_name : String?, @weather_score : Int32?, @estimated_duration_in_millis : Int32?, @latest_run : PipelinelatestRun?)
    end
