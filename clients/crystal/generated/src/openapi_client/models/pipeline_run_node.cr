...
module OpenAPIClient
  class PipelineRunNode
    ...
    def initialize(@_class : String?, @display_name : String?, @duration_in_millis : Int32?, @edges : Array(PipelineRunNodeedges)?, @id : String?, @result : String?, @start_time : String?, @state : String?)
    end
