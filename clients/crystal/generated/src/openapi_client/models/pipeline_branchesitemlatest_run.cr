...
module OpenAPIClient
  class PipelineBranchesitemlatestRun
    ...
    def hash
      [duration_in_millis, estimated_duration_in_millis, en_queue_time, end_time, id, organization, pipeline, result, run_summary, start_time, state, _type, commit_id, _class].hash
    end
