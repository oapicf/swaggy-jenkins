...
module OpenAPIClient
  class HudsonMasterComputerexecutors
    ...
    # Optional properties
    @[JSON::Field(key: "currentExecutable", type: FreeStyleBuild?, nillable: true, emit_null: false)]
    property current_executable : FreeStyleBuild?

    @[JSON::Field(key: "idle", type: Bool?, nillable: true, emit_null: false)]
    property idle : Bool?

    @[JSON::Field(key: "likelyStuck", type: Bool?, nillable: true, emit_null: false)]
    property likely_stuck : Bool?

    @[JSON::Field(key: "number", type: Int32?, nillable: true, emit_null: false)]
    property number : Int32?

    @[JSON::Field(key: "progress", type: Int32?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          current_executable == other.current_executable &&
          idle == other.idle &&
          likely_stuck == other.likely_stuck &&
          number == other.number &&
    ...
    def to_h
      ...
      hash["currentExecutable"] = _to_h(current_executable)
      hash["idle"] = _to_h(idle)
      hash["likelyStuck"] = _to_h(likely_stuck)
      hash["number"] = _to_h(number)
      hash["progress"] = _to_h(progress)
