...
module OpenAPIClient
  class GithubRepositorypermissions
    ...
    # Optional properties
    @[JSON::Field(key: "admin", type: Bool?, nillable: true, emit_null: false)]
    property admin : Bool?

    @[JSON::Field(key: "push", type: Bool?, nillable: true, emit_null: false)]
    property push : Bool?

    @[JSON::Field(key: "pull", type: Bool?, nillable: true, emit_null: false)]
    property pull : Bool?
    ...
    def to_h
      ...
      hash["admin"] = _to_h(admin)
      hash["push"] = _to_h(push)
      hash["pull"] = _to_h(pull)
