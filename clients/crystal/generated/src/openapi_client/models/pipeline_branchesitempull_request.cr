...
module OpenAPIClient
  class PipelineBranchesitempullRequest
    ...
    # Optional properties
    @[JSON::Field(key: "_links", type: PipelineBranchesitempullRequestlinks?, nillable: true, emit_null: false)]
    ...
    def hash
      [_links, author, id, title, url, _class].hash
    end
