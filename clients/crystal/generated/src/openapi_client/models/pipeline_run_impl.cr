...
module OpenAPIClient
  class PipelineRunImpl
    ...
    def initialize(@_class : String?, @_links : PipelineRunImpllinks?, @duration_in_millis : Int32?, @en_queue_time : String?, @end_time : String?, @estimated_duration_in_millis : Int32?, @id : String?, @organization : String?, @pipeline : String?, @result : String?, @run_summary : String?, @start_time : String?, @state : String?, @_type : String?, @commit_id : String?)
    end
