...
module OpenAPIClient
  class PipelineFolderImpl
    ...
    @[JSON::Field(key: "numberOfFolders", type: Int32?, nillable: true, emit_null: false)]
    property number_of_folders : Int32?

    @[JSON::Field(key: "numberOfPipelines", type: Int32?, nillable: true, emit_null: false)]
    property number_of_pipelines : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_class : String? = nil, @display_name : String? = nil, @full_name : String? = nil, @name : String? = nil, @organization : String? = nil, @number_of_folders : Int32? = nil, @number_of_pipelines : Int32? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          number_of_folders == other.number_of_folders &&
          number_of_pipelines == other.number_of_pipelines
    end
    ...
    def to_h
      ...
      hash["numberOfFolders"] = _to_h(number_of_folders)
      hash["numberOfPipelines"] = _to_h(number_of_pipelines)
      hash.to_h
    end
