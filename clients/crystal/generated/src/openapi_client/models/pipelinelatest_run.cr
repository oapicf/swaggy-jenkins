...
module OpenAPIClient
  class PipelinelatestRun
    ...
    # Optional properties
    @[JSON::Field(key: "artifacts", type: Array(PipelinelatestRunartifacts)?, nillable: true, emit_null: false)]
    property artifacts : Array(PipelinelatestRunartifacts)?
    ...
    def initialize(@artifacts : Array(PipelinelatestRunartifacts)? = nil, @duration_in_millis : Int32? = nil, @estimated_duration_in_millis : Int32? = nil, @en_queue_time : String? = nil, @end_time : String? = nil, @id : String? = nil, @organization : String? = nil, @pipeline : String? = nil, @result : String? = nil, @run_summary : String? = nil, @start_time : String? = nil, @state : String? = nil, @_type : String? = nil, @commit_id : String? = nil, @_class : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          duration_in_millis == other.duration_in_millis &&
          estimated_duration_in_millis == other.estimated_duration_in_millis &&
          en_queue_time == other.en_queue_time &&
          end_time == other.end_time &&
          id == other.id &&
          organization == other.organization &&
          pipeline == other.pipeline &&
          result == other.result &&
          run_summary == other.run_summary &&
    ...
    def hash
      [artifacts, duration_in_millis, estimated_duration_in_millis, en_queue_time, end_time, id, organization, pipeline, result, run_summary, start_time, state, _type, commit_id, _class].hash
    end
    ...
    def to_h
      ...
      hash["artifacts"] = _to_h(artifacts)
      hash["durationInMillis"] = _to_h(duration_in_millis)
      hash["estimatedDurationInMillis"] = _to_h(estimated_duration_in_millis)
      hash["enQueueTime"] = _to_h(en_queue_time)
      hash["endTime"] = _to_h(end_time)
      hash["id"] = _to_h(id)
      hash["organization"] = _to_h(organization)
      hash["pipeline"] = _to_h(pipeline)
      hash["result"] = _to_h(result)
      hash["runSummary"] = _to_h(run_summary)
      hash["startTime"] = _to_h(start_time)
      hash["state"] = _to_h(state)
      hash["type"] = _to_h(_type)
      hash["commitId"] = _to_h(commit_id)
