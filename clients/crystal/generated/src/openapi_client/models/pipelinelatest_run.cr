...
module OpenAPIClient
  class PipelinelatestRun
    ...
    def initialize(@artifacts : Array(PipelinelatestRunartifacts)?, @duration_in_millis : Int32?, @estimated_duration_in_millis : Int32?, @en_queue_time : String?, @end_time : String?, @id : String?, @organization : String?, @pipeline : String?, @result : String?, @run_summary : String?, @start_time : String?, @state : String?, @_type : String?, @commit_id : String?, @_class : String?)
    end
