...
module OpenAPIClient
  class BranchImplpermissions
    ...
    # Optional properties
    @[JSON::Field(key: "create", type: Bool?, nillable: true, emit_null: false)]
    property create : Bool?

    @[JSON::Field(key: "read", type: Bool?, nillable: true, emit_null: false)]
    property read : Bool?

    @[JSON::Field(key: "start", type: Bool?, nillable: true, emit_null: false)]
    property start : Bool?

    @[JSON::Field(key: "stop", type: Bool?, nillable: true, emit_null: false)]
    property stop : Bool?
    ...
    def initialize(@create : Bool? = nil, @read : Bool? = nil, @start : Bool? = nil, @stop : Bool? = nil, @_class : String? = nil)
    end
