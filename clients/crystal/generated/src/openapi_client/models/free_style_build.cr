  ...
  class FreeStyleBuild
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          id == other.id &&
          keep_log == other.keep_log &&
          queue_id == other.queue_id &&
          result == other.result &&
          timestamp == other.timestamp &&
          built_on == other.built_on &&
          change_set == other.change_set
    end
    ...
    def to_h
      ...
      hash["building"] = _to_h(building)
      hash["description"] = _to_h(description)
      hash["displayName"] = _to_h(display_name)
      hash["duration"] = _to_h(duration)
      hash["estimatedDuration"] = _to_h(estimated_duration)
      hash["executor"] = _to_h(executor)
      hash["fullDisplayName"] = _to_h(full_display_name)
      hash["id"] = _to_h(id)
      hash["keepLog"] = _to_h(keep_log)
      hash["queueId"] = _to_h(queue_id)
      hash["result"] = _to_h(result)
      hash["timestamp"] = _to_h(timestamp)
      hash["builtOn"] = _to_h(built_on)
      hash["changeSet"] = _to_h(change_set)
      hash.to_h
    end
