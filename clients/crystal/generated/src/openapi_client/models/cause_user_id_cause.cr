...
module OpenAPIClient
  class CauseUserIdCause
    ...
    @[JSON::Field(key: "shortDescription", type: String?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["shortDescription"] = _to_h(short_description)
      hash["userId"] = _to_h(user_id)
      hash["userName"] = _to_h(user_name)
      hash.to_h
    end
