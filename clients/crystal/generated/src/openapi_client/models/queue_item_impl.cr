...
module OpenAPIClient
  class QueueItemImpl
    ...
    @[JSON::Field(key: "expectedBuildNumber", type: Int32?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "queuedTime", type: Int32?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          _class == other._class &&
          expected_build_number == other.expected_build_number &&
          id == other.id &&
    ...
    def to_h
      ...
      hash["expectedBuildNumber"] = _to_h(expected_build_number)
      hash["id"] = _to_h(id)
      hash["pipeline"] = _to_h(pipeline)
      hash["queuedTime"] = _to_h(queued_time)
      hash.to_h
    end
