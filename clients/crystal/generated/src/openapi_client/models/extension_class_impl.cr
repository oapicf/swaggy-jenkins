...
module OpenAPIClient
  class ExtensionClassImpl
    ...
    @[JSON::Field(key: "_links", type: ExtensionClassImpllinks?, nillable: true, emit_null: false)]
    property _links : ExtensionClassImpllinks?

    @[JSON::Field(key: "classes", type: Array(String)?, nillable: true, emit_null: false)]
