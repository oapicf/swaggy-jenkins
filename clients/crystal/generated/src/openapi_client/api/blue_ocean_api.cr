...
module OpenAPIClient
  class BlueOceanApi
    ...
    # @return [String]
    def get_json_web_token(expiry_time_in_mins : Int32? = nil, max_expiry_time_in_mins : Int32? = nil)
    ...
    # Retrieve JSON Web Token
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_json_web_token_with_http_info(expiry_time_in_mins : Int32? = nil, max_expiry_time_in_mins : Int32? = nil)
      if @api_client.config.debugging
    ...
    # @param run [String] Name of the run
    # @return [String]
    def get_pipeline_run_log(organization : String, pipeline : String, run : String, start : Int32? = nil, download : Bool? = nil)
    ...
    # @param run [String] Name of the run
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_pipeline_run_log_with_http_info(organization : String, pipeline : String, run : String, start : Int32? = nil, download : Bool? = nil)
      if @api_client.config.debugging
    ...
    def get_scm_organisation_repositories(organization : String, scm : String, scm_organisation : String, credential_id : String? = nil, page_size : Int32? = nil, page_number : Int32? = nil)
    ...
    def get_scm_organisation_repositories_with_http_info(organization : String, scm : String, scm_organisation : String, credential_id : String? = nil, page_size : Int32? = nil, page_number : Int32? = nil)
      if @api_client.config.debugging
    ...
    # @return [Array(GithubOrganization)]
    def get_scm_organisation_repository(organization : String, scm : String, scm_organisation : String, repository : String, credential_id : String? = nil)
    ...
    # @param repository [String] Name of the SCM repository
    # @return [Array<(Array(GithubOrganization), Integer, Hash)>] Array(GithubOrganization) data, response status code and response headers
    def get_scm_organisation_repository_with_http_info(organization : String, scm : String, scm_organisation : String, repository : String, credential_id : String? = nil)
      if @api_client.config.debugging
    ...
    # @param scm [String] Name of SCM
    # @return [Array(GithubOrganization)]
    def get_scm_organisations(organization : String, scm : String, credential_id : String? = nil)
    ...
    # @param scm [String] Name of SCM
    # @return [Array<(Array(GithubOrganization), Integer, Hash)>] Array(GithubOrganization) data, response status code and response headers
    def get_scm_organisations_with_http_info(organization : String, scm : String, credential_id : String? = nil)
      if @api_client.config.debugging
    ...
    # @param run [String] Name of the run
    # @return [PipelineRun]
    def put_pipeline_run(organization : String, pipeline : String, run : String, blocking : String? = nil, time_out_in_secs : Int32? = nil)
    ...
    # @param run [String] Name of the run
    # @return [Array<(PipelineRun, Integer, Hash)>] PipelineRun data, response status code and response headers
    def put_pipeline_run_with_http_info(organization : String, pipeline : String, run : String, blocking : String? = nil, time_out_in_secs : Int32? = nil)
      if @api_client.config.debugging
