...
# Unit tests for OpenAPIClient::BranchImpllinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::BranchImpllinks do

  describe "test an instance of BranchImpllinks" do
    skip "should create an instance of BranchImpllinks" do
      #instance = OpenAPIClient::BranchImpllinks.new
      #expect(instance).to be_instance_of(OpenAPIClient::BranchImpllinks)
    end
  end
