...
# Unit tests for OpenAPIClient::Pipeline
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::Pipeline do

  describe "test an instance of Pipeline" do
    skip "should create an instance of Pipeline" do
      #instance = OpenAPIClient::Pipeline.new
      #expect(instance).to be_instance_of(OpenAPIClient::Pipeline)
    end
  end
