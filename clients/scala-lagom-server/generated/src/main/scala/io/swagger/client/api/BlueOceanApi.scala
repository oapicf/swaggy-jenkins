...
trait BlueOceanApi extends Service {
  ...
  /**
    ...
    */
  def getOrganisations(): ServiceCall[NotUsed ,Organisations]
  ...
  /**
    ...
    */
  def getPipelineActivities(organization: String, pipeline: String): ServiceCall[NotUsed ,PipelineActivities]
  ...
  /**
    ...
    */
  def getPipelineQueue(organization: String, pipeline: String): ServiceCall[NotUsed ,PipelineQueue]
  ...
  /**
    ...
    */
  def getPipelineRunNodeSteps(organization: String, pipeline: String, run: String, node: String): ServiceCall[NotUsed ,PipelineRunNodeSteps]
  ...
  /**
    ...
    */
  def getPipelineRunNodes(organization: String, pipeline: String, run: String): ServiceCall[NotUsed ,PipelineRunNodes]
  ...
  /**
    ...
    * @return PipelineRuns
    */
  def getPipelineRuns(organization: String, pipeline: String): ServiceCall[NotUsed ,PipelineRuns]
  ...
  /**
    ...
    * @return Pipelines
    */
  def getPipelines(organization: String): ServiceCall[NotUsed ,Pipelines]
  ...
  /**
    ...
    */
  def getSCMOrganisationRepositories(credentialId:           Option[String] = None,pageSize:           Option[Int] = None,pageNumber:           Option[Int] = Noneorganization: String, scm: String, scmOrganisation: String): ServiceCall[NotUsed ,ScmOrganisations]
  ...
  /**
    ...
    * @return ScmOrganisations
    */
  def getSCMOrganisationRepository(credentialId:           Option[String] = Noneorganization: String, scm: String, scmOrganisation: String, repository: String): ServiceCall[NotUsed ,ScmOrganisations]
  ...
  /**
    ...
    * @return ScmOrganisations
    */
  def getSCMOrganisations(credentialId:           Option[String] = Noneorganization: String, scm: String): ServiceCall[NotUsed ,ScmOrganisations]
  ...
  /**
    ...
    */
  def getUserFavorites(user: String): ServiceCall[NotUsed ,UserFavorites]
  ...
  /**
    ...
    */
  def putPipelineFavorite(organization: String, pipeline: String): ServiceCall[Body ,FavoriteImpl]
