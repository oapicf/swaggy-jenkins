...
InputStepImpllinks <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return InputStepImpllinks as a base R list.
    #' @examples
    #' # convert array of InputStepImpllinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert InputStepImpllinks to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(InputStepImpllinksObject)
    },
