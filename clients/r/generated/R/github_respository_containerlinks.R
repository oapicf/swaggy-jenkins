...
GithubRespositoryContainerlinks <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GithubRespositoryContainerlinks as a base R list.
    #' @examples
    #' # convert array of GithubRespositoryContainerlinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GithubRespositoryContainerlinks to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(GithubRespositoryContainerlinksObject)
    },
