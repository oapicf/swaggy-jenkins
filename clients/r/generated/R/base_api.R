...
BaseApi <- R6::R6Class(
  ...
  public = list(
    ...
    GetCrumb = function(data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$GetCrumbWithHttpInfo(data_file = data_file, ..., .parse = .parse)
    ...
    GetCrumbWithHttpInfo = function(data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
