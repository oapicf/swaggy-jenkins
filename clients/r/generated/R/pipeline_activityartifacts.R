...
PipelineActivityartifacts <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PipelineActivityartifacts as a base R list.
    #' @examples
    #' # convert array of PipelineActivityartifacts (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PipelineActivityartifacts to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PipelineActivityartifactsObject)
    },
