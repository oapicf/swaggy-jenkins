  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`artifacts`)) {
        self$`artifacts` <- ApiClient$new()$deserializeObj(this_object$`artifacts`, "array[PipelineRunartifacts]", loadNamespace("openapi"))
      }
...
# PipelineRun$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
