...
ResponseTimeMonitorData <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ResponseTimeMonitorData as a base R list.
    #' @examples
    #' # convert array of ResponseTimeMonitorData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ResponseTimeMonitorData to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ResponseTimeMonitorDataObject)
    },
