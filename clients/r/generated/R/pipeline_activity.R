...
PipelineActivity <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PipelineActivity as a base R list.
    #' @examples
    #' # convert array of PipelineActivity (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PipelineActivity to a base R type
    #'
