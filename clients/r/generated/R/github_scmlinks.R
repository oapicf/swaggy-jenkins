...
GithubScmlinks <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return GithubScmlinks as a base R list.
    #' @examples
    #' # convert array of GithubScmlinks (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert GithubScmlinks to a base R type
    #'
