...
StringParameterValue <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return StringParameterValue as a base R list.
    #' @examples
    #' # convert array of StringParameterValue (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert StringParameterValue to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(StringParameterValueObject)
    },
