...
```php
<?php
// src/Acme/MyBundle/Api/BaseAccessApiInterface.php

namespace Acme\MyBundle\Api;

use OpenAPI\Server\Api\BaseAccessApiInterface;

class BaseAccessApi implements BaseAccessApiInterface // An interface is autogenerated
{

    /**
     * Implementation of BaseAccessApiInterface#getCrumb
     */
...
services:
    # ...
    acme.my_bundle.api.baseAccess:
        class: Acme\MyBundle\Api\BaseAccessApi
        tags:
            - { name: "open_apiserver.api", api: "baseAccess" }
    # ...
```
...
------------ | ------------- | ------------- | -------------
*BaseAccessApiInterface* | [**getCrumb**](Resources/docs/Api/BaseAccessApiInterface.md#getcrumb) | **GET** /crumbIssuer/api/json | 
