...
use OpenAPI\Server\Model\GenericResource;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\GenericResource
 */
class GenericResourceTest extends TestCase
{
    protected GenericResource|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(GenericResource::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(GenericResource::class));
        $this->assertInstanceOf(GenericResource::class, $this->object);
    }
