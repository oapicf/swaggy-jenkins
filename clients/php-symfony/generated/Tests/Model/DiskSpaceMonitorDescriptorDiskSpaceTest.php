...
use OpenAPI\Server\Model\DiskSpaceMonitorDescriptorDiskSpace;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\DiskSpaceMonitorDescriptorDiskSpace
 */
class DiskSpaceMonitorDescriptorDiskSpaceTest extends TestCase
{
    protected DiskSpaceMonitorDescriptorDiskSpace|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(DiskSpaceMonitorDescriptorDiskSpace::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(DiskSpaceMonitorDescriptorDiskSpace::class));
        $this->assertInstanceOf(DiskSpaceMonitorDescriptorDiskSpace::class, $this->object);
    }
