...
use OpenAPI\Server\Model\CauseUserIdCause;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CauseUserIdCause
 */
class CauseUserIdCauseTest extends TestCase
{
    protected CauseUserIdCause|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CauseUserIdCause::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CauseUserIdCause::class));
        $this->assertInstanceOf(CauseUserIdCause::class, $this->object);
    }
