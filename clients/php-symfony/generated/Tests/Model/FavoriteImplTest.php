 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FavoriteImpl
 */
class FavoriteImplTest extends TestCase
{
    protected FavoriteImpl|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(FavoriteImpl::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FavoriteImpl::class));
        $this->assertInstanceOf(FavoriteImpl::class, $this->object);
    }
