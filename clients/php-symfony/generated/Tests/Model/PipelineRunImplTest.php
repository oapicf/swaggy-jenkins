...
use OpenAPI\Server\Model\PipelineRunImpl;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineRunImpl
 */
class PipelineRunImplTest extends TestCase
{
    protected PipelineRunImpl|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineRunImpl::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineRunImpl::class));
        $this->assertInstanceOf(PipelineRunImpl::class, $this->object);
    }
