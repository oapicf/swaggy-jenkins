...
use OpenAPI\Server\Model\QueueLeftItem;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\QueueLeftItem
 */
class QueueLeftItemTest extends TestCase
{
    protected QueueLeftItem|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(QueueLeftItem::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(QueueLeftItem::class));
        $this->assertInstanceOf(QueueLeftItem::class, $this->object);
    }
    ...
    {
        $this->markTestSkipped('Test for property executable not implemented');
    }
}
