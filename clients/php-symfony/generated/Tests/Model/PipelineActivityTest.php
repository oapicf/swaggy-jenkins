 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineActivity
 */
class PipelineActivityTest extends TestCase
{
    protected PipelineActivity|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineActivity::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineActivity::class));
        $this->assertInstanceOf(PipelineActivity::class, $this->object);
    }
