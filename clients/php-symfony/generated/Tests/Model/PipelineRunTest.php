 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineRun
 */
class PipelineRunTest extends TestCase
{
    protected PipelineRun|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineRun::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineRun::class));
        $this->assertInstanceOf(PipelineRun::class, $this->object);
    }
