 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineRunNode
 */
class PipelineRunNodeTest extends TestCase
{
    protected PipelineRunNode|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineRunNode::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineRunNode::class));
        $this->assertInstanceOf(PipelineRunNode::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyEdges(): void
    {
        $this->markTestSkipped('Test for property edges not implemented');
    }
