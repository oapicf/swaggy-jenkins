...
use OpenAPI\Server\Model\GithubRepository;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\GithubRepository
 */
class GithubRepositoryTest extends TestCase
{
    protected GithubRepository|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(GithubRepository::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(GithubRepository::class));
        $this->assertInstanceOf(GithubRepository::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyDefaultBranch(): void
    {
        $this->markTestSkipped('Test for property defaultBranch not implemented');
    }
