...
use OpenAPI\Server\Model\PipelineBranchesitemlatestRun;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineBranchesitemlatestRun
 */
class PipelineBranchesitemlatestRunTest extends TestCase
{
    protected PipelineBranchesitemlatestRun|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineBranchesitemlatestRun::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineBranchesitemlatestRun::class));
        $this->assertInstanceOf(PipelineBranchesitemlatestRun::class, $this->object);
    }
