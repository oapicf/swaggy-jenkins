 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelineImpl
 */
class PipelineImplTest extends TestCase
{
    protected PipelineImpl|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelineImpl::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelineImpl::class));
        $this->assertInstanceOf(PipelineImpl::class, $this->object);
    }
