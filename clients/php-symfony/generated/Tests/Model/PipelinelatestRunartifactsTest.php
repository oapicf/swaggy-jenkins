<?php
/**
 * PipelinelatestRunartifactsTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\PipelinelatestRunartifacts;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PipelinelatestRunartifacts
 */
class PipelinelatestRunartifactsTest extends TestCase
{
    protected PipelinelatestRunartifacts|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(PipelinelatestRunartifacts::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PipelinelatestRunartifacts::class));
        $this->assertInstanceOf(PipelinelatestRunartifacts::class, $this->object);
    }
