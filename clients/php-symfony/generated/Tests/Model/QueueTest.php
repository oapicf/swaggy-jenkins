 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Queue
 */
class QueueTest extends TestCase
{
    protected Queue|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(Queue::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Queue::class));
        $this->assertInstanceOf(Queue::class, $this->object);
    }
