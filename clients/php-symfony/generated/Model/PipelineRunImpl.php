...
class PipelineRunImpl 
{
     ...
     * @Type("OpenAPI\Server\Model\PipelineRunImpllinks")
     */
    #[Assert\Type("OpenAPI\Server\Model\PipelineRunImpllinks")]
    protected ?PipelineRunImpllinks $links = null;
     ...
     */
    public function getLinks(): ?PipelineRunImpllinks
    {
        return $this->links;
    }
     ...
     * @return $this
     */
    public function setLinks(?PipelineRunImpllinks $links = null): self
    {
        $this->links = $links;
