...
class QueueLeftItem 
{
    ...
    protected ?FreeStyleBuild $executable = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->executable = array_key_exists('executable', $data) ? $data['executable'] : $this->executable;
        }
    }
     ...
     * @return $this
     */
    public function setExecutable(?FreeStyleBuild $executable = null): self
    {
