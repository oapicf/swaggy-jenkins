...
void main() {
  final instance = Openapi().getBlueOceanApi();
  ...
  group(BlueOceanApi, () {
    ...
    //
    //Future<BuiltList<Organisation>> getOrganisations() async
    ...
    //
    //Future<BuiltList<PipelineActivity>> getPipelineActivities(String organization, String pipeline) async
    ...
    //
    //Future<BuiltList<QueueItemImpl>> getPipelineQueue(String organization, String pipeline) async
    ...
    //
    //Future<BuiltList<PipelineStepImpl>> getPipelineRunNodeSteps(String organization, String pipeline, String run, String node) async
    ...
    //
    //Future<BuiltList<PipelineRunNode>> getPipelineRunNodes(String organization, String pipeline, String run) async
    ...
    //
    //Future<BuiltList<PipelineRun>> getPipelineRuns(String organization, String pipeline) async
    ...
    //
    //Future<BuiltList<Pipeline>> getPipelines(String organization) async
    ...
    //
    //Future<BuiltList<GithubOrganization>> getSCMOrganisationRepositories(String organization, String scm, String scmOrganisation, { String credentialId, int pageSize, int pageNumber }) async
    ...
    //
    //Future<BuiltList<GithubOrganization>> getSCMOrganisationRepository(String organization, String scm, String scmOrganisation, String repository, { String credentialId }) async
    ...
    //
    //Future<BuiltList<GithubOrganization>> getSCMOrganisations(String organization, String scm, { String credentialId }) async
    ...
    //
    //Future<BuiltList<FavoriteImpl>> getUserFavorites(String user) async
