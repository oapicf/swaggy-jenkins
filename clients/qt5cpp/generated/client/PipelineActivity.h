...
class PipelineActivity: public SWGObject {
public:
    PipelineActivity();
    PipelineActivity(QString* json);
    ...
    PipelineActivity* fromJson(QString &jsonString);

    QString* getClass();
    void setClass(QString* _class);

    QList<PipelineActivityartifacts*>* getArtifacts();
    void setArtifacts(QList<PipelineActivityartifacts*>* artifacts);
...
private:
    QString* _class;
    QList<PipelineActivityartifacts*>* artifacts;
