...
class PipelineBranchesitemlatestRun: public SWGObject {
public:
    PipelineBranchesitemlatestRun();
    PipelineBranchesitemlatestRun(QString* json);
    ...
    PipelineBranchesitemlatestRun* fromJson(QString &jsonString);
