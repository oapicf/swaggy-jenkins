...
public interface RemoteAccessApiControllerImpInterface {
    ...
    void postCreateItem( @NotNull String name, String from, String mode, String jenkinsCrumb, String contentType, String body) throws Exception;

    void postCreateView( @NotNull String name, String jenkinsCrumb, String contentType, String body) throws Exception;
