...
public class HudsonassignedLabels   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<HudsonassignedLabels>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<HudsonassignedLabels> contraintes : constraintViolations) {
