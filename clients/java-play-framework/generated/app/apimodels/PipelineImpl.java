...
public class PipelineImpl   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineImpl>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineImpl> contraintes : constraintViolations) {
