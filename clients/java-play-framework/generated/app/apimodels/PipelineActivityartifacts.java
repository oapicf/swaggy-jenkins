...
public class PipelineActivityartifacts   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineActivityartifacts>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineActivityartifacts> contraintes : constraintViolations) {
