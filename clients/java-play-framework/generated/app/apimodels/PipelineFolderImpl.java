...
public class PipelineFolderImpl   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineFolderImpl>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineFolderImpl> contraintes : constraintViolations) {
