...
public class PipelineActivity   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineActivity>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineActivity> contraintes : constraintViolations) {
