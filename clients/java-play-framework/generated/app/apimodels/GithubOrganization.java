...
public class GithubOrganization   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<GithubOrganization>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<GithubOrganization> contraintes : constraintViolations) {
