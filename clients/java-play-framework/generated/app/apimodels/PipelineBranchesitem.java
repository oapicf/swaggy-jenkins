...
public class PipelineBranchesitem   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineBranchesitem>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineBranchesitem> contraintes : constraintViolations) {
