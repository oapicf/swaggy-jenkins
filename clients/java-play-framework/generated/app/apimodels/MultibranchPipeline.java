...
public class MultibranchPipeline   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<MultibranchPipeline>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<MultibranchPipeline> contraintes : constraintViolations) {
