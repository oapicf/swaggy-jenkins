...
public class ExtensionClassContainerImpl1map   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<ExtensionClassContainerImpl1map>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<ExtensionClassContainerImpl1map> contraintes : constraintViolations) {
