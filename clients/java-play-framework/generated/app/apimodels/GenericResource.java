...
public class GenericResource   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<GenericResource>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<GenericResource> contraintes : constraintViolations) {
