...
public class PipelineActivities extends ArrayList<PipelineActivity>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineActivities>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineActivities> contraintes : constraintViolations) {
