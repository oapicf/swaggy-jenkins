...
public class Organisations extends ArrayList<Organisation>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<Organisations>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<Organisations> contraintes : constraintViolations) {
