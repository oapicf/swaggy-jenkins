...
public class ScmOrganisations extends ArrayList<GithubOrganization>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<ScmOrganisations>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<ScmOrganisations> contraintes : constraintViolations) {
