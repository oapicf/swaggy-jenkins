...
public class FreeStyleProjectactions   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<FreeStyleProjectactions>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<FreeStyleProjectactions> contraintes : constraintViolations) {
