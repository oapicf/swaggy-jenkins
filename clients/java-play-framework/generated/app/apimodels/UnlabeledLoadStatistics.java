...
public class UnlabeledLoadStatistics   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<UnlabeledLoadStatistics>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<UnlabeledLoadStatistics> contraintes : constraintViolations) {
