...
public class PipelineQueue extends ArrayList<QueueItemImpl>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineQueue>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineQueue> contraintes : constraintViolations) {
