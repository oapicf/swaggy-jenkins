...
public class PipelineRunNode   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineRunNode>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineRunNode> contraintes : constraintViolations) {
