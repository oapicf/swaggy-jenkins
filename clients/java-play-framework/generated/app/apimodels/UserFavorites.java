...
public class UserFavorites extends ArrayList<FavoriteImpl>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<UserFavorites>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<UserFavorites> contraintes : constraintViolations) {
