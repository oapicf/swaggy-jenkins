...
public class PipelinelatestRun   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelinelatestRun>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelinelatestRun> contraintes : constraintViolations) {
