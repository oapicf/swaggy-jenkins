...
public class FreeStyleProject   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<FreeStyleProject>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<FreeStyleProject> contraintes : constraintViolations) {
