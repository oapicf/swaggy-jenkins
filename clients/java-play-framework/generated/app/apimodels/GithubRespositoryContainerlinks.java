...
public class GithubRespositoryContainerlinks   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<GithubRespositoryContainerlinks>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<GithubRespositoryContainerlinks> contraintes : constraintViolations) {
