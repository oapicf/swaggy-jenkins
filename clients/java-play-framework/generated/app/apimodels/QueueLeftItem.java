...
public class QueueLeftItem   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<QueueLeftItem>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<QueueLeftItem> contraintes : constraintViolations) {
