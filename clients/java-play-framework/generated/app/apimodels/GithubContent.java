...
public class GithubContent   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<GithubContent>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<GithubContent> contraintes : constraintViolations) {
