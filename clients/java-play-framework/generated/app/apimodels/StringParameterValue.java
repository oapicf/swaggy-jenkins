...
public class StringParameterValue   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<StringParameterValue>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<StringParameterValue> contraintes : constraintViolations) {
