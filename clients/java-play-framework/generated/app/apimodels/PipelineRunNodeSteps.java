...
public class PipelineRunNodeSteps extends ArrayList<PipelineStepImpl>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineRunNodeSteps>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineRunNodeSteps> contraintes : constraintViolations) {
