...
public class PipelinelatestRunartifacts   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelinelatestRunartifacts>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelinelatestRunartifacts> contraintes : constraintViolations) {
