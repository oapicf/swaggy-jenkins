...
import apimodels.InputStepImpl;
import apimodels.PipelineStepImpllinks;
...
public class PipelineStepImpl   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineStepImpl>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineStepImpl> contraintes : constraintViolations) {
