...
import apimodels.PipelineBranchesitem;
...
public class PipelineBranches extends ArrayList<PipelineBranchesitem>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineBranches>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineBranches> contraintes : constraintViolations) {
