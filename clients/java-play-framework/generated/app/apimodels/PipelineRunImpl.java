...
public class PipelineRunImpl   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineRunImpl>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineRunImpl> contraintes : constraintViolations) {
