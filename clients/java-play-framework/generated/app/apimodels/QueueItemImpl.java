...
public class QueueItemImpl   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<QueueItemImpl>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<QueueItemImpl> contraintes : constraintViolations) {
