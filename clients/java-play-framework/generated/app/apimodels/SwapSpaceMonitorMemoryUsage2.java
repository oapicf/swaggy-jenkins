...
public class SwapSpaceMonitorMemoryUsage2   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<SwapSpaceMonitorMemoryUsage2>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<SwapSpaceMonitorMemoryUsage2> contraintes : constraintViolations) {
