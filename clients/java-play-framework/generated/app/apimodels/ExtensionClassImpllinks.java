...
public class ExtensionClassImpllinks   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<ExtensionClassImpllinks>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<ExtensionClassImpllinks> contraintes : constraintViolations) {
