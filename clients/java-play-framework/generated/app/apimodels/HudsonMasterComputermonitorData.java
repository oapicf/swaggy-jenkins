...
public class HudsonMasterComputermonitorData   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<HudsonMasterComputermonitorData>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<HudsonMasterComputermonitorData> contraintes : constraintViolations) {
