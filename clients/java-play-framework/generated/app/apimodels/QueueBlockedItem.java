...
public class QueueBlockedItem   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<QueueBlockedItem>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<QueueBlockedItem> contraintes : constraintViolations) {
