...
public class Organisation   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<Organisation>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<Organisation> contraintes : constraintViolations) {
