...
public class ClockDifference   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<ClockDifference>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<ClockDifference> contraintes : constraintViolations) {
