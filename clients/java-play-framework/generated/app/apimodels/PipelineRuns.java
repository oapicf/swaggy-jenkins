...
public class PipelineRuns extends ArrayList<PipelineRun>  {
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<PipelineRuns>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<PipelineRuns> contraintes : constraintViolations) {
