...
public class GithubRepository   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<GithubRepository>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<GithubRepository> contraintes : constraintViolations) {
