...
public class InputStepImpllinks   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<InputStepImpllinks>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<InputStepImpllinks> contraintes : constraintViolations) {
