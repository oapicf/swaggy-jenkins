...
public class HudsonMasterComputer   {
  ...
  **/
  ...
  public void validate() {
    ...
    Set<ConstraintViolation<HudsonMasterComputer>> constraintViolations = validator.validate(this);
    if (constraintViolations.size() > 0) {
      StringBuilder errors = new StringBuilder();
      for (ConstraintViolation<HudsonMasterComputer> contraintes : constraintViolations) {
