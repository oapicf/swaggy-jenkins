 ...
 * @version 1.1.2-pre.0
 */
var DefaultCrumbIssuer = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DefaultCrumbIssuer</code>.
   * @alias module:model/DefaultCrumbIssuer
   */
  function DefaultCrumbIssuer() {
    _classCallCheck(this, DefaultCrumbIssuer);
  ...
  _createClass(DefaultCrumbIssuer, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('crumb')) {
          obj['crumb'] = _ApiClient["default"].convertToType(data['crumb'], 'String');
        }

        if (data.hasOwnProperty('crumbRequestField')) {
          obj['crumbRequestField'] = _ApiClient["default"].convertToType(data['crumbRequestField'], 'String');
        }
      }
...
var _default = DefaultCrumbIssuer;
