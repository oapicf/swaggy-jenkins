...
var _ExtensionClassImpllinks = _interopRequireDefault(require("./ExtensionClassImpllinks"));
 ...
 * @version 1.1.2-pre.0
 */
var ExtensionClassImpl = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ExtensionClassImpl</code>.
   * @alias module:model/ExtensionClassImpl
   */
  function ExtensionClassImpl() {
    _classCallCheck(this, ExtensionClassImpl);
  ...
  _createClass(ExtensionClassImpl, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('_links')) {
          obj['_links'] = _ExtensionClassImpllinks["default"].constructFromObject(data['_links']);
        }

        if (data.hasOwnProperty('classes')) {
          obj['classes'] = _ApiClient["default"].convertToType(data['classes'], ['String']);
        }
      }
...
var _default = ExtensionClassImpl;
