...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.FavoriteImpl();
  });
  ...
  describe('FavoriteImpl', function() {
    it('should create an instance of FavoriteImpl', function() {
      // uncomment below and update the code to test FavoriteImpl
      //var instance = new SwaggyJenkins.FavoriteImpl();
      //expect(instance).to.be.a(SwaggyJenkins.FavoriteImpl);
    });
