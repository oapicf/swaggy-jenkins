...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.GithubScm();
  });
  ...
  describe('GithubScm', function() {
    it('should create an instance of GithubScm', function() {
      // uncomment below and update the code to test GithubScm
      //var instance = new SwaggyJenkins.GithubScm();
      //expect(instance).to.be.a(SwaggyJenkins.GithubScm);
    });
