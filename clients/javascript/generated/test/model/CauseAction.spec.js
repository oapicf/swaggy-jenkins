...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.CauseAction();
  });
  ...
  describe('CauseAction', function() {
    it('should create an instance of CauseAction', function() {
      // uncomment below and update the code to test CauseAction
      //var instance = new SwaggyJenkins.CauseAction();
      //expect(instance).to.be.a(SwaggyJenkins.CauseAction);
    });
