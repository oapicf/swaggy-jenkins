...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.QueueBlockedItem();
  });
  ...
  describe('QueueBlockedItem', function() {
    it('should create an instance of QueueBlockedItem', function() {
      // uncomment below and update the code to test QueueBlockedItem
      //var instance = new SwaggyJenkins.QueueBlockedItem();
      //expect(instance).to.be.a(SwaggyJenkins.QueueBlockedItem);
    });
    ...
    it('should have the property buildableStartMilliseconds (base name: "buildableStartMilliseconds")', function() {
      // uncomment below and update the code to test the property buildableStartMilliseconds
      //var instance = new SwaggyJenkins.QueueBlockedItem();
      //expect(instance).to.be();
    });
