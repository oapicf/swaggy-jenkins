...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.ClockDifference();
  });
  ...
  describe('ClockDifference', function() {
    it('should create an instance of ClockDifference', function() {
      // uncomment below and update the code to test ClockDifference
      //var instance = new SwaggyJenkins.ClockDifference();
      //expect(instance).to.be.a(SwaggyJenkins.ClockDifference);
    });
