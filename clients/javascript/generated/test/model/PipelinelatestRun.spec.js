...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.PipelinelatestRun();
  });
  ...
  describe('PipelinelatestRun', function() {
    it('should create an instance of PipelinelatestRun', function() {
      // uncomment below and update the code to test PipelinelatestRun
      //var instance = new SwaggyJenkins.PipelinelatestRun();
      //expect(instance).to.be.a(SwaggyJenkins.PipelinelatestRun);
    });
