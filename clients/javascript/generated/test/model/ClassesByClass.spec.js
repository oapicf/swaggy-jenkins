...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.ClassesByClass();
  });
  ...
  describe('ClassesByClass', function() {
    it('should create an instance of ClassesByClass', function() {
      // uncomment below and update the code to test ClassesByClass
      //var instance = new SwaggyJenkins.ClassesByClass();
      //expect(instance).to.be.a(SwaggyJenkins.ClassesByClass);
    });
