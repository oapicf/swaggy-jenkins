...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.CauseUserIdCause();
  });
  ...
  describe('CauseUserIdCause', function() {
    it('should create an instance of CauseUserIdCause', function() {
      // uncomment below and update the code to test CauseUserIdCause
      //var instance = new SwaggyJenkins.CauseUserIdCause();
      //expect(instance).to.be.a(SwaggyJenkins.CauseUserIdCause);
    });
