...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PipelineRunartifacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PipelineRunartifacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.PipelineRun = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.PipelineRunartifacts);
  }
}(this, function(ApiClient, PipelineRunartifacts) {
  'use strict';
