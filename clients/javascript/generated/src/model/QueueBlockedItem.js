...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CauseAction', 'model/FreeStyleProject'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CauseAction'), require('./FreeStyleProject'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.QueueBlockedItem = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.CauseAction, root.SwaggyJenkins.FreeStyleProject);
  }
}(this, function(ApiClient, CauseAction, FreeStyleProject) {
  'use strict';
