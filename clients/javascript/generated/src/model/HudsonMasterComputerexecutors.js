...
class HudsonMasterComputerexecutors {
    ...
    /**
     * Validates the JSON data with respect to <code>HudsonMasterComputerexecutors</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HudsonMasterComputerexecutors</code>.
     */
    static validateJSON(data) {
        // validate the optional field `currentExecutable`
        if (data['currentExecutable']) { // data not null
          FreeStyleBuild.validateJSON(data['currentExecutable']);
        }
