...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SwaggyjenkinsPipelineActivityartifacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SwaggyjenkinsPipelineActivityartifacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.SwaggyjenkinsPipelineActivity = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.SwaggyjenkinsPipelineActivityartifacts);
  }
}(this, function(ApiClient, SwaggyjenkinsPipelineActivityartifacts) {
  'use strict';
  ...
  /**
   * The SwaggyjenkinsPipelineActivity model module.
   * @module model/SwaggyjenkinsPipelineActivity
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>SwaggyjenkinsPipelineActivity</code>.
   * @alias module:model/SwaggyjenkinsPipelineActivity
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggyjenkinsPipelineActivity</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggyjenkinsPipelineActivity} obj Optional instance to populate.
   * @return {module:model/SwaggyjenkinsPipelineActivity} The populated <code>SwaggyjenkinsPipelineActivity</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('artifacts')) {
        obj['artifacts'] = ApiClient.convertToType(data['artifacts'], [SwaggyjenkinsPipelineActivityartifacts]);
      }
  ...
  /**
   * @member {Array.<module:model/SwaggyjenkinsPipelineActivityartifacts>} artifacts
   */
