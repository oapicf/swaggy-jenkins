...
class QueueLeftItem {
    ...
    /**
     * Validates the JSON data with respect to <code>QueueLeftItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueueLeftItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['executable']) { // data not null
          FreeStyleBuild.validateJSON(data['executable']);
        }
