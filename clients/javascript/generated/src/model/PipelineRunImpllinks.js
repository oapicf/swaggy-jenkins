...
class PipelineRunImpllinks {
    ...
    /**
     * Validates the JSON data with respect to <code>PipelineRunImpllinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelineRunImpllinks</code>.
     */
    static validateJSON(data) {
        // validate the optional field `nodes`
        if (data['nodes']) { // data not null
          Link.validateJSON(data['nodes']);
        }
        // validate the optional field `log`
        if (data['log']) { // data not null
          Link.validateJSON(data['log']);
        }
