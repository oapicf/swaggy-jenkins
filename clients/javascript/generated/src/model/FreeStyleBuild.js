...
class FreeStyleBuild {
    ...
    /**
     * Validates the JSON data with respect to <code>FreeStyleBuild</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FreeStyleBuild</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['builtOn'] && !(typeof data['builtOn'] === 'string' || data['builtOn'] instanceof String)) {
            throw new Error("Expected the field `builtOn` to be a primitive type in the JSON string but got " + data['builtOn']);
        }
        // validate the optional field `changeSet`
        if (data['changeSet']) { // data not null
          EmptyChangeLogSet.validateJSON(data['changeSet']);
        }
