...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GithubRepositories', 'model/GithubRespositoryContainerlinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GithubRepositories'), require('./GithubRespositoryContainerlinks'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.GithubRespositoryContainer = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.GithubRepositories, root.SwaggyJenkins.GithubRespositoryContainerlinks);
  }
}(this, function(ApiClient, GithubRepositories, GithubRespositoryContainerlinks) {
  'use strict';
