...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/HudsonMasterComputerexecutors', 'model/HudsonMasterComputermonitorData', 'model/Label1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HudsonMasterComputerexecutors'), require('./HudsonMasterComputermonitorData'), require('./Label1'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.HudsonMasterComputer = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.HudsonMasterComputerexecutors, root.SwaggyJenkins.HudsonMasterComputermonitorData, root.SwaggyJenkins.Label1);
  }
}(this, function(ApiClient, HudsonMasterComputerexecutors, HudsonMasterComputermonitorData, Label1) {
  'use strict';
