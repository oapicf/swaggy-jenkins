...
class ExtensionClassImpl {
    ...
    /**
     * Validates the JSON data with respect to <code>ExtensionClassImpl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtensionClassImpl</code>.
     */
    static validateJSON(data) {
        ...
        if (data['_links']) { // data not null
          ExtensionClassImpllinks.validateJSON(data['_links']);
        }
