...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PipelinelatestRunartifacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PipelinelatestRunartifacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.PipelinelatestRun = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.PipelinelatestRunartifacts);
  }
}(this, function(ApiClient, PipelinelatestRunartifacts) {
  'use strict';
