...
class PipelinelatestRun {
    ...
    /**
     * Validates the JSON data with respect to <code>PipelinelatestRun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PipelinelatestRun</code>.
     */
    static validateJSON(data) {
        if (data['artifacts']) { // data not null
            ...
            for (const item of data['artifacts']) {
                PipelinelatestRunartifacts.validateJSON(item);
            };
        }
