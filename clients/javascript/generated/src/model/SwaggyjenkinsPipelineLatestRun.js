...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SwaggyjenkinsPipelineLatestRunartifacts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SwaggyjenkinsPipelineLatestRunartifacts'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggyJenkins) {
      root.SwaggyJenkins = {};
    }
    root.SwaggyJenkins.SwaggyjenkinsPipelineLatestRun = factory(root.SwaggyJenkins.ApiClient, root.SwaggyJenkins.SwaggyjenkinsPipelineLatestRunartifacts);
  }
}(this, function(ApiClient, SwaggyjenkinsPipelineLatestRunartifacts) {
  'use strict';
  ...
  /**
   * The SwaggyjenkinsPipelineLatestRun model module.
   * @module model/SwaggyjenkinsPipelineLatestRun
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>SwaggyjenkinsPipelineLatestRun</code>.
   * @alias module:model/SwaggyjenkinsPipelineLatestRun
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggyjenkinsPipelineLatestRun</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggyjenkinsPipelineLatestRun} obj Optional instance to populate.
   * @return {module:model/SwaggyjenkinsPipelineLatestRun} The populated <code>SwaggyjenkinsPipelineLatestRun</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('artifacts')) {
        obj['artifacts'] = ApiClient.convertToType(data['artifacts'], [SwaggyjenkinsPipelineLatestRunartifacts]);
      }
  ...
  /**
   * @member {Array.<module:model/SwaggyjenkinsPipelineLatestRunartifacts>} artifacts
   */
