...
export class RemoteAccessService {
    ...
    public getComputer(depth: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <ComputerSet>(httpResponse.response));
        }
        return response;
    }
    ...
    public getCrumb(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <DefaultCrumbIssuer>(httpResponse.response));
        }
        return response;
    }
    ...
    public getJenkins(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <Hudson>(httpResponse.response));
        }
        return response;
    }
    ...
    public getJob(name: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <FreeStyleProject>(httpResponse.response));
        }
        return response;
    }
    ...
    public getJobLastBuild(name: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <FreeStyleBuild>(httpResponse.response));
        }
        return response;
    }
    ...
    public getQueue(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <Queue>(httpResponse.response));
        }
        return response;
    }
    ...
    public getView(name: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        if (observe == 'body') {
               return response.map(httpResponse => <ListView>(httpResponse.response));
        }
        return response;
    }
