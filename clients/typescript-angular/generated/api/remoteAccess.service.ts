...
export class RemoteAccessService {
     ...
     */
    public getComputer(depth: number, extraHttpRequestParams?: any): Observable<ComputerSet> {
        return this.getComputerWithHttpInfo(depth, extraHttpRequestParams)
     ...
     */
    public getCrumb(extraHttpRequestParams?: any): Observable<DefaultCrumbIssuer> {
     ...
     */
    public getJenkins(extraHttpRequestParams?: any): Observable<Hudson> {
     ...
     */
    public getJob(name: string, extraHttpRequestParams?: any): Observable<FreeStyleProject> {
     ...
     * @param name Name of the job
     */
    public getJobLastBuild(name: string, extraHttpRequestParams?: any): Observable<FreeStyleBuild> {
     ...
     */
    public getQueue(extraHttpRequestParams?: any): Observable<Queue> {
     ...
     */
    public getQueueItem(number: string, extraHttpRequestParams?: any): Observable<Queue> {
     ...
     */
    public getView(name: string, extraHttpRequestParams?: any): Observable<ListView> {
     ...
     * @param depth Recursion depth in response model
     */
    public getComputerWithHttpInfo(depth: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/computer/api/json';
        ...
        if (depth !== undefined) {
            queryParameters.set('depth', <any>depth);
        }
