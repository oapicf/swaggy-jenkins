...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class HostConfiguration
    {
            ...
            Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IBaseApi, BaseApi>("Org.OpenAPITools.Api.IBaseApi", client));
            builders.Add(_services.AddHttpClient<IBlueOceanApi, BlueOceanApi>("Org.OpenAPITools.Api.IBlueOceanApi", client));
            builders.Add(_services.AddHttpClient<IRemoteAccessApi, RemoteAccessApi>("Org.OpenAPITools.Api.IRemoteAccessApi", client));
