...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FreeStyleBuild : IValidatableObject
    {
        ...
        public bool? Building { get { return this.BuildingOption.Value; } set { this.BuildingOption = new(value); } }
        ...
        public int? EstimatedDuration { get { return this.EstimatedDurationOption.Value; } set { this.EstimatedDurationOption = new(value); } }
        ...
        public string? Executor { get { return this.ExecutorOption.Value; } set { this.ExecutorOption = new(value); } }
        ...
        public bool? KeepLog { get { return this.KeepLogOption.Value; } set { this.KeepLogOption = new(value); } }
        ...
        public int? QueueId { get { return this.QueueIdOption.Value; } set { this.QueueIdOption = new(value); } }
        ...
        public string? BuiltOn { get { return this.BuiltOnOption.Value; } set { this.BuiltOnOption = new(value); } }
        ...
        public EmptyChangeLogSet? ChangeSet { get { return this.ChangeSetOption.Value; } set { this.ChangeSetOption = new(value); } }
    ...
    /// </summary>
    public partial class FreeStyleBuildJsonConverter : JsonConverter<FreeStyleBuild>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FreeStyleBuildJsonConverter" /> class.
        /// </summary>
        public FreeStyleBuildJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "actions":
                            ...
                            break;
                        case "building":
                            building = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "description":
                        ...
                        case "estimatedDuration":
                            estimatedDuration = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "executor":
                        ...
                        case "id":
                            ...
                            break;
                        case "keepLog":
                            keepLog = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "queueId":
                            queueId = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "result":
