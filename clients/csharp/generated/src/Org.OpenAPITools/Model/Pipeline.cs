...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Pipeline : IValidatableObject
    {
        ...
        public Pipeline(string varClass = default(string), string organization = default(string), string name = default(string), string displayName = default(string), string fullName = default(string), int weatherScore = default(int), int estimatedDurationInMillis = default(int), PipelinelatestRun latestRun = default(PipelinelatestRun))
        {
