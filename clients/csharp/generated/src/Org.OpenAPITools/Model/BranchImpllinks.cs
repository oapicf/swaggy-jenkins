...
namespace Org.OpenAPITools.Model
{
    ...
    /// BranchImpllinks
    /// </summary>
    [DataContract(Name = "BranchImpllinks")]
    public partial class BranchImpllinks : IValidatableObject
    {
        ...
        public BranchImpllinks(Link self = default(Link), Link actions = default(Link), Link runs = default(Link), Link queue = default(Link), string varClass = default(string))
        {
            this.Self = self;
