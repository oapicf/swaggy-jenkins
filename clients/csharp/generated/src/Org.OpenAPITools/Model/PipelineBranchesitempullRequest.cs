...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PipelineBranchesitempullRequest : IValidatableObject
    {
        ...
        public PipelineBranchesitempullRequestlinks? Links { get { return this.LinksOption.Value; } set { this.LinksOption = new(value); } }
    ...
    /// </summary>
    public partial class PipelineBranchesitempullRequestJsonConverter : JsonConverter<PipelineBranchesitempullRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PipelineBranchesitempullRequestJsonConverter" /> class.
        /// </summary>
        public PipelineBranchesitempullRequestJsonConverter()
        {
            OnCreated();
        }
