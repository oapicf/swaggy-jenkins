...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class HudsonMasterComputerexecutors : IValidatableObject
    {
        ...
        public FreeStyleBuild? CurrentExecutable { get { return this.CurrentExecutableOption.Value; } set { this.CurrentExecutableOption = new(value); } }
        ...
        public bool? LikelyStuck { get { return this.LikelyStuckOption.Value; } set { this.LikelyStuckOption = new(value); } }
    ...
    /// </summary>
    public partial class HudsonMasterComputerexecutorsJsonConverter : JsonConverter<HudsonMasterComputerexecutors>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HudsonMasterComputerexecutorsJsonConverter" /> class.
        /// </summary>
        public HudsonMasterComputerexecutorsJsonConverter()
        {
            OnCreated();
        }
