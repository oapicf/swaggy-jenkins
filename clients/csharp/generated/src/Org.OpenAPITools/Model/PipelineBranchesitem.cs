...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PipelineBranchesitem : IValidatableObject
    {
        ...
        public PipelineBranchesitem(string displayName = default(string), int estimatedDurationInMillis = default(int), string name = default(string), int weatherScore = default(int), PipelineBranchesitemlatestRun latestRun = default(PipelineBranchesitemlatestRun), string organization = default(string), PipelineBranchesitempullRequest pullRequest = default(PipelineBranchesitempullRequest), int totalNumberOfPullRequests = default(int), string varClass = default(string))
        {
