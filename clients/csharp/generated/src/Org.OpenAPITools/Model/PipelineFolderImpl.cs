...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PipelineFolderImpl : IValidatableObject
    {
        ...
        public int? NumberOfFolders { get { return this.NumberOfFoldersOption.Value; } set { this.NumberOfFoldersOption = new(value); } }
        ...
        public int? NumberOfPipelines { get { return this.NumberOfPipelinesOption.Value; } set { this.NumberOfPipelinesOption = new(value); } }
    ...
    /// </summary>
    public partial class PipelineFolderImplJsonConverter : JsonConverter<PipelineFolderImpl>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PipelineFolderImplJsonConverter" /> class.
        /// </summary>
        public PipelineFolderImplJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "numberOfFolders":
                            numberOfFolders = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "numberOfPipelines":
                            numberOfPipelines = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        default:
                            break;
                    }
