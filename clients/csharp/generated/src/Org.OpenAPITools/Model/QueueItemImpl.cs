...
namespace Org.OpenAPITools.Model
{
    ...
    /// QueueItemImpl
    /// </summary>
    [DataContract(Name = "QueueItemImpl")]
    public partial class QueueItemImpl : IValidatableObject
    {
        ...
        public QueueItemImpl(string varClass = default(string), int expectedBuildNumber = default(int), string id = default(string), string pipeline = default(string), int queuedTime = default(int))
        {
