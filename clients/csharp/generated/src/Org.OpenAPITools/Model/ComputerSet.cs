...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ComputerSet : IValidatableObject
    {
        ...
        public int? BusyExecutors { get { return this.BusyExecutorsOption.Value; } set { this.BusyExecutorsOption = new(value); } }
        ...
        public List<HudsonMasterComputer>? Computer { get { return this.ComputerOption.Value; } set { this.ComputerOption = new(value); } }
        ...
        public int? TotalExecutors { get { return this.TotalExecutorsOption.Value; } set { this.TotalExecutorsOption = new(value); } }
    ...
    /// </summary>
    public partial class ComputerSetJsonConverter : JsonConverter<ComputerSet>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ComputerSetJsonConverter" /> class.
        /// </summary>
        public ComputerSetJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "_class":
                            ...
                            break;
                        case "busyExecutors":
                            busyExecutors = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "computer":
                        ...
                        case "displayName":
                            ...
                            break;
                        case "totalExecutors":
                            totalExecutors = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        default:
                            break;
                    }
