...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GithubRespositoryContainer")]
    public partial class GithubRespositoryContainer : IValidatableObject
    {
        ...
        public GithubRespositoryContainer(string varClass = default(string), GithubRespositoryContainerlinks links = default(GithubRespositoryContainerlinks), GithubRepositories repositories = default(GithubRepositories))
        {
