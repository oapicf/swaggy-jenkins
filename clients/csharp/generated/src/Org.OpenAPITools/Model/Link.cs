...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Link : IValidatableObject
    {
        ...
        public string? Href { get { return this.HrefOption.Value; } set { this.HrefOption = new(value); } }
    ...
    /// </summary>
    public partial class LinkJsonConverter : JsonConverter<Link>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LinkJsonConverter" /> class.
        /// </summary>
        public LinkJsonConverter()
        {
            OnCreated();
        }
