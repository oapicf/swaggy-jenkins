...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PipelineRun : IValidatableObject
    {
        ...
        public PipelineRun(string varClass = default(string), List<PipelineRunartifacts> artifacts = default(List<PipelineRunartifacts>), int durationInMillis = default(int), int estimatedDurationInMillis = default(int), string enQueueTime = default(string), string endTime = default(string), string id = default(string), string organization = default(string), string pipeline = default(string), string result = default(string), string runSummary = default(string), string startTime = default(string), string state = default(string), string type = default(string), string commitId = default(string))
        {
