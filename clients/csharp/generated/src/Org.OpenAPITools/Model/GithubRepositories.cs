...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GithubRepositories : IValidatableObject
    {
        ...
        public GithubRepositories(string varClass = default(string), GithubRepositorieslinks links = default(GithubRepositorieslinks), List<GithubRepository> items = default(List<GithubRepository>), int lastPage = default(int), int nextPage = default(int), int pageSize = default(int))
        {
