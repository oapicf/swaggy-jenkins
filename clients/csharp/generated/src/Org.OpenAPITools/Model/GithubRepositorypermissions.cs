...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GithubRepositorypermissions : IValidatableObject
    {
        ...
        public bool? Push { get { return this.PushOption.Value; } set { this.PushOption = new(value); } }
        ...
        public bool? Pull { get { return this.PullOption.Value; } set { this.PullOption = new(value); } }
    ...
    /// </summary>
    public partial class GithubRepositorypermissionsJsonConverter : JsonConverter<GithubRepositorypermissions>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GithubRepositorypermissionsJsonConverter" /> class.
        /// </summary>
        public GithubRepositorypermissionsJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "admin":
                            ...
                            break;
                        case "push":
                            push = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "pull":
                            pull = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        case "_class":
