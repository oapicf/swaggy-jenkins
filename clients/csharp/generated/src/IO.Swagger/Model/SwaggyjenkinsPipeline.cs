...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwaggyjenkinsPipeline :  IEquatable<SwaggyjenkinsPipeline>, IValidatableObject
    {
        /// <summary>
        ...
        public SwaggyjenkinsPipeline(string _Class = default(string), string Organization = default(string), string Name = default(string), string DisplayName = default(string), string FullName = default(string), int? WeatherScore = default(int?), int? EstimatedDurationInMillis = default(int?), SwaggyjenkinsPipelineLatestRun LatestRun = default(SwaggyjenkinsPipelineLatestRun))
        {
            this._Class = _Class;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SwaggyjenkinsPipeline);
        }
