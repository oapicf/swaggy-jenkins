...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HudsonutilClockDifference :  IEquatable<HudsonutilClockDifference>, IValidatableObject
    {
        /// <summary>
        ...
        public HudsonutilClockDifference(string _Class = default(string), int? Diff = default(int?))
        {
            this._Class = _Class;
            this.Diff = Diff;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HudsonutilClockDifference);
        }
