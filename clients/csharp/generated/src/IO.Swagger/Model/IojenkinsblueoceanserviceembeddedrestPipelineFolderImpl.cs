...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl :  IEquatable<IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl>, IValidatableObject
    {
        /// <summary>
        ...
        public IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl(string _Class = default(string), string DisplayName = default(string), string FullName = default(string), string Name = default(string), string Organization = default(string), int? NumberOfFolders = default(int?), int? NumberOfPipelines = default(int?))
        {
            this._Class = _Class;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl);
        }
