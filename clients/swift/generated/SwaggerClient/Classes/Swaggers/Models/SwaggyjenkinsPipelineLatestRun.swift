//
// SwaggyjenkinsPipelineLatestRun.swift
//
...
public class SwaggyjenkinsPipelineLatestRun: JSONEncodable {
    public var artifacts: [SwaggyjenkinsPipelineLatestRunartifacts]?
