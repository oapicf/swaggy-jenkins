...
object Paths {
     ...
     */
    @Location("/blue/rest/classes/{class}") class getClasses(val &#x60;class&#x60;: kotlin.String)
     ...
     */
    @Location("/jwt-auth/token") class getJsonWebToken(val expiryTimeInMins: kotlin.Int, val maxExpiryTimeInMins: kotlin.Int)
     ...
     */
    @Location("/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/log") class getPipelineRunLog(val organization: kotlin.String, val pipeline: kotlin.String, val run: kotlin.String, val start: kotlin.Int, val download: kotlin.Boolean)
     ...
     * @param credentialId Credential ID (optional)
     */
    @Location("/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories/{repository}") class getSCMOrganisationRepository(val organization: kotlin.String, val scm: kotlin.String, val scmOrganisation: kotlin.String, val repository: kotlin.String, val credentialId: kotlin.String)
     ...
     * @param credentialId Credential ID (optional)
     */
    @Location("/blue/rest/organizations/{organization}/scm/{scm}/organizations") class getSCMOrganisations(val organization: kotlin.String, val scm: kotlin.String, val credentialId: kotlin.String)
