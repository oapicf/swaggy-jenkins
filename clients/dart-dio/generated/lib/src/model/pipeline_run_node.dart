...
class _$PipelineRunNodeSerializer implements PrimitiveSerializer<PipelineRunNode> {
  @override
  ...
  void _deserializeProperties(
    ...
    required PipelineRunNodeBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'edges':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(PipelineRunNodeedges)]),
          ) as BuiltList<PipelineRunNodeedges>?;
          if (valueDes == null) continue;
