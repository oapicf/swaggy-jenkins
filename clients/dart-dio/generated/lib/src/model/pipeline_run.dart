...
class _$PipelineRunSerializer implements PrimitiveSerializer<PipelineRun> {
  @override
  ...
  void _deserializeProperties(
    ...
    required PipelineRunBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'artifacts':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(PipelineRunartifacts)]),
          ) as BuiltList<PipelineRunartifacts>?;
          if (valueDes == null) continue;
