...
abstract class DefaultCrumbIssuer implements Built<DefaultCrumbIssuer, DefaultCrumbIssuerBuilder> {
    ...
    static void _initializeBuilder(DefaultCrumbIssuerBuilder b) => b;
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                case r'_class':
                    ...
                    break;
                case r'crumb':
                    result.crumb = serializers.deserialize(value,
                        specifiedType: const FullType(String)) as String;
                    break;
                case r'crumbRequestField':
                    result.crumbRequestField = serializers.deserialize(value,
                        specifiedType: const FullType(String)) as String;
                    break;
            }
        }
