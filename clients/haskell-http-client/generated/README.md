## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Swaggy Jenkins`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Swaggy Jenkins API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | SwaggyJenkins                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | swaggy-jenkins                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | SwaggyJenkinsConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | SwaggyJenkinsRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| SwaggyJenkins.Client    | use the "dispatch" functions to send requests       |
| SwaggyJenkins.Core      | core functions, config and request types            |
| SwaggyJenkins.API       | construct api requests                              |
| SwaggyJenkins.Model     | describes api models                                |
| SwaggyJenkins.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| SwaggyJenkins.ModelLens | lenses for model fields                             |
| SwaggyJenkins.Logging   | logging functions and utils                         |
