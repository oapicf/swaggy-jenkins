...
module SwaggyJenkins.Core where
...
-- | 
data SwaggyJenkinsConfig = SwaggyJenkinsConfig
...
-- | display the config
instance P.Show SwaggyJenkinsConfig where
  show c =
    T.printf
...
-- | constructs a default SwaggyJenkinsConfig
--
-- configHost:
--
-- @http://localhost@
...
-- configUserAgent:
--
-- @"swaggy-jenkins/0.1.0.0"@
--
newConfig :: IO SwaggyJenkinsConfig
newConfig = do
    logCxt <- initLogContext
    return $ SwaggyJenkinsConfig
        { configHost = "http://localhost"
        , configUserAgent = "swaggy-jenkins/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => SwaggyJenkinsConfig -> auth -> SwaggyJenkinsConfig
addAuthMethod config@SwaggyJenkinsConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: SwaggyJenkinsConfig -> IO SwaggyJenkinsConfig
...
withStderrLogging :: SwaggyJenkinsConfig -> IO SwaggyJenkinsConfig
...
withNoLogging :: SwaggyJenkinsConfig -> SwaggyJenkinsConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * SwaggyJenkinsRequest
...
data SwaggyJenkinsRequest req contentType res accept = SwaggyJenkinsRequest
  { rMethod  :: NH.Method   -- ^ Method of SwaggyJenkinsRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of SwaggyJenkinsRequest
  , rParams   :: Params -- ^ params of SwaggyJenkinsRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (SwaggyJenkinsRequest req contentType res accept) NH.Method
rMethodL f SwaggyJenkinsRequest{..} = (\rMethod -> SwaggyJenkinsRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (SwaggyJenkinsRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f SwaggyJenkinsRequest{..} = (\rUrlPath -> SwaggyJenkinsRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (SwaggyJenkinsRequest req contentType res accept) Params
rParamsL f SwaggyJenkinsRequest{..} = (\rParams -> SwaggyJenkinsRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (SwaggyJenkinsRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f SwaggyJenkinsRequest{..} = (\rAuthTypes -> SwaggyJenkinsRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => SwaggyJenkinsRequest req contentType res accept -> param -> SwaggyJenkinsRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: SwaggyJenkinsRequest req contentType res accept -> param -> SwaggyJenkinsRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: SwaggyJenkinsRequest req contentType res accept -> param -> SwaggyJenkinsRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** SwaggyJenkinsRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> SwaggyJenkinsRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = SwaggyJenkinsRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: SwaggyJenkinsRequest req contentType res accept -> [NH.Header] -> SwaggyJenkinsRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: SwaggyJenkinsRequest req contentType res accept -> [NH.HeaderName] -> SwaggyJenkinsRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => SwaggyJenkinsRequest req contentType res accept -> SwaggyJenkinsRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => SwaggyJenkinsRequest req contentType res accept -> SwaggyJenkinsRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: SwaggyJenkinsRequest req contentType res accept -> [NH.QueryItem] -> SwaggyJenkinsRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: SwaggyJenkinsRequest req contentType res accept -> WH.Form -> SwaggyJenkinsRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: SwaggyJenkinsRequest req contentType res accept -> NH.Part -> SwaggyJenkinsRequest req contentType res accept
...
_setBodyBS :: SwaggyJenkinsRequest req contentType res accept -> B.ByteString -> SwaggyJenkinsRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: SwaggyJenkinsRequest req contentType res accept -> BL.ByteString -> SwaggyJenkinsRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => SwaggyJenkinsRequest req contentType res accept -> P.Proxy authMethod -> SwaggyJenkinsRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: SwaggyJenkinsConfig
    -> a
    -> SwaggyJenkinsRequest req contentType res accept
    -> IO (SwaggyJenkinsRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> SwaggyJenkinsConfig
  -> IO (SwaggyJenkinsRequest req contentType res accept)
_applyAuthMethods req config@(SwaggyJenkinsConfig {configAuthMethods = as}) =
  foldlM go req as
  where
