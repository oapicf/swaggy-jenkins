...
impl BranchImpllinks {
  ...
  pub fn with__self(mut self, _self: ::models::Link) -> BranchImpllinks {
    self._self = Some(_self);
    self
  }
  ...
  pub fn with_actions(mut self, actions: ::models::Link) -> BranchImpllinks {
    self.actions = Some(actions);
    self
  }
  ...
  pub fn with_runs(mut self, runs: ::models::Link) -> BranchImpllinks {
    self.runs = Some(runs);
    self
  }
  ...
  pub fn with_queue(mut self, queue: ::models::Link) -> BranchImpllinks {
    self.queue = Some(queue);
    self
  }
  ...
  pub fn with__class(mut self, _class: String) -> BranchImpllinks {
    self._class = Some(_class);
    self
  }
