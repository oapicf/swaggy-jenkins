...
pub struct PipelineActivity {
  ...
  artifacts: Option<Vec<::models::PipelineActivityartifacts>>,
...
impl PipelineActivity {
  ...
  pub fn with__class(mut self, _class: String) -> PipelineActivity {
    self._class = Some(_class);
    self
  }
  ...
  pub fn set_artifacts(&mut self, artifacts: Vec<::models::PipelineActivityartifacts>) {
    self.artifacts = Some(artifacts);
  }

  pub fn with_artifacts(mut self, artifacts: Vec<::models::PipelineActivityartifacts>) -> PipelineActivity {
    self.artifacts = Some(artifacts);
    self
  }

  pub fn artifacts(&self) -> Option<&Vec<::models::PipelineActivityartifacts>> {
  ...
  pub fn with_duration_in_millis(mut self, duration_in_millis: i32) -> PipelineActivity {
    self.duration_in_millis = Some(duration_in_millis);
    self
  }
  ...
  pub fn with_estimated_duration_in_millis(mut self, estimated_duration_in_millis: i32) -> PipelineActivity {
    self.estimated_duration_in_millis = Some(estimated_duration_in_millis);
    self
  }
  ...
  pub fn with_en_queue_time(mut self, en_queue_time: String) -> PipelineActivity {
    self.en_queue_time = Some(en_queue_time);
    self
  }
  ...
  pub fn with_end_time(mut self, end_time: String) -> PipelineActivity {
    self.end_time = Some(end_time);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PipelineActivity {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_organization(mut self, organization: String) -> PipelineActivity {
    self.organization = Some(organization);
    self
  }
  ...
  pub fn with_pipeline(mut self, pipeline: String) -> PipelineActivity {
    self.pipeline = Some(pipeline);
    self
  }
  ...
  pub fn with_result(mut self, result: String) -> PipelineActivity {
    self.result = Some(result);
    self
  }
  ...
  pub fn with_run_summary(mut self, run_summary: String) -> PipelineActivity {
    self.run_summary = Some(run_summary);
    self
  }
  ...
  pub fn with_start_time(mut self, start_time: String) -> PipelineActivity {
    self.start_time = Some(start_time);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> PipelineActivity {
    self.state = Some(state);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> PipelineActivity {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_commit_id(mut self, commit_id: String) -> PipelineActivity {
    self.commit_id = Some(commit_id);
    self
  }
