...
pub struct HudsonMasterComputermonitorData {
    ...
    pub hudson_node_monitors_swap_space_monitor: Option<Box<models::SwapSpaceMonitorMemoryUsage2>>,
    #[serde(rename = "hudson.node_monitors.TemporarySpaceMonitor", skip_serializing_if = "Option::is_none")]
    pub hudson_node_monitors_temporary_space_monitor: Option<Box<models::DiskSpaceMonitorDescriptorDiskSpace>>,
    #[serde(rename = "hudson.node_monitors.DiskSpaceMonitor", skip_serializing_if = "Option::is_none")]
    pub hudson_node_monitors_disk_space_monitor: Option<Box<models::DiskSpaceMonitorDescriptorDiskSpace>>,
    ...
    pub hudson_node_monitors_response_time_monitor: Option<Box<models::ResponseTimeMonitorData>>,
    #[serde(rename = "hudson.node_monitors.ClockMonitor", skip_serializing_if = "Option::is_none")]
    pub hudson_node_monitors_clock_monitor: Option<Box<models::ClockDifference>>,
