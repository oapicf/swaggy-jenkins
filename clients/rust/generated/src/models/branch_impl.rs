...
pub struct BranchImpl {
  ...
  permissions: Option<::models::BranchImplpermissions>,
  #[serde(rename = "weatherScore")]
  weather_score: Option<i32>,
  #[serde(rename = "pullRequest")]
  pull_request: Option<String>,
  #[serde(rename = "_links")]
  _links: Option<::models::BranchImpllinks>,
  #[serde(rename = "latestRun")]
  latest_run: Option<::models::PipelineRunImpl>
}
...
impl BranchImpl {
  ...
  pub fn with__class(mut self, _class: String) -> BranchImpl {
    self._class = Some(_class);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> BranchImpl {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_estimated_duration_in_millis(mut self, estimated_duration_in_millis: i32) -> BranchImpl {
    self.estimated_duration_in_millis = Some(estimated_duration_in_millis);
    self
  }
  ...
  pub fn with_full_display_name(mut self, full_display_name: String) -> BranchImpl {
    self.full_display_name = Some(full_display_name);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> BranchImpl {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> BranchImpl {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_organization(mut self, organization: String) -> BranchImpl {
    self.organization = Some(organization);
    self
  }
  ...
  pub fn with_parameters(mut self, parameters: Vec<::models::StringParameterDefinition>) -> BranchImpl {
    self.parameters = Some(parameters);
    self
  }
  ...
  pub fn set_permissions(&mut self, permissions: ::models::BranchImplpermissions) {
    self.permissions = Some(permissions);
  }

  pub fn with_permissions(mut self, permissions: ::models::BranchImplpermissions) -> BranchImpl {
    self.permissions = Some(permissions);
    self
  }

  pub fn permissions(&self) -> Option<&::models::BranchImplpermissions> {
  ...
  pub fn with_weather_score(mut self, weather_score: i32) -> BranchImpl {
    self.weather_score = Some(weather_score);
    self
  }
  ...
  pub fn set_pull_request(&mut self, pull_request: String) {
    self.pull_request = Some(pull_request);
  }

  pub fn with_pull_request(mut self, pull_request: String) -> BranchImpl {
    self.pull_request = Some(pull_request);
    self
  }
  ...
  pub fn set__links(&mut self, _links: ::models::BranchImpllinks) {
    self._links = Some(_links);
  }

  pub fn with__links(mut self, _links: ::models::BranchImpllinks) -> BranchImpl {
    self._links = Some(_links);
    self
  }

  pub fn _links(&self) -> Option<&::models::BranchImpllinks> {
    self._links.as_ref()
  }
  ...
  pub fn set_latest_run(&mut self, latest_run: ::models::PipelineRunImpl) {
    self.latest_run = Some(latest_run);
  }

  pub fn with_latest_run(mut self, latest_run: ::models::PipelineRunImpl) -> BranchImpl {
    self.latest_run = Some(latest_run);
    self
  }

  pub fn latest_run(&self) -> Option<&::models::PipelineRunImpl> {
