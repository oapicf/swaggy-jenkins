...
pub struct PipelineRunImpl {
  ...
  #[serde(rename = "_links")]
  _links: Option<::models::PipelineRunImpllinks>,
...
impl PipelineRunImpl {
  ...
  pub fn with__class(mut self, _class: String) -> PipelineRunImpl {
    self._class = Some(_class);
    self
  }
  ...
  pub fn set__links(&mut self, _links: ::models::PipelineRunImpllinks) {
    self._links = Some(_links);
  }

  pub fn with__links(mut self, _links: ::models::PipelineRunImpllinks) -> PipelineRunImpl {
    self._links = Some(_links);
    self
  }

  pub fn _links(&self) -> Option<&::models::PipelineRunImpllinks> {
    self._links.as_ref()
  }
  ...
  pub fn with_duration_in_millis(mut self, duration_in_millis: i32) -> PipelineRunImpl {
    self.duration_in_millis = Some(duration_in_millis);
    self
  }
  ...
  pub fn with_en_queue_time(mut self, en_queue_time: String) -> PipelineRunImpl {
    self.en_queue_time = Some(en_queue_time);
    self
  }
  ...
  pub fn with_end_time(mut self, end_time: String) -> PipelineRunImpl {
    self.end_time = Some(end_time);
    self
  }
  ...
  pub fn with_estimated_duration_in_millis(mut self, estimated_duration_in_millis: i32) -> PipelineRunImpl {
    self.estimated_duration_in_millis = Some(estimated_duration_in_millis);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PipelineRunImpl {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_organization(mut self, organization: String) -> PipelineRunImpl {
    self.organization = Some(organization);
    self
  }
  ...
  pub fn with_pipeline(mut self, pipeline: String) -> PipelineRunImpl {
    self.pipeline = Some(pipeline);
    self
  }
  ...
  pub fn with_result(mut self, result: String) -> PipelineRunImpl {
    self.result = Some(result);
    self
  }
  ...
  pub fn with_run_summary(mut self, run_summary: String) -> PipelineRunImpl {
    self.run_summary = Some(run_summary);
    self
  }
  ...
  pub fn with_start_time(mut self, start_time: String) -> PipelineRunImpl {
    self.start_time = Some(start_time);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> PipelineRunImpl {
    self.state = Some(state);
    self
  }
  ...
  pub fn with__type(mut self, _type: String) -> PipelineRunImpl {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_commit_id(mut self, commit_id: String) -> PipelineRunImpl {
    self.commit_id = Some(commit_id);
    self
  }
