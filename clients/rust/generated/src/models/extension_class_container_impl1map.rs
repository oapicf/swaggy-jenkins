...
pub struct ExtensionClassContainerImpl1map {
    ...
    pub io_jenkins_blueocean_service_embedded_rest_pipeline_impl: Option<Box<models::ExtensionClassImpl>>,
    #[serde(rename = "io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl", skip_serializing_if = "Option::is_none")]
    pub io_jenkins_blueocean_service_embedded_rest_multi_branch_pipeline_impl: Option<Box<models::ExtensionClassImpl>>,
