...
pub struct FreeStyleProject {
    ...
    pub first_build: Option<Box<models::FreeStyleBuild>>,
    ...
    pub last_build: Option<Box<models::FreeStyleBuild>>,
    #[serde(rename = "lastCompletedBuild", skip_serializing_if = "Option::is_none")]
    pub last_completed_build: Option<Box<models::FreeStyleBuild>>,
    ...
    pub last_stable_build: Option<Box<models::FreeStyleBuild>>,
    #[serde(rename = "lastSuccessfulBuild", skip_serializing_if = "Option::is_none")]
    pub last_successful_build: Option<Box<models::FreeStyleBuild>>,
    ...
    pub scm: Option<Box<models::NullScm>>,
}
