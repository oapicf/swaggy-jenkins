...
pub async fn delete_pipeline_queue_item(configuration: &configuration::Configuration, organization: &str, pipeline: &str, queue: &str) -> Result<(), Error<DeletePipelineQueueItemError>> {
    ...
    let p_path_pipeline = pipeline;
    let p_path_queue = queue;

    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue/{queue}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), queue=crate::apis::urlencode(p_path_queue));
...
pub async fn get_authenticated_user(configuration: &configuration::Configuration, organization: &str) -> Result<models::User, Error<GetAuthenticatedUserError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/user/", configuration.base_path, organization=crate::apis::urlencode(p_path_organization));
...
pub async fn get_classes(configuration: &configuration::Configuration, class: &str) -> Result<String, Error<GetClassesError>> {
    ...
    let uri_str = format!("{}/blue/rest/classes/{class}", configuration.base_path, class=crate::apis::urlencode(p_path_class));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_json_web_key(configuration: &configuration::Configuration, key: i32) -> Result<String, Error<GetJsonWebKeyError>> {
    ...
    let uri_str = format!("{}/jwt-auth/jwks/{key}", configuration.base_path, key=p_path_key);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_json_web_token(configuration: &configuration::Configuration, expiry_time_in_mins: Option<i32>, max_expiry_time_in_mins: Option<i32>) -> Result<String, Error<GetJsonWebTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_expiry_time_in_mins = expiry_time_in_mins;
    let p_query_max_expiry_time_in_mins = max_expiry_time_in_mins;

    let uri_str = format!("{}/jwt-auth/token", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_expiry_time_in_mins {
        req_builder = req_builder.query(&[("expiryTimeInMins", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_max_expiry_time_in_mins {
...
pub async fn get_organisation(configuration: &configuration::Configuration, organization: &str) -> Result<models::Organisation, Error<GetOrganisationError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline(configuration: &configuration::Configuration, organization: &str, pipeline: &str) -> Result<models::Pipeline, Error<GetPipelineError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_activities(configuration: &configuration::Configuration, organization: &str, pipeline: &str) -> Result<Vec<models::PipelineActivity>, Error<GetPipelineActivitiesError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/activities", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_branch(configuration: &configuration::Configuration, organization: &str, pipeline: &str, branch: &str) -> Result<models::BranchImpl, Error<GetPipelineBranchError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches/{branch}/", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), branch=crate::apis::urlencode(p_path_branch));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_branch_run(configuration: &configuration::Configuration, organization: &str, pipeline: &str, branch: &str, run: &str) -> Result<models::PipelineRun, Error<GetPipelineBranchRunError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches/{branch}/runs/{run}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), branch=crate::apis::urlencode(p_path_branch), run=crate::apis::urlencode(p_path_run));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_branches(configuration: &configuration::Configuration, organization: &str, pipeline: &str) -> Result<models::MultibranchPipeline, Error<GetPipelineBranchesError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_folder(configuration: &configuration::Configuration, organization: &str, folder: &str) -> Result<models::PipelineFolderImpl, Error<GetPipelineFolderError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization = organization;
    let p_path_folder = folder;

    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{folder}/", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), folder=crate::apis::urlencode(p_path_folder));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_folder_pipeline(configuration: &configuration::Configuration, organization: &str, pipeline: &str, folder: &str) -> Result<models::PipelineImpl, Error<GetPipelineFolderPipelineError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{folder}/pipelines/{pipeline}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), folder=crate::apis::urlencode(p_path_folder));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_queue(configuration: &configuration::Configuration, organization: &str, pipeline: &str) -> Result<Vec<models::QueueItemImpl>, Error<GetPipelineQueueError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str) -> Result<models::PipelineRun, Error<GetPipelineRunError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run_log(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str, start: Option<i32>, download: Option<bool>) -> Result<String, Error<GetPipelineRunLogError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/log", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run_node(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str, node: &str) -> Result<models::PipelineRunNode, Error<GetPipelineRunNodeError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run), node=crate::apis::urlencode(p_path_node));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run_node_step(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str, node: &str, step: &str) -> Result<models::PipelineStepImpl, Error<GetPipelineRunNodeStepError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps/{step}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run), node=crate::apis::urlencode(p_path_node), step=crate::apis::urlencode(p_path_step));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run_node_steps(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str, node: &str) -> Result<Vec<models::PipelineStepImpl>, Error<GetPipelineRunNodeStepsError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run), node=crate::apis::urlencode(p_path_node));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_run_nodes(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str) -> Result<Vec<models::PipelineRunNode>, Error<GetPipelineRunNodesError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipeline_runs(configuration: &configuration::Configuration, organization: &str, pipeline: &str) -> Result<Vec<models::PipelineRun>, Error<GetPipelineRunsError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pipelines(configuration: &configuration::Configuration, organization: &str) -> Result<Vec<models::Pipeline>, Error<GetPipelinesError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/", configuration.base_path, organization=crate::apis::urlencode(p_path_organization));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_scm(configuration: &configuration::Configuration, organization: &str, scm: &str) -> Result<models::GithubScm, Error<GetScmError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/scm/{scm}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), scm=crate::apis::urlencode(p_path_scm));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_scm_organisation_repositories(configuration: &configuration::Configuration, organization: &str, scm: &str, scm_organisation: &str, credential_id: Option<&str>, page_size: Option<i32>, page_number: Option<i32>) -> Result<Vec<models::GithubOrganization>, Error<GetScmOrganisationRepositoriesError>> {
    ...
    let p_path_organization = organization;
    let p_path_scm = scm;
    let p_path_scm_organisation = scm_organisation;
    let p_query_credential_id = credential_id;
    let p_query_page_size = page_size;
    let p_query_page_number = page_number;

    let uri_str = format!("{}/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), scm=crate::apis::urlencode(p_path_scm), scmOrganisation=crate::apis::urlencode(p_path_scm_organisation));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_credential_id {
...
pub async fn get_scm_organisations(configuration: &configuration::Configuration, organization: &str, scm: &str, credential_id: Option<&str>) -> Result<Vec<models::GithubOrganization>, Error<GetScmOrganisationsError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/scm/{scm}/organizations", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), scm=crate::apis::urlencode(p_path_scm));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_user(configuration: &configuration::Configuration, organization: &str, user: &str) -> Result<models::User, Error<GetUserError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/users/{user}", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), user=crate::apis::urlencode(p_path_user));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_user_favorites(configuration: &configuration::Configuration, user: &str) -> Result<Vec<models::FavoriteImpl>, Error<GetUserFavoritesError>> {
    ...
    let uri_str = format!("{}/blue/rest/users/{user}/favorites", configuration.base_path, user=crate::apis::urlencode(p_path_user));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_users(configuration: &configuration::Configuration, organization: &str) -> Result<models::User, Error<GetUsersError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/users/", configuration.base_path, organization=crate::apis::urlencode(p_path_organization));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn post_pipeline_run(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str) -> Result<models::QueueItemImpl, Error<PostPipelineRunError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/replay", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run));
...
pub async fn put_pipeline_favorite(configuration: &configuration::Configuration, organization: &str, pipeline: &str, body: bool) -> Result<models::FavoriteImpl, Error<PutPipelineFavoriteError>> {
    ...
    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/favorite", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline));
...
pub async fn put_pipeline_run(configuration: &configuration::Configuration, organization: &str, pipeline: &str, run: &str, blocking: Option<&str>, time_out_in_secs: Option<i32>) -> Result<models::PipelineRun, Error<PutPipelineRunError>> {
    ...
    let p_path_pipeline = pipeline;
    let p_path_run = run;
    let p_query_blocking = blocking;
    let p_query_time_out_in_secs = time_out_in_secs;

    let uri_str = format!("{}/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/stop", configuration.base_path, organization=crate::apis::urlencode(p_path_organization), pipeline=crate::apis::urlencode(p_path_pipeline), run=crate::apis::urlencode(p_path_run));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);

    if let Some(ref param_value) = p_query_blocking {
        req_builder = req_builder.query(&[("blocking", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_time_out_in_secs {
