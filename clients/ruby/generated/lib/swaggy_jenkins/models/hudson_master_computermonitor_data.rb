...
module SwaggyJenkinsClient
  class HudsonMasterComputermonitorData < ApiModelBase
    attr_accessor :hudson_node_monitors_swap_space_monitor

    attr_accessor :hudson_node_monitors_temporary_space_monitor

    attr_accessor :hudson_node_monitors_disk_space_monitor

    attr_accessor :hudson_node_monitors_architecture_monitor

    attr_accessor :hudson_node_monitors_response_time_monitor

    attr_accessor :hudson_node_monitors_clock_monitor
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggyJenkinsClient::HudsonMasterComputermonitorData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
