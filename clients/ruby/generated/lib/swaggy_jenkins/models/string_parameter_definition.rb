...
module SwaggyJenkinsClient
  class StringParameterDefinition < ApiModelBase
    attr_accessor :_class

    attr_accessor :default_parameter_value
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggyJenkinsClient::StringParameterDefinition`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _class == o._class &&
          default_parameter_value == o.default_parameter_value &&
