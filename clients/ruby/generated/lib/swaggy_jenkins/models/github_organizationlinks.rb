...
module SwaggyJenkinsClient
  class GithubOrganizationlinks < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggyJenkinsClient::GithubOrganizationlinks` initialize method"
      end
