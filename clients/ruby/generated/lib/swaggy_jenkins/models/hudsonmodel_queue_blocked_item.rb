...
module SwaggyJenkinsClient
  ...
  class HudsonmodelQueueBlockedItem
    ...
    def self.swagger_types
      {
        ...
        :'url' => :'String',
        :'why' => :'String',
        :'buildable_start_milliseconds' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'buildableStartMilliseconds')
        self.buildable_start_milliseconds = attributes[:'buildableStartMilliseconds']
      end
