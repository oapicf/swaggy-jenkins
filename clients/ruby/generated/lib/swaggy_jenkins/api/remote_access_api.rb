...
module SwaggyJenkinsClient
  class RemoteAccessApi
    ...
    def get_computer(opts = {})
      data, _status_code, _headers = get_computer_with_http_info(opts)
      return data
    end
    ...
    # Retrieve computer details
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelComputerSet, Fixnum, Hash)>] HudsonmodelComputerSet data, response status code and response headers
    def get_computer_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RemoteAccessApi.get_computer ..."
      end
      # resource path
      local_var_path = "/computer/api/json?depth=1"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'HudsonmodelComputerSet')
      if @api_client.config.debugging
    ...
    # Retrieve CSRF protection token
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonsecuritycsrfDefaultCrumbIssuer, Fixnum, Hash)>] HudsonsecuritycsrfDefaultCrumbIssuer data, response status code and response headers
    def get_crumb_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'HudsonsecuritycsrfDefaultCrumbIssuer')
      if @api_client.config.debugging
    ...
    # Retrieve Jenkins details
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelHudson, Fixnum, Hash)>] HudsonmodelHudson data, response status code and response headers
    ...
    # @param name Name of the job
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelFreeStyleProject, Fixnum, Hash)>] HudsonmodelFreeStyleProject data, response status code and response headers
    def get_job_with_http_info(name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'HudsonmodelFreeStyleProject')
      if @api_client.config.debugging
    ...
    # @param name Name of the job
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelFreeStyleBuild, Fixnum, Hash)>] HudsonmodelFreeStyleBuild data, response status code and response headers
    def get_job_last_build_with_http_info(name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'HudsonmodelFreeStyleBuild')
      if @api_client.config.debugging
    ...
    # Retrieve queue details
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelQueue, Fixnum, Hash)>] HudsonmodelQueue data, response status code and response headers
    ...
    # @param name Name of the view
    # @param [Hash] opts the optional parameters
    # @return [Array<(HudsonmodelListView, Fixnum, Hash)>] HudsonmodelListView data, response status code and response headers
    def get_view_with_http_info(name, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'HudsonmodelListView')
      if @api_client.config.debugging
