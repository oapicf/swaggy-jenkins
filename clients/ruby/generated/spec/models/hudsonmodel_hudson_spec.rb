...
# Unit tests for SwaggyJenkinsClient::HudsonmodelHudson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HudsonmodelHudson' do
  before do
    # run before each test
    @instance = SwaggyJenkinsClient::HudsonmodelHudson.new
  end
  ...
  describe 'test an instance of HudsonmodelHudson' do
    it 'should create an instact of HudsonmodelHudson' do
      expect(@instance).to be_instance_of(SwaggyJenkinsClient::HudsonmodelHudson)
    end
  end
