...
std::string FavoriteImpllinks::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree FavoriteImpllinks::toPropertyTree()
{
    return toPropertyTree_internal();
}

void FavoriteImpllinks::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string FavoriteImpllinks::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void FavoriteImpllinks::fromJsonString_internal(std::string const& jsonString)
{
...
ptree FavoriteImpllinks::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	if (m_Self != nullptr) {
...
void FavoriteImpllinks::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
