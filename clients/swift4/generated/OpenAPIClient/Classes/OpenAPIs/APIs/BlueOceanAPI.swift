...
open class BlueOceanAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganisations(completion: @escaping ((_ data: Organisations?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelineActivities(organization: String, pipeline: String, completion: @escaping ((_ data: PipelineActivities?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelineQueue(organization: String, pipeline: String, completion: @escaping ((_ data: PipelineQueue?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelineRunNodeSteps(organization: String, pipeline: String, run: String, node: String, completion: @escaping ((_ data: PipelineRunNodeSteps?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelineRunNodes(organization: String, pipeline: String, run: String, completion: @escaping ((_ data: PipelineRunNodes?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelineRuns(organization: String, pipeline: String, completion: @escaping ((_ data: PipelineRuns?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPipelines(organization: String, completion: @escaping ((_ data: Pipelines?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSCMOrganisationRepositories(organization: String, scm: String, scmOrganisation: String, credentialId: String? = nil, pageSize: Int? = nil, pageNumber: Int? = nil, completion: @escaping ((_ data: ScmOrganisations?,_ error: Error?) -> Void)) {
     ...
     */
    open class func getSCMOrganisationRepositoriesWithRequestBuilder(organization: String, scm: String, scmOrganisation: String, credentialId: String? = nil, pageSize: Int? = nil, pageNumber: Int? = nil) -> RequestBuilder<ScmOrganisations> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSCMOrganisationRepository(organization: String, scm: String, scmOrganisation: String, repository: String, credentialId: String? = nil, completion: @escaping ((_ data: ScmOrganisations?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSCMOrganisations(organization: String, scm: String, credentialId: String? = nil, completion: @escaping ((_ data: ScmOrganisations?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getUserFavorites(user: String, completion: @escaping ((_ data: UserFavorites?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putPipelineFavorite(organization: String, pipeline: String, body: Body, completion: @escaping ((_ data: FavoriteImpl?,_ error: Error?) -> Void)) {
