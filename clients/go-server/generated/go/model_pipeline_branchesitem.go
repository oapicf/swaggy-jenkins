...
// AssertPipelineBranchesitemRequired checks complex required fields (models, arrays, maps) and embedded parents.
...
func AssertPipelineBranchesitemConstraints(obj PipelineBranchesitem) error {
	if err := AssertPipelineBranchesitemlatestRunConstraints(obj.LatestRun); err != nil {
		return err
	}
	if err := AssertPipelineBranchesitempullRequestConstraints(obj.PullRequest); err != nil {
		return err
	}
	return nil
}
