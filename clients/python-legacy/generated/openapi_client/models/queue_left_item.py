...
class QueueLeftItem(object):
    ...
    def __init__(self, _class=None, actions=None, blocked=None, buildable=None, id=None, in_queue_since=None, params=None, stuck=None, task=None, url=None, why=None, cancelled=None, executable=None, local_vars_configuration=None):  # noqa: E501
