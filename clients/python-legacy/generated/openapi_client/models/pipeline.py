...
class Pipeline(object):
    ...
    def __init__(self, _class=None, organization=None, name=None, display_name=None, full_name=None, weather_score=None, estimated_duration_in_millis=None, latest_run=None, local_vars_configuration=None):  # noqa: E501
