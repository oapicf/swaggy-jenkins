...
public class GetMultibranchPipeline {
  ...
  public boolean equals(Object o) {
    ...
    return (this.displayName == null ? getMultibranchPipeline.displayName == null : this.displayName.equals(getMultibranchPipeline.displayName)) &&
        (this.estimatedDurationInMillis == null ? getMultibranchPipeline.estimatedDurationInMillis == null : this.estimatedDurationInMillis.equals(getMultibranchPipeline.estimatedDurationInMillis)) &&
        (this.latestRun == null ? getMultibranchPipeline.latestRun == null : this.latestRun.equals(getMultibranchPipeline.latestRun)) &&
        (this.name == null ? getMultibranchPipeline.name == null : this.name.equals(getMultibranchPipeline.name)) &&
        (this.organization == null ? getMultibranchPipeline.organization == null : this.organization.equals(getMultibranchPipeline.organization)) &&
        (this.weatherScore == null ? getMultibranchPipeline.weatherScore == null : this.weatherScore.equals(getMultibranchPipeline.weatherScore)) &&
        (this.branchNames == null ? getMultibranchPipeline.branchNames == null : this.branchNames.equals(getMultibranchPipeline.branchNames)) &&
        (this.numberOfFailingBranches == null ? getMultibranchPipeline.numberOfFailingBranches == null : this.numberOfFailingBranches.equals(getMultibranchPipeline.numberOfFailingBranches)) &&
        (this.numberOfFailingPullRequests == null ? getMultibranchPipeline.numberOfFailingPullRequests == null : this.numberOfFailingPullRequests.equals(getMultibranchPipeline.numberOfFailingPullRequests)) &&
        (this.numberOfSuccessfulBranches == null ? getMultibranchPipeline.numberOfSuccessfulBranches == null : this.numberOfSuccessfulBranches.equals(getMultibranchPipeline.numberOfSuccessfulBranches)) &&
        (this.numberOfSuccessfulPullRequests == null ? getMultibranchPipeline.numberOfSuccessfulPullRequests == null : this.numberOfSuccessfulPullRequests.equals(getMultibranchPipeline.numberOfSuccessfulPullRequests)) &&
        (this.totalNumberOfBranches == null ? getMultibranchPipeline.totalNumberOfBranches == null : this.totalNumberOfBranches.equals(getMultibranchPipeline.totalNumberOfBranches)) &&
        (this.totalNumberOfPullRequests == null ? getMultibranchPipeline.totalNumberOfPullRequests == null : this.totalNumberOfPullRequests.equals(getMultibranchPipeline.totalNumberOfPullRequests)) &&
        (this._class == null ? getMultibranchPipeline._class == null : this._class.equals(getMultibranchPipeline._class));
  }
