...
public class HudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2 {
  ...
  public boolean equals(Object o) {
    ...
    return (this._class == null ? hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2._class == null : this._class.equals(hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2._class)) &&
        (this.availablePhysicalMemory == null ? hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.availablePhysicalMemory == null : this.availablePhysicalMemory.equals(hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.availablePhysicalMemory)) &&
        (this.availableSwapSpace == null ? hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.availableSwapSpace == null : this.availableSwapSpace.equals(hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.availableSwapSpace)) &&
        (this.totalPhysicalMemory == null ? hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.totalPhysicalMemory == null : this.totalPhysicalMemory.equals(hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.totalPhysicalMemory)) &&
        (this.totalSwapSpace == null ? hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.totalSwapSpace == null : this.totalSwapSpace.equals(hudsonnodeMonitorsSwapSpaceMonitorMemoryUsage2.totalSwapSpace));
  }
