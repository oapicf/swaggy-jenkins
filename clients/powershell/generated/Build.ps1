...
$Manifest = @{
    ...
    Description = 'IO.Swagger - the PowerShell module for Swaggy Jenkins'

    RootModule = 'IO.Swagger.psm1'
    Guid = '{80A37D94-BFEF-4CA4-A540-C38E8B3E3212}' # Has to be static, otherwise each new build will be considered different module
