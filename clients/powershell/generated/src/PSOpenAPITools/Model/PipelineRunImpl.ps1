...
PipelineRunImpl<PSCustomObject>
#>

function Initialize-PipelineRunImpl {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PipelineRunImpl' | Write-Debug
...
Convert from JSON to PipelineRunImpl<PSCustomObject>
...
PipelineRunImpl<PSCustomObject>
#>
function ConvertFrom-JsonToPipelineRunImpl {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PipelineRunImpl' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PipelineRunImpl
        $AllProperties = ("_class", "_links", "durationInMillis", "enQueueTime", "endTime", "estimatedDurationInMillis", "id", "organization", "pipeline", "result", "runSummary", "startTime", "state", "type", "commitId")
