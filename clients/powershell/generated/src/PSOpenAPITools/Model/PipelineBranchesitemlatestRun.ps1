...
PipelineBranchesitemlatestRun<PSCustomObject>
#>

function Initialize-PipelineBranchesitemlatestRun {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PipelineBranchesitemlatestRun' | Write-Debug
...
Convert from JSON to PipelineBranchesitemlatestRun<PSCustomObject>
...
PipelineBranchesitemlatestRun<PSCustomObject>
#>
function ConvertFrom-JsonToPipelineBranchesitemlatestRun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PipelineBranchesitemlatestRun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PipelineBranchesitemlatestRun
        $AllProperties = ("durationInMillis", "estimatedDurationInMillis", "enQueueTime", "endTime", "id", "organization", "pipeline", "result", "runSummary", "startTime", "state", "type", "commitId", "_class")
