...
function Initialize-PipelineRun {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PipelineRun' | Write-Debug
...
Convert from JSON to PipelineRun<PSCustomObject>
...
PipelineRun<PSCustomObject>
#>
function ConvertFrom-JsonToPipelineRun {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PipelineRun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PipelineRun
