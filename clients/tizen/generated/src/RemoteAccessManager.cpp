...
static bool postCreateItemHelper(char * accessToken,
	std::string name, std::string from, std::string mode, std::string body, std::string jenkinsCrumb, std::string contentType, 
	...
	void(* handler)(Error, void* ) , void* userData)
{
	...
	name, from, mode, body, jenkinsCrumb, contentType, 
	handler, userData, true);
}
...
static bool postCreateViewHelper(char * accessToken,
	std::string name, std::string body, std::string jenkinsCrumb, std::string contentType, 
	...
	void(* handler)(Error, void* ) , void* userData)
{
	...
	name, body, jenkinsCrumb, contentType, 
	handler, userData, true);
}
