...
#ifndef _MultibranchPipeline_H_
#define _MultibranchPipeline_H_
...
class MultibranchPipeline : public Object {
public:
	/*! \brief Constructor.
	 */
	MultibranchPipeline();
	MultibranchPipeline(char* str);
