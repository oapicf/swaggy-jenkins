...
void
GithubRepositorieslinks::__init()
{
	//
	//
	//self = new Link();
...
void
GithubRepositorieslinks::__cleanup()
{
	//if(self != NULL) {
	//
	//delete self;
...
void
GithubRepositorieslinks::fromJson(char* jsonStr)
{
...
GithubRepositorieslinks::GithubRepositorieslinks(char* json)
{
	this->fromJson(json);
}

char*
GithubRepositorieslinks::toJson()
{
