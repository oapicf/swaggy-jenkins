 ...
 * @return {!angular.$q.Promise}
 */
API.Client.RemoteAccessApi.prototype.postCreateItem = function(name, opt_from, opt_mode, opt_body, opt_jenkinsCrumb, opt_contentType, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 * @return {!angular.$q.Promise}
 */
API.Client.RemoteAccessApi.prototype.postCreateView = function(name, opt_body, opt_jenkinsCrumb, opt_contentType, opt_extraHttpRequestParams) {
  /** @const {string} */
