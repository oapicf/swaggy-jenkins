 ...
 * @export
 */
export type PipelineRunNodeSteps = {
}
...
export type BaseRemoteAccessApiType = { 
    getCrumb(options?: RequestOptions): Promise<DefaultCrumbIssuer>,
}

/**
 * BaseRemoteAccessApi - factory function to inject configuration 
 * @export
 */
export const BaseRemoteAccessApi = function(configuration?: Configuration, fetch: FetchAPI = portableFetch): BaseRemoteAccessApiType {
...
export const BlueOceanApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        putPipelineFavorite(organization: string, pipeline: string, body: Body, options: RequestOptions): FetchArgs {
            // verify required parameter 'organization' is not null or undefined
            if (organization === null || organization === undefined) {
...
export type BlueOceanApiType = { 
    ...
    getOrganisations(options?: RequestOptions): Promise<Organisations>,

    getPipeline(organization: string, pipeline: string, options?: RequestOptions): Promise<Pipeline>,

    getPipelineActivities(organization: string, pipeline: string, options?: RequestOptions): Promise<PipelineActivities>,
    ...
    getPipelineQueue(organization: string, pipeline: string, options?: RequestOptions): Promise<PipelineQueue>,
    ...
    getPipelineRunNodeSteps(organization: string, pipeline: string, run: string, node: string, options?: RequestOptions): Promise<PipelineRunNodeSteps>,

    getPipelineRunNodes(organization: string, pipeline: string, run: string, options?: RequestOptions): Promise<PipelineRunNodes>,

    getPipelineRuns(organization: string, pipeline: string, options?: RequestOptions): Promise<PipelineRuns>,

    getPipelines(organization: string, options?: RequestOptions): Promise<Pipelines>,

    getSCM(organization: string, scm: string, options?: RequestOptions): Promise<GithubScm>,

    getSCMOrganisationRepositories(organization: string, scm: string, scmOrganisation: string, credentialId?: string, pageSize?: number, pageNumber?: number, options?: RequestOptions): Promise<ScmOrganisations>,

    getSCMOrganisationRepository(organization: string, scm: string, scmOrganisation: string, repository: string, credentialId?: string, options?: RequestOptions): Promise<ScmOrganisations>,

    getSCMOrganisations(organization: string, scm: string, credentialId?: string, options?: RequestOptions): Promise<ScmOrganisations>,

    getUser(organization: string, user: string, options?: RequestOptions): Promise<User>,

    getUserFavorites(user: string, options?: RequestOptions): Promise<UserFavorites>,
    ...
    putPipelineFavorite(organization: string, pipeline: string, body: Body, options?: RequestOptions): Promise<FavoriteImpl>,
...
export type ApiTypes = { 
    BaseRemoteAccessApi: BaseRemoteAccessApiType,
