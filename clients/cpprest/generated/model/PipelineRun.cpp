...
void PipelineRun::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("artifacts")].as_array() )
        {
            if(item.is_null())
            {
                m_Artifacts.push_back( std::shared_ptr<PipelineRunartifacts>(nullptr) );
            }
            else
            {
                std::shared_ptr<PipelineRunartifacts> newItem(new PipelineRunartifacts());
...
void PipelineRun::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
void PipelineRun::setClass(utility::string_t value)
{
    m__class = value;
    m__classIsSet = true;
}
...
void PipelineRun::setEnQueueTime(utility::string_t value)
{
    m_EnQueueTime = value;
...
void PipelineRun::setEndTime(utility::string_t value)
{
    m_EndTime = value;
    m_EndTimeIsSet = true;
}
...
void PipelineRun::setId(utility::string_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
void PipelineRun::setOrganization(utility::string_t value)
{
...
void PipelineRun::setPipeline(utility::string_t value)
{
    m_Pipeline = value;
...
void PipelineRun::setResult(utility::string_t value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
...
void PipelineRun::setRunSummary(utility::string_t value)
{
    m_RunSummary = value;
...
void PipelineRun::setStartTime(utility::string_t value)
{
    m_StartTime = value;
...
void PipelineRun::setState(utility::string_t value)
{
    m_State = value;
    m_StateIsSet = true;
}
...
void PipelineRun::setType(utility::string_t value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
...
void PipelineRun::setCommitId(utility::string_t value)
{
    m_CommitId = value;
