...
Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2()
{
    m__class = U("");
    m__classIsSet = false;
...
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::validate()
{
    // TODO: implement validation
}

web::json::value Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::toJson() const
{
...
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::fromJson(web::json::value& val)
{
...
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::getClass() const
{
    return m__class;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::setClass(utility::string_t value)
{
    m__class = value;
    m__classIsSet = true;
}
bool Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::_classIsSet() const
{
    return m__classIsSet;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::unset_class()
{
    m__classIsSet = false;
}
int32_t Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::getAvailablePhysicalMemory() const
{
    return m_AvailablePhysicalMemory;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::setAvailablePhysicalMemory(int32_t value)
{
    m_AvailablePhysicalMemory = value;
    m_AvailablePhysicalMemoryIsSet = true;
}
bool Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::availablePhysicalMemoryIsSet() const
{
    return m_AvailablePhysicalMemoryIsSet;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::unsetAvailablePhysicalMemory()
{
    m_AvailablePhysicalMemoryIsSet = false;
}
int32_t Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::getAvailableSwapSpace() const
{
    return m_AvailableSwapSpace;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::setAvailableSwapSpace(int32_t value)
{
    m_AvailableSwapSpace = value;
    m_AvailableSwapSpaceIsSet = true;
}
bool Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::availableSwapSpaceIsSet() const
{
    return m_AvailableSwapSpaceIsSet;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::unsetAvailableSwapSpace()
{
    m_AvailableSwapSpaceIsSet = false;
}
int32_t Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::getTotalPhysicalMemory() const
{
    return m_TotalPhysicalMemory;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::setTotalPhysicalMemory(int32_t value)
{
    m_TotalPhysicalMemory = value;
    m_TotalPhysicalMemoryIsSet = true;
}
bool Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::totalPhysicalMemoryIsSet() const
{
    return m_TotalPhysicalMemoryIsSet;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::unsetTotalPhysicalMemory()
{
    m_TotalPhysicalMemoryIsSet = false;
}
int32_t Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::getTotalSwapSpace() const
{
    return m_TotalSwapSpace;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::setTotalSwapSpace(int32_t value)
{
    m_TotalSwapSpace = value;
    m_TotalSwapSpaceIsSet = true;
}
bool Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::totalSwapSpaceIsSet() const
{
    return m_TotalSwapSpaceIsSet;
}
void Hudsonnode_monitorsSwapSpaceMonitorMemoryUsage2::unsetTotalSwapSpace()
{
    m_TotalSwapSpaceIsSet = false;
}
