...
public:
    ...
    pplx::task<std::shared_ptr<ComputerSet>> getComputer(int32_t depth);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<FreeStyleProject>> getJob(utility::string_t name);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="name">Name of the job</param>
    pplx::task<std::shared_ptr<FreeStyleBuild>> getJobLastBuild(utility::string_t name);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<Queue>> getQueueItem(utility::string_t number);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    pplx::task<std::shared_ptr<ListView>> getView(utility::string_t name);
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
