...
export class BlueOceanApi extends BaseAPI {
    ...
    deletePipelineQueueItem({ organization, pipeline, queue }: DeletePipelineQueueItemRequest, opts?: OperationOpts): Observable<void | RawAjaxResponse<void>>
    deletePipelineQueueItem({ organization, pipeline, queue }: DeletePipelineQueueItemRequest, opts?: OperationOpts): Observable<void | RawAjaxResponse<void>> {
    ...
    getAuthenticatedUser({ organization }: GetAuthenticatedUserRequest, opts?: OperationOpts): Observable<RawAjaxResponse<User>>
    getAuthenticatedUser({ organization }: GetAuthenticatedUserRequest, opts?: OperationOpts): Observable<User | RawAjaxResponse<User>> {
    ...
    getClasses({ _class }: GetClassesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    getClasses({ _class }: GetClassesRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    getJsonWebKey({ key }: GetJsonWebKeyRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    getJsonWebKey({ key }: GetJsonWebKeyRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    getJsonWebToken({ expiryTimeInMins, maxExpiryTimeInMins }: GetJsonWebTokenRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    getJsonWebToken({ expiryTimeInMins, maxExpiryTimeInMins }: GetJsonWebTokenRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    getOrganisation({ organization }: GetOrganisationRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Organisation>>
    getOrganisation({ organization }: GetOrganisationRequest, opts?: OperationOpts): Observable<Organisation | RawAjaxResponse<Organisation>> {
    ...
    getOrganisations(opts?: OperationOpts): Observable<RawAjaxResponse<Array<Organisation>>>
    getOrganisations(opts?: OperationOpts): Observable<Array<Organisation> | RawAjaxResponse<Array<Organisation>>> {
        const headers: HttpHeaders = {
            ...(this.configuration.username != null && this.configuration.password != null ? { Authorization: `Basic ${btoa(this.configuration.username + ':' + this.configuration.password)}` } : undefined),
        };
    ...
    getPipeline({ organization, pipeline }: GetPipelineRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Pipeline>>
    getPipeline({ organization, pipeline }: GetPipelineRequest, opts?: OperationOpts): Observable<Pipeline | RawAjaxResponse<Pipeline>> {
    ...
    getPipelineActivities({ organization, pipeline }: GetPipelineActivitiesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PipelineActivity>>>
    getPipelineActivities({ organization, pipeline }: GetPipelineActivitiesRequest, opts?: OperationOpts): Observable<Array<PipelineActivity> | RawAjaxResponse<Array<PipelineActivity>>> {
    ...
    getPipelineBranch({ organization, pipeline, branch }: GetPipelineBranchRequest, opts?: OperationOpts): Observable<RawAjaxResponse<BranchImpl>>
    getPipelineBranch({ organization, pipeline, branch }: GetPipelineBranchRequest, opts?: OperationOpts): Observable<BranchImpl | RawAjaxResponse<BranchImpl>> {
    ...
    getPipelineBranchRun({ organization, pipeline, branch, run }: GetPipelineBranchRunRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineRun>>
    getPipelineBranchRun({ organization, pipeline, branch, run }: GetPipelineBranchRunRequest, opts?: OperationOpts): Observable<PipelineRun | RawAjaxResponse<PipelineRun>> {
    ...
    getPipelineBranches({ organization, pipeline }: GetPipelineBranchesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<MultibranchPipeline>>
    getPipelineBranches({ organization, pipeline }: GetPipelineBranchesRequest, opts?: OperationOpts): Observable<MultibranchPipeline | RawAjaxResponse<MultibranchPipeline>> {
    ...
    getPipelineFolder({ organization, folder }: GetPipelineFolderRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineFolderImpl>>
    getPipelineFolder({ organization, folder }: GetPipelineFolderRequest, opts?: OperationOpts): Observable<PipelineFolderImpl | RawAjaxResponse<PipelineFolderImpl>> {
    ...
    getPipelineFolderPipeline({ organization, pipeline, folder }: GetPipelineFolderPipelineRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineImpl>>
    getPipelineFolderPipeline({ organization, pipeline, folder }: GetPipelineFolderPipelineRequest, opts?: OperationOpts): Observable<PipelineImpl | RawAjaxResponse<PipelineImpl>> {
    ...
    getPipelineQueue({ organization, pipeline }: GetPipelineQueueRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<QueueItemImpl>>>
    getPipelineQueue({ organization, pipeline }: GetPipelineQueueRequest, opts?: OperationOpts): Observable<Array<QueueItemImpl> | RawAjaxResponse<Array<QueueItemImpl>>> {
    ...
    getPipelineRun({ organization, pipeline, run }: GetPipelineRunRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineRun>>
    getPipelineRun({ organization, pipeline, run }: GetPipelineRunRequest, opts?: OperationOpts): Observable<PipelineRun | RawAjaxResponse<PipelineRun>> {
    ...
    getPipelineRunLog({ organization, pipeline, run, start, download }: GetPipelineRunLogRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    getPipelineRunLog({ organization, pipeline, run, start, download }: GetPipelineRunLogRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    getPipelineRunNode({ organization, pipeline, run, node }: GetPipelineRunNodeRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineRunNode>>
    getPipelineRunNode({ organization, pipeline, run, node }: GetPipelineRunNodeRequest, opts?: OperationOpts): Observable<PipelineRunNode | RawAjaxResponse<PipelineRunNode>> {
    ...
    getPipelineRunNodeStep({ organization, pipeline, run, node, step }: GetPipelineRunNodeStepRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineStepImpl>>
    getPipelineRunNodeStep({ organization, pipeline, run, node, step }: GetPipelineRunNodeStepRequest, opts?: OperationOpts): Observable<PipelineStepImpl | RawAjaxResponse<PipelineStepImpl>> {
    ...
    getPipelineRunNodeStepLog({ organization, pipeline, run, node, step }: GetPipelineRunNodeStepLogRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    getPipelineRunNodeStepLog({ organization, pipeline, run, node, step }: GetPipelineRunNodeStepLogRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    getPipelineRunNodeSteps({ organization, pipeline, run, node }: GetPipelineRunNodeStepsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PipelineStepImpl>>>
    getPipelineRunNodeSteps({ organization, pipeline, run, node }: GetPipelineRunNodeStepsRequest, opts?: OperationOpts): Observable<Array<PipelineStepImpl> | RawAjaxResponse<Array<PipelineStepImpl>>> {
    ...
    getPipelineRunNodes({ organization, pipeline, run }: GetPipelineRunNodesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PipelineRunNode>>>
    getPipelineRunNodes({ organization, pipeline, run }: GetPipelineRunNodesRequest, opts?: OperationOpts): Observable<Array<PipelineRunNode> | RawAjaxResponse<Array<PipelineRunNode>>> {
    ...
    getPipelineRuns({ organization, pipeline }: GetPipelineRunsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<PipelineRun>>>
    getPipelineRuns({ organization, pipeline }: GetPipelineRunsRequest, opts?: OperationOpts): Observable<Array<PipelineRun> | RawAjaxResponse<Array<PipelineRun>>> {
    ...
    getPipelines({ organization }: GetPipelinesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<Pipeline>>>
    getPipelines({ organization }: GetPipelinesRequest, opts?: OperationOpts): Observable<Array<Pipeline> | RawAjaxResponse<Array<Pipeline>>> {
    ...
    getSCM({ organization, scm }: GetSCMRequest, opts?: OperationOpts): Observable<RawAjaxResponse<GithubScm>>
    getSCM({ organization, scm }: GetSCMRequest, opts?: OperationOpts): Observable<GithubScm | RawAjaxResponse<GithubScm>> {
    ...
    getSCMOrganisationRepositories({ organization, scm, scmOrganisation, credentialId, pageSize, pageNumber }: GetSCMOrganisationRepositoriesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<GithubOrganization>>>
    getSCMOrganisationRepositories({ organization, scm, scmOrganisation, credentialId, pageSize, pageNumber }: GetSCMOrganisationRepositoriesRequest, opts?: OperationOpts): Observable<Array<GithubOrganization> | RawAjaxResponse<Array<GithubOrganization>>> {
    ...
    getSCMOrganisationRepository({ organization, scm, scmOrganisation, repository, credentialId }: GetSCMOrganisationRepositoryRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<GithubOrganization>>>
    getSCMOrganisationRepository({ organization, scm, scmOrganisation, repository, credentialId }: GetSCMOrganisationRepositoryRequest, opts?: OperationOpts): Observable<Array<GithubOrganization> | RawAjaxResponse<Array<GithubOrganization>>> {
    ...
    getSCMOrganisations({ organization, scm, credentialId }: GetSCMOrganisationsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<GithubOrganization>>>
    getSCMOrganisations({ organization, scm, credentialId }: GetSCMOrganisationsRequest, opts?: OperationOpts): Observable<Array<GithubOrganization> | RawAjaxResponse<Array<GithubOrganization>>> {
    ...
    getUser({ organization, user }: GetUserRequest, opts?: OperationOpts): Observable<RawAjaxResponse<User>>
    getUser({ organization, user }: GetUserRequest, opts?: OperationOpts): Observable<User | RawAjaxResponse<User>> {
    ...
    getUserFavorites({ user }: GetUserFavoritesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<Array<FavoriteImpl>>>
    getUserFavorites({ user }: GetUserFavoritesRequest, opts?: OperationOpts): Observable<Array<FavoriteImpl> | RawAjaxResponse<Array<FavoriteImpl>>> {
    ...
    getUsers({ organization }: GetUsersRequest, opts?: OperationOpts): Observable<RawAjaxResponse<User>>
    getUsers({ organization }: GetUsersRequest, opts?: OperationOpts): Observable<User | RawAjaxResponse<User>> {
    ...
    postPipelineRun({ organization, pipeline, run }: PostPipelineRunRequest, opts?: OperationOpts): Observable<RawAjaxResponse<QueueItemImpl>>
    postPipelineRun({ organization, pipeline, run }: PostPipelineRunRequest, opts?: OperationOpts): Observable<QueueItemImpl | RawAjaxResponse<QueueItemImpl>> {
    ...
    postPipelineRuns({ organization, pipeline }: PostPipelineRunsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<QueueItemImpl>>
    postPipelineRuns({ organization, pipeline }: PostPipelineRunsRequest, opts?: OperationOpts): Observable<QueueItemImpl | RawAjaxResponse<QueueItemImpl>> {
    ...
    putPipelineRun({ organization, pipeline, run, blocking, timeOutInSecs }: PutPipelineRunRequest, opts?: OperationOpts): Observable<RawAjaxResponse<PipelineRun>>
    putPipelineRun({ organization, pipeline, run, blocking, timeOutInSecs }: PutPipelineRunRequest, opts?: OperationOpts): Observable<PipelineRun | RawAjaxResponse<PipelineRun>> {
    ...
    search({ q }: SearchRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    search({ q }: SearchRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    searchClasses({ q }: SearchClassesRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    searchClasses({ q }: SearchClassesRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
