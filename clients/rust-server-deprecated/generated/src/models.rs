...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for AllView {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for AllView {
...
impl std::fmt::Display for AllView {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AllView>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             ...
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AllView - value: {hdr_value} is invalid {e}"))
        }
    }
}
             ...
             std::result::Result::Ok(value) => {
                    match <AllView as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into AllView - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <AllView as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into AllView - {err}"))
                        }
                    })
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for BranchImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for BranchImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for BranchImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<BranchImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BranchImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BranchImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BranchImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into BranchImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <BranchImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into BranchImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for BranchImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for BranchImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for BranchImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<BranchImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BranchImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BranchImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BranchImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into BranchImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <BranchImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into BranchImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for BranchImplpermissions {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for BranchImplpermissions {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for BranchImplpermissions {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<BranchImplpermissions>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BranchImplpermissions>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BranchImplpermissions - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BranchImplpermissions as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into BranchImplpermissions - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <BranchImplpermissions as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into BranchImplpermissions - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for CauseAction {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for CauseAction {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for CauseAction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<CauseAction>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CauseAction>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for CauseAction - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CauseAction as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into CauseAction - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <CauseAction as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into CauseAction - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for CauseUserIdCause {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for CauseUserIdCause {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for CauseUserIdCause {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<CauseUserIdCause>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<CauseUserIdCause>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for CauseUserIdCause - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CauseUserIdCause as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into CauseUserIdCause - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <CauseUserIdCause as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into CauseUserIdCause - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ClassesByClass {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ClassesByClass {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ClassesByClass {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<ClassesByClass>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ClassesByClass>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ClassesByClass - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ClassesByClass as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ClassesByClass - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ClassesByClass as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ClassesByClass - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ClockDifference {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ClockDifference {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ClockDifference {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<ClockDifference>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ClockDifference>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ClockDifference - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ClockDifference as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ClockDifference - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ClockDifference as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ClockDifference - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ComputerSet {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ComputerSet {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ComputerSet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<ComputerSet>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ComputerSet>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ComputerSet - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ComputerSet as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ComputerSet - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ComputerSet as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ComputerSet - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for DefaultCrumbIssuer {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for DefaultCrumbIssuer {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for DefaultCrumbIssuer {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<DefaultCrumbIssuer>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<DefaultCrumbIssuer>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for DefaultCrumbIssuer - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <DefaultCrumbIssuer as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into DefaultCrumbIssuer - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <DefaultCrumbIssuer as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into DefaultCrumbIssuer - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for DiskSpaceMonitorDescriptorDiskSpace {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for DiskSpaceMonitorDescriptorDiskSpace {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for DiskSpaceMonitorDescriptorDiskSpace {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<DiskSpaceMonitorDescriptorDiskSpace>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<DiskSpaceMonitorDescriptorDiskSpace>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for DiskSpaceMonitorDescriptorDiskSpace - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <DiskSpaceMonitorDescriptorDiskSpace as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into DiskSpaceMonitorDescriptorDiskSpace - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <DiskSpaceMonitorDescriptorDiskSpace as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into DiskSpaceMonitorDescriptorDiskSpace - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for EmptyChangeLogSet {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for EmptyChangeLogSet {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for EmptyChangeLogSet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<EmptyChangeLogSet>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<EmptyChangeLogSet>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for EmptyChangeLogSet - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <EmptyChangeLogSet as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into EmptyChangeLogSet - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <EmptyChangeLogSet as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into EmptyChangeLogSet - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ExtensionClassContainerImpl1 {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ExtensionClassContainerImpl1 {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ExtensionClassContainerImpl1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExtensionClassContainerImpl1>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExtensionClassContainerImpl1>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExtensionClassContainerImpl1 - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExtensionClassContainerImpl1 as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ExtensionClassContainerImpl1 - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ExtensionClassContainerImpl1 as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ExtensionClassContainerImpl1 - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ExtensionClassContainerImpl1links {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ExtensionClassContainerImpl1links {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ExtensionClassContainerImpl1links {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExtensionClassContainerImpl1links>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExtensionClassContainerImpl1links>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExtensionClassContainerImpl1links - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExtensionClassContainerImpl1links as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ExtensionClassContainerImpl1links - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ExtensionClassContainerImpl1links as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ExtensionClassContainerImpl1links - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ExtensionClassContainerImpl1map {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ExtensionClassContainerImpl1map {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ExtensionClassContainerImpl1map {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExtensionClassContainerImpl1map>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExtensionClassContainerImpl1map>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExtensionClassContainerImpl1map - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExtensionClassContainerImpl1map as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ExtensionClassContainerImpl1map - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ExtensionClassContainerImpl1map as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ExtensionClassContainerImpl1map - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ExtensionClassImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ExtensionClassImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ExtensionClassImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExtensionClassImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExtensionClassImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExtensionClassImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExtensionClassImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ExtensionClassImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ExtensionClassImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ExtensionClassImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ExtensionClassImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ExtensionClassImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ExtensionClassImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExtensionClassImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExtensionClassImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExtensionClassImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExtensionClassImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ExtensionClassImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ExtensionClassImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ExtensionClassImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FavoriteImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FavoriteImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FavoriteImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<FavoriteImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FavoriteImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FavoriteImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FavoriteImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FavoriteImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FavoriteImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FavoriteImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FavoriteImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FavoriteImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FavoriteImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<FavoriteImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FavoriteImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FavoriteImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FavoriteImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FavoriteImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FavoriteImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FavoriteImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FreeStyleBuild {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FreeStyleBuild {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FreeStyleBuild {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<FreeStyleBuild>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FreeStyleBuild>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FreeStyleBuild - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FreeStyleBuild as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FreeStyleBuild - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FreeStyleBuild as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FreeStyleBuild - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FreeStyleProject {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FreeStyleProject {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FreeStyleProject {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<FreeStyleProject>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FreeStyleProject>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FreeStyleProject - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FreeStyleProject as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FreeStyleProject - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FreeStyleProject as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FreeStyleProject - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FreeStyleProjectactions {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FreeStyleProjectactions {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FreeStyleProjectactions {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<FreeStyleProjectactions>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FreeStyleProjectactions>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FreeStyleProjectactions - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FreeStyleProjectactions as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FreeStyleProjectactions - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FreeStyleProjectactions as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FreeStyleProjectactions - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for FreeStyleProjecthealthReport {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for FreeStyleProjecthealthReport {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for FreeStyleProjecthealthReport {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.description.as_ref().map(|description| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<FreeStyleProjecthealthReport>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<FreeStyleProjecthealthReport>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for FreeStyleProjecthealthReport - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <FreeStyleProjecthealthReport as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into FreeStyleProjecthealthReport - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <FreeStyleProjecthealthReport as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into FreeStyleProjecthealthReport - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GenericResource {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GenericResource {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GenericResource>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GenericResource>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GenericResource - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GenericResource as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GenericResource - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GenericResource as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GenericResource - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubContent {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubContent {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubContent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.name.as_ref().map(|name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubContent>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubContent>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubContent - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubContent as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubContent - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubContent as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubContent - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubFile {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubFile {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubFile>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubFile>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubFile - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubFile as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubFile - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubFile as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubFile - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubOrganization {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubOrganization {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubOrganization {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubOrganization>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubOrganization>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubOrganization - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubOrganization as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubOrganization - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubOrganization as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubOrganization - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubOrganizationlinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubOrganizationlinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubOrganizationlinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubOrganizationlinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubOrganizationlinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubOrganizationlinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubOrganizationlinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubOrganizationlinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubOrganizationlinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubOrganizationlinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRepositories {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRepositories {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRepositories {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRepositories>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRepositories>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRepositories - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRepositories as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRepositories - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRepositories as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRepositories - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRepositorieslinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRepositorieslinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRepositorieslinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRepositorieslinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRepositorieslinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRepositorieslinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRepositorieslinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRepositorieslinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRepositorieslinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRepositorieslinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRepository {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRepository {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRepository>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRepository>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRepository - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRepository as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRepository - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRepository as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRepository - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRepositorylinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRepositorylinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRepositorylinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRepositorylinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRepositorylinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRepositorylinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRepositorylinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRepositorylinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRepositorylinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRepositorylinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRepositorypermissions {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRepositorypermissions {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRepositorypermissions {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRepositorypermissions>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRepositorypermissions>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRepositorypermissions - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRepositorypermissions as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRepositorypermissions - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRepositorypermissions as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRepositorypermissions - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRespositoryContainer {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRespositoryContainer {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRespositoryContainer {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRespositoryContainer>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRespositoryContainer>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRespositoryContainer - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRespositoryContainer as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRespositoryContainer - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRespositoryContainer as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRespositoryContainer - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubRespositoryContainerlinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubRespositoryContainerlinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubRespositoryContainerlinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubRespositoryContainerlinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubRespositoryContainerlinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubRespositoryContainerlinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubRespositoryContainerlinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubRespositoryContainerlinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubRespositoryContainerlinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubRespositoryContainerlinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubScm {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubScm {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubScm {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubScm>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubScm>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubScm - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubScm as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubScm - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubScm as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubScm - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for GithubScmlinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for GithubScmlinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for GithubScmlinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<GithubScmlinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GithubScmlinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GithubScmlinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <GithubScmlinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into GithubScmlinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <GithubScmlinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into GithubScmlinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Hudson {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Hudson {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for Hudson {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<Hudson>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Hudson>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Hudson - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Hudson as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Hudson - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Hudson as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Hudson - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for HudsonMasterComputer {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for HudsonMasterComputer {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for HudsonMasterComputer {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<HudsonMasterComputer>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<HudsonMasterComputer>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for HudsonMasterComputer - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <HudsonMasterComputer as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into HudsonMasterComputer - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <HudsonMasterComputer as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into HudsonMasterComputer - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for HudsonMasterComputerexecutors {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for HudsonMasterComputerexecutors {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for HudsonMasterComputerexecutors {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<HudsonMasterComputerexecutors>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<HudsonMasterComputerexecutors>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for HudsonMasterComputerexecutors - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <HudsonMasterComputerexecutors as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into HudsonMasterComputerexecutors - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <HudsonMasterComputerexecutors as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into HudsonMasterComputerexecutors - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for HudsonMasterComputermonitorData {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for HudsonMasterComputermonitorData {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for HudsonMasterComputermonitorData {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<HudsonMasterComputermonitorData>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<HudsonMasterComputermonitorData>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for HudsonMasterComputermonitorData - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <HudsonMasterComputermonitorData as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into HudsonMasterComputermonitorData - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <HudsonMasterComputermonitorData as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into HudsonMasterComputermonitorData - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for HudsonassignedLabels {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for HudsonassignedLabels {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for HudsonassignedLabels {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<HudsonassignedLabels>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<HudsonassignedLabels>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for HudsonassignedLabels - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <HudsonassignedLabels as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into HudsonassignedLabels - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <HudsonassignedLabels as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into HudsonassignedLabels - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for InputStepImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for InputStepImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for InputStepImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<InputStepImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<InputStepImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for InputStepImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <InputStepImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into InputStepImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <InputStepImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into InputStepImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for InputStepImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for InputStepImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for InputStepImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            self._class.as_ref().map(|_class| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<InputStepImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<InputStepImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for InputStepImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <InputStepImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into InputStepImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <InputStepImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into InputStepImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Label1 {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Label1 {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for Label1 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<Label1>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Label1>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Label1 - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Label1 as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Label1 - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Label1 as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Label1 - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Link {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Link {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<Link>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Link>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Link - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Link as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Link - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Link as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Link - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ListView {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ListView {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<ListView>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ListView>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ListView - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ListView as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ListView - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ListView as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ListView - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for MultibranchPipeline {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for MultibranchPipeline {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for MultibranchPipeline {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.display_name.as_ref().map(|display_name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<MultibranchPipeline>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<MultibranchPipeline>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for MultibranchPipeline - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <MultibranchPipeline as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into MultibranchPipeline - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <MultibranchPipeline as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into MultibranchPipeline - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for NullScm {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for NullScm {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for NullScm {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<NullScm>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<NullScm>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NullScm - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NullScm as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into NullScm - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <NullScm as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into NullScm - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Organisation {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Organisation {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for Organisation {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<Organisation>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Organisation>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Organisation - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Organisation as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Organisation - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Organisation as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Organisation - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Pipeline {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Pipeline {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<Pipeline>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Pipeline>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Pipeline - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Pipeline as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Pipeline - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Pipeline as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Pipeline - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineActivity {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineActivity {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineActivity {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineActivity>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineActivity>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineActivity - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineActivity as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineActivity - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineActivity as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineActivity - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineActivityartifacts {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineActivityartifacts {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineActivityartifacts {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.name.as_ref().map(|name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineActivityartifacts>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineActivityartifacts>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineActivityartifacts - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineActivityartifacts as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineActivityartifacts - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineActivityartifacts as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineActivityartifacts - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineBranchesitem {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineBranchesitem {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineBranchesitem {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.display_name.as_ref().map(|display_name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineBranchesitem>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineBranchesitem>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineBranchesitem - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineBranchesitem as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineBranchesitem - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineBranchesitem as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineBranchesitem - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineBranchesitemlatestRun {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineBranchesitemlatestRun {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineBranchesitemlatestRun {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.duration_in_millis.as_ref().map(|duration_in_millis| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineBranchesitemlatestRun>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineBranchesitemlatestRun>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineBranchesitemlatestRun - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineBranchesitemlatestRun as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineBranchesitemlatestRun - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineBranchesitemlatestRun as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineBranchesitemlatestRun - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineBranchesitempullRequest {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineBranchesitempullRequest {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineBranchesitempullRequest {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type _links in query parameter serialization
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineBranchesitempullRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineBranchesitempullRequest>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineBranchesitempullRequest - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineBranchesitempullRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineBranchesitempullRequest - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineBranchesitempullRequest as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineBranchesitempullRequest - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineBranchesitempullRequestlinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineBranchesitempullRequestlinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineBranchesitempullRequestlinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineBranchesitempullRequestlinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineBranchesitempullRequestlinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineBranchesitempullRequestlinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineBranchesitempullRequestlinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineBranchesitempullRequestlinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineBranchesitempullRequestlinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineBranchesitempullRequestlinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineFolderImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineFolderImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineFolderImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineFolderImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineFolderImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineFolderImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineFolderImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineFolderImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineFolderImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineFolderImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRun {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRun {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRun>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRun>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRun - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRun as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRun - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRun as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRun - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRunImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRunImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineRunImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRunImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRunImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRunImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRunImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRunImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRunImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRunImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRunImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRunImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineRunImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRunImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRunImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRunImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRunImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRunImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRunImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRunImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRunNode {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRunNode {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineRunNode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRunNode>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRunNode>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRunNode - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRunNode as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRunNode - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRunNode as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRunNode - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRunNodeedges {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRunNodeedges {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineRunNodeedges {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.id.as_ref().map(|id| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRunNodeedges>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRunNodeedges>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRunNodeedges - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRunNodeedges as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRunNodeedges - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRunNodeedges as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRunNodeedges - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineRunartifacts {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineRunartifacts {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineRunartifacts {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.name.as_ref().map(|name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineRunartifacts>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineRunartifacts>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineRunartifacts - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineRunartifacts as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineRunartifacts - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineRunartifacts as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineRunartifacts - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineStepImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineStepImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineStepImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineStepImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineStepImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineStepImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineStepImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineStepImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineStepImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineStepImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelineStepImpllinks {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelineStepImpllinks {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelineStepImpllinks {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type self in query parameter serialization
            // Skipping non-primitive type actions in query parameter serialization
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelineStepImpllinks>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelineStepImpllinks>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelineStepImpllinks - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelineStepImpllinks as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelineStepImpllinks - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelineStepImpllinks as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelineStepImpllinks - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelinelatestRun {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelinelatestRun {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelinelatestRun {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            // Skipping non-primitive type artifacts in query parameter serialization
            self.duration_in_millis.as_ref().map(|duration_in_millis| {
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelinelatestRun>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelinelatestRun>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelinelatestRun - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelinelatestRun as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelinelatestRun - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelinelatestRun as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelinelatestRun - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for PipelinelatestRunartifacts {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for PipelinelatestRunartifacts {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for PipelinelatestRunartifacts {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self.name.as_ref().map(|name| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<PipelinelatestRunartifacts>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PipelinelatestRunartifacts>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PipelinelatestRunartifacts - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PipelinelatestRunartifacts as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into PipelinelatestRunartifacts - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <PipelinelatestRunartifacts as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into PipelinelatestRunartifacts - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for Queue {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for Queue {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
impl std::convert::TryFrom<header::IntoHeaderValue<Queue>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Queue>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Queue - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Queue as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into Queue - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <Queue as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into Queue - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for QueueBlockedItem {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for QueueBlockedItem {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for QueueBlockedItem {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<QueueBlockedItem>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<QueueBlockedItem>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for QueueBlockedItem - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <QueueBlockedItem as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into QueueBlockedItem - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <QueueBlockedItem as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into QueueBlockedItem - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for QueueItemImpl {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for QueueItemImpl {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for QueueItemImpl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<QueueItemImpl>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<QueueItemImpl>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for QueueItemImpl - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <QueueItemImpl as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into QueueItemImpl - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <QueueItemImpl as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into QueueItemImpl - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for QueueLeftItem {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for QueueLeftItem {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for QueueLeftItem {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<QueueLeftItem>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<QueueLeftItem>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for QueueLeftItem - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <QueueLeftItem as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into QueueLeftItem - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <QueueLeftItem as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into QueueLeftItem - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for ResponseTimeMonitorData {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for ResponseTimeMonitorData {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for ResponseTimeMonitorData {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<ResponseTimeMonitorData>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ResponseTimeMonitorData>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ResponseTimeMonitorData - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ResponseTimeMonitorData as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into ResponseTimeMonitorData - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <ResponseTimeMonitorData as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into ResponseTimeMonitorData - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for StringParameterDefinition {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for StringParameterDefinition {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for StringParameterDefinition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<StringParameterDefinition>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<StringParameterDefinition>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for StringParameterDefinition - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <StringParameterDefinition as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into StringParameterDefinition - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <StringParameterDefinition as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into StringParameterDefinition - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for StringParameterValue {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for StringParameterValue {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for StringParameterValue {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<StringParameterValue>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<StringParameterValue>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for StringParameterValue - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <StringParameterValue as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into StringParameterValue - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <StringParameterValue as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into StringParameterValue - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for SwapSpaceMonitorMemoryUsage2 {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for SwapSpaceMonitorMemoryUsage2 {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for SwapSpaceMonitorMemoryUsage2 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<SwapSpaceMonitorMemoryUsage2>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<SwapSpaceMonitorMemoryUsage2>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SwapSpaceMonitorMemoryUsage2 - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SwapSpaceMonitorMemoryUsage2 as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into SwapSpaceMonitorMemoryUsage2 - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <SwapSpaceMonitorMemoryUsage2 as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into SwapSpaceMonitorMemoryUsage2 - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMinLength for UnlabeledLoadStatistics {
    fn validate_composited_min_length(
        &self,
        _min_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MinLengthError>> {
...
#[cfg(feature = "validate")]
impl serde_valid::validation::ValidateCompositedMaxLength for UnlabeledLoadStatistics {
    fn validate_composited_max_length(
        &self,
        _max_length: usize,
    ) -> Result<(), serde_valid::validation::Composited<serde_valid::validation::error::MaxLengthError>> {
...
/// specified in <https://swagger.io/docs/specification/serialization/>
/// Should be implemented in a serde serializer
impl std::fmt::Display for UnlabeledLoadStatistics {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let params: Vec<Option<String>> = vec![
            self._class.as_ref().map(|_class| {
                [
...
impl std::convert::TryFrom<header::IntoHeaderValue<UnlabeledLoadStatistics>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<UnlabeledLoadStatistics>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for UnlabeledLoadStatistics - value: {hdr_value} is invalid {e}"))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <UnlabeledLoadStatistics as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{value}' into UnlabeledLoadStatistics - {err}"))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Unable to convert header: {hdr_value:?} to string: {e}"))
                ...
                .filter_map(|hdr_value| match hdr_value.trim() {
                    ...
                    hdr_value => std::option::Option::Some({
                        match <UnlabeledLoadStatistics as std::str::FromStr>::from_str(hdr_value) {
                            std::result::Result::Ok(value) => std::result::Result::Ok(value),
                            std::result::Result::Err(err) => std::result::Result::Err(
                                format!("Unable to convert header value '{hdr_value}' into UnlabeledLoadStatistics - {err}"))
                        }
                    })
                }).collect::<std::result::Result<std::vec::Vec<_>, String>>()?;
