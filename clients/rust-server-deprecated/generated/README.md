...
- Build date: 2026-08-16T01:41:31.577636735Z[Etc/UTC]
...
cargo run --example openapi_client-client Search
cargo run --example openapi_client-client SearchClasses
cargo run --example openapi_client-client GetAuthenticatedUser
cargo run --example openapi_client-client GetClasses
cargo run --example openapi_client-client GetJsonWebKey
cargo run --example openapi_client-client GetOrganisation
cargo run --example openapi_client-client GetPipelines
cargo run --example openapi_client-client GetUserFavorites
cargo run --example openapi_client-client GetUsers
cargo run --example openapi_client-client GetPipeline
cargo run --example openapi_client-client GetPipelineActivities
cargo run --example openapi_client-client GetPipelineBranches
cargo run --example openapi_client-client GetPipelineFolder
cargo run --example openapi_client-client GetPipelineQueue
cargo run --example openapi_client-client GetPipelineRuns
cargo run --example openapi_client-client GetScm
cargo run --example openapi_client-client GetScmOrganisations
cargo run --example openapi_client-client GetUser
cargo run --example openapi_client-client PostPipelineRuns
cargo run --example openapi_client-client PutPipelineFavorite
cargo run --example openapi_client-client DeletePipelineQueueItem
cargo run --example openapi_client-client GetPipelineBranch
cargo run --example openapi_client-client GetPipelineFolderPipeline
cargo run --example openapi_client-client GetPipelineRun
cargo run --example openapi_client-client GetPipelineRunLog
cargo run --example openapi_client-client GetPipelineRunNodes
cargo run --example openapi_client-client GetScmOrganisationRepositories
cargo run --example openapi_client-client PostPipelineRun
cargo run --example openapi_client-client PutPipelineRun
cargo run --example openapi_client-client GetPipelineBranchRun
cargo run --example openapi_client-client GetPipelineRunNode
cargo run --example openapi_client-client GetPipelineRunNodeSteps
cargo run --example openapi_client-client GetScmOrganisationRepository
cargo run --example openapi_client-client GetPipelineRunNodeStep
cargo run --example openapi_client-client GetPipelineRunNodeStepLog
...
cargo run --example openapi_client-client PostCreateItem
cargo run --example openapi_client-client PostCreateView
cargo run --example openapi_client-client GetJob
cargo run --example openapi_client-client GetJobConfig
cargo run --example openapi_client-client GetJobLastBuild
cargo run --example openapi_client-client GetQueueItem
cargo run --example openapi_client-client GetView
cargo run --example openapi_client-client GetViewConfig
cargo run --example openapi_client-client PostJobBuild
cargo run --example openapi_client-client PostJobConfig
cargo run --example openapi_client-client PostJobDelete
cargo run --example openapi_client-client PostJobDisable
cargo run --example openapi_client-client PostJobEnable
cargo run --example openapi_client-client PostJobLastBuildStop
cargo run --example openapi_client-client PostViewConfig
cargo run --example openapi_client-client GetJobProgressiveText
```
...
```toml
[dependencies]
openapi_client = { version = "3.4.1-pre.0", default-features = false, features = ["client", "server"] }
```

**For server with callbacks that need HTTPS:**
```toml
[dependencies]
openapi_client = { version = "3.4.1-pre.0", features = ["server", "client-tls"] }
```
