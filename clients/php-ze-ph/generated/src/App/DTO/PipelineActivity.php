...
class PipelineActivity
{
     ...
     * @DTA\Strategy(name="ObjectArray", options={"type":\App\DTO\PipelineActivityartifacts::class})
     * @DTA\Validator(name="Collection", options={"validators":{
     *     {"name":"Dictionary", "options":{"type":\App\DTO\PipelineActivityartifacts::class}}
     * }})
     * @var \App\DTO\PipelineActivityartifacts[]
     */
    public $artifacts;
    /**
