...
class PipelineRun
{
     ...
     * @DTA\Strategy(name="ObjectArray", options={"type":\App\DTO\PipelineRunartifacts::class})
     * @DTA\Validator(name="Collection", options={"validators":{
     *     {"name":"Dictionary", "options":{"type":\App\DTO\PipelineRunartifacts::class}}
     * }})
     * @var \App\DTO\PipelineRunartifacts[]
     */
    public $artifacts;
    /**
