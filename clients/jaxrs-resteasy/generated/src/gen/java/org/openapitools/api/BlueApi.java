...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaResteasyServerCodegen", date = "2026-08-15T02:28:26.230644062Z[Etc/UTC]", comments = "Generator version: 7.24.0")
public class BlueApi  {
    ...
    throws NotFoundException {
        return service.deletePipelineQueueItem(organization,pipeline,queue,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getClasses(propertyClass,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getOrganisation(organization,securityContext);
    }
    @GET
    @Path("/organizations/")
    ...
    throws NotFoundException {
        return service.getOrganisations(securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipeline(organization,pipeline,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineActivities(organization,pipeline,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineBranch(organization,pipeline,branch,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineBranchRun(organization,pipeline,branch,run,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineBranches(organization,pipeline,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineFolder(organization,folder,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineFolderPipeline(organization,pipeline,folder,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineQueue(organization,pipeline,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRun(organization,pipeline,run,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunLog(organization,pipeline,run,start,download,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunNode(organization,pipeline,run,node,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunNodeStep(organization,pipeline,run,node,step,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunNodeStepLog(organization,pipeline,run,node,step,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunNodeSteps(organization,pipeline,run,node,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelineRunNodes(organization,pipeline,run,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelines(organization,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getSCM(organization,scm,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getSCMOrganisationRepositories(organization,scm,scmOrganisation,credentialId,pageSize,pageNumber,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getSCMOrganisationRepository(organization,scm,scmOrganisation,repository,credentialId,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getSCMOrganisations(organization,scm,credentialId,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getUser(organization,user,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getUsers(organization,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.postPipelineRun(organization,pipeline,run,securityContext);
    }
    @POST
    @Path("/organizations/{organization}/pipelines/{pipeline}/runs")
    ...
    throws NotFoundException {
        return service.postPipelineRuns(organization,pipeline,securityContext);
    }
    @PUT
    ...
    throws NotFoundException {
        return service.putPipelineRun(organization,pipeline,run,blocking,timeOutInSecs,securityContext);
    }
    @GET
    @Path("/search/")
    ...
    throws NotFoundException {
        return service.search(q,securityContext);
    }
    @GET
    @Path("/classes/")
    ...
    throws NotFoundException {
        return service.searchClasses(q,securityContext);
    }
}
