...
class PipelineActivity {
  /// Returns a new [PipelineActivity] instance.
  PipelineActivity({
    this.class_,
  ...
  static PipelineActivity fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<PipelineActivity> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PipelineActivity.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PipelineActivity>[];

  static Map<String, PipelineActivity> mapFromJson(dynamic json) {
    final map = <String, PipelineActivity>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PipelineActivity.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PipelineActivity-objects as value to a dart map
  static Map<String, List<PipelineActivity>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PipelineActivity>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PipelineActivity.listFromJson(
            value,
