...
class GithubRepositorieslinks {
  ...
  static List<GithubRepositorieslinks> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GithubRepositorieslinks.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GithubRepositorieslinks>[];
  ...
  static Map<String, GithubRepositorieslinks> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GithubRepositorieslinks.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GithubRepositorieslinks-objects as value to a dart map
  static Map<String, List<GithubRepositorieslinks>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GithubRepositorieslinks>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GithubRepositorieslinks.listFromJson(
            value,
