...
final organization = organization_example; // String | Name of the organization
final pipeline = pipeline_example; // String | Name of the pipeline
final body = bool(); // bool | Set JSON string body to {\"favorite\": true} to favorite, set value to false to unfavorite

try {
    final result = api_instance.putPipelineFavorite(organization, pipeline, body);
    print(result);
} catch (e) {
