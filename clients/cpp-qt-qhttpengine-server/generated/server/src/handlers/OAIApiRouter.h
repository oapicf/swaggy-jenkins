...
public:
    ...
    void setOAIBaseApiHandler(QSharedPointer<OAIBaseApiHandler> handler);
    void setOAIBlueOceanApiHandler(QSharedPointer<OAIBlueOceanApiHandler> handler);
    void setOAIRemoteAccessApiHandler(QSharedPointer<OAIRemoteAccessApiHandler> handler);
private:
    ...
    QSharedPointer<OAIBaseApiHandler> mOAIBaseApiHandler;
    QSharedPointer<OAIBlueOceanApiHandler> mOAIBlueOceanApiHandler;
    QSharedPointer<OAIRemoteAccessApiHandler> mOAIRemoteAccessApiHandler;
protected:
