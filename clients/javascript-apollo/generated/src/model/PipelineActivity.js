...
class PipelineActivity {
    ...
    _class;
    /**
     * @member {Array.<CodegenProperty{openApiType='PipelineActivityartifacts', baseName='artifacts', complexType='PipelineActivityartifacts', getter='getArtifacts', setter='setArtifacts', description='null', dataType='PipelineActivityartifacts', datatypeWithEnum='PipelineActivityartifacts', dataFormat='null', name='artifacts', min='null', max='null', defaultValue='null', defaultValueWithParam=' = PipelineActivityartifacts.constructFromObject(data['artifacts']);', baseType='PipelineActivityartifacts', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
