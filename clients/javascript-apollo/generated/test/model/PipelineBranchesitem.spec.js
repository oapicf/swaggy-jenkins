...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggyJenkins.PipelineBranchesitem();
  });
  ...
  describe('PipelineBranchesitem', function() {
    it('should create an instance of PipelineBranchesitem', function() {
      // uncomment below and update the code to test PipelineBranchesitem
      //var instance = new SwaggyJenkins.PipelineBranchesitem();
      //expect(instance).to.be.a(SwaggyJenkins.PipelineBranchesitem);
    });
