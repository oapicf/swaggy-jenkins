...
class PipelineRunImpl implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PipelineRunImpl';
     ...
     */
    public function getLinks(): ?\OpenAPI\Client\Model\PipelineRunImpllinks
    {
     ...
     * @return $this
     */
    public function setLinks(?\OpenAPI\Client\Model\PipelineRunImpllinks $_links): static
    {
        if (is_null($_links)) {
