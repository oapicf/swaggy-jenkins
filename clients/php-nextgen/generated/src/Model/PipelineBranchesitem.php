...
class PipelineBranchesitem implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PipelineBranchesitem';
     ...
     */
    public function getLatestRun(): ?\OpenAPI\Client\Model\PipelineBranchesitemlatestRun
    {
     ...
     * @return $this
     */
    public function setLatestRun(?\OpenAPI\Client\Model\PipelineBranchesitemlatestRun $latest_run): static
    {
     ...
     */
    public function getPullRequest(): ?\OpenAPI\Client\Model\PipelineBranchesitempullRequest
    {
     ...
     * @return $this
     */
    public function setPullRequest(?\OpenAPI\Client\Model\PipelineBranchesitempullRequest $pull_request): static
    {
