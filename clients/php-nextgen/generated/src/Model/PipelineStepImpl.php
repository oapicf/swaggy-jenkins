...
class PipelineStepImpl implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PipelineStepImpl';
     ...
     */
    public function getLinks(): ?\OpenAPI\Client\Model\PipelineStepImpllinks
    {
     ...
     * @return $this
     */
    public function setLinks(?\OpenAPI\Client\Model\PipelineStepImpllinks $_links): static
    {
        if (is_null($_links)) {
     ...
     */
    public function getInput(): ?\OpenAPI\Client\Model\InputStepImpl
    {
     ...
     * @return $this
     */
    public function setInput(?\OpenAPI\Client\Model\InputStepImpl $input): static
    {
        if (is_null($input)) {
