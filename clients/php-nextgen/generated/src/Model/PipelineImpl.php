...
class PipelineImpl implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PipelineImpl';
     ...
     */
    public function getLinks(): ?\OpenAPI\Client\Model\PipelineImpllinks
    {
     ...
     * @return $this
     */
    public function setLinks(?\OpenAPI\Client\Model\PipelineImpllinks $_links): static
    {
        if (is_null($_links)) {
