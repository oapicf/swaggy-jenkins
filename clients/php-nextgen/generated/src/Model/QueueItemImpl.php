...
class QueueItemImpl implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'QueueItemImpl';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expected_build_number', $data ?? [], null);
        $this->setIfExists('id', $data ?? [], null);
        $this->setIfExists('pipeline', $data ?? [], null);
        $this->setIfExists('queued_time', $data ?? [], null);
    }
     ...
     * @return $this
     */
    public function setExpectedBuildNumber(?int $expected_build_number): static
    {
        if (is_null($expected_build_number)) {
            throw new InvalidArgumentException('non-nullable expected_build_number cannot be null');
        }
     ...
     * @return $this
     */
    public function setQueuedTime(?int $queued_time): static
    {
        if (is_null($queued_time)) {
            throw new InvalidArgumentException('non-nullable queued_time cannot be null');
        }
