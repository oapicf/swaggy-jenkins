...
class Queue implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Queue';
    ...
    protected static array $openAPITypes = [
        '_class' => 'string',
        'items' => '\OpenAPI\Client\Model\QueueBlockedItem[]'
    ];
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\QueueBlockedItem[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\QueueBlockedItem[]|null $items items
     *
     * @return $this
     */
