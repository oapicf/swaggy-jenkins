...
class CauseAction implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CauseAction';
    ...
    protected static array $openAPITypes = [
        '_class' => 'string',
        'causes' => '\OpenAPI\Client\Model\CauseUserIdCause[]'
    ];
     ...
     * Gets causes
     *
     * @return \OpenAPI\Client\Model\CauseUserIdCause[]|null
     */
     ...
     * Sets causes
     *
     * @param \OpenAPI\Client\Model\CauseUserIdCause[]|null $causes causes
     *
     * @return $this
     */
    public function setCauses(?array $causes): static
    {
        if (is_null($causes)) {
