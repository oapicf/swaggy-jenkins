...
class GithubRespositoryContainer implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GithubRespositoryContainer';
     ...
     */
    public function getLinks(): ?\OpenAPI\Client\Model\GithubRespositoryContainerlinks
    {
     ...
     * @return $this
     */
    public function setLinks(?\OpenAPI\Client\Model\GithubRespositoryContainerlinks $_links): static
    {
        if (is_null($_links)) {
     ...
     */
    public function getRepositories(): ?\OpenAPI\Client\Model\GithubRepositories
    {
     ...
     * @return $this
     */
    public function setRepositories(?\OpenAPI\Client\Model\GithubRepositories $repositories): static
    {
