...
class PipelineBranchesitem(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "latestRun": PipelineBranchesitemlatestRun.from_dict(obj.get("latestRun")) if obj.get("latestRun") is not None else None,
            "organization": obj.get("organization"),
            "pullRequest": PipelineBranchesitempullRequest.from_dict(obj.get("pullRequest")) if obj.get("pullRequest") is not None else None,
