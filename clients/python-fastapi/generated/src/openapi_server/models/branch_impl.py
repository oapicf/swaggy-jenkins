...
class BranchImpl(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "_links": BranchImpllinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "latestRun": PipelineRunImpl.from_dict(obj.get("latestRun")) if obj.get("latestRun") is not None else None
        })
        return _obj
