...
class FreeStyleProject(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "firstBuild": FreeStyleBuild.from_dict(obj.get("firstBuild")) if obj.get("firstBuild") is not None else None,
            "healthReport": [FreeStyleProjecthealthReport.from_dict(_item) for _item in obj.get("healthReport")] if obj.get("healthReport") is not None else None,
            "inQueue": obj.get("inQueue"),
            "keepDependencies": obj.get("keepDependencies"),
            "lastBuild": FreeStyleBuild.from_dict(obj.get("lastBuild")) if obj.get("lastBuild") is not None else None,
            "lastCompletedBuild": FreeStyleBuild.from_dict(obj.get("lastCompletedBuild")) if obj.get("lastCompletedBuild") is not None else None,
            "lastFailedBuild": obj.get("lastFailedBuild"),
            "lastStableBuild": FreeStyleBuild.from_dict(obj.get("lastStableBuild")) if obj.get("lastStableBuild") is not None else None,
            "lastSuccessfulBuild": FreeStyleBuild.from_dict(obj.get("lastSuccessfulBuild")) if obj.get("lastSuccessfulBuild") is not None else None,
