...
request_path_queue = api_client.PathParameter(
    name="queue",
    style=api_client.ParameterStyle.SIMPLE,
    schema=QueueSchema,
    required=True,
)
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue/{queue}'
_method = 'DELETE'
_auth = [
    'jenkins_auth',
]
...
class DeletePipelineQueueItem(api_client.Api):
