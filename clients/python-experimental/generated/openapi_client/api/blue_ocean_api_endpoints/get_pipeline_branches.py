...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = MultibranchPipeline
...
class GetPipelineBranches(api_client.Api):
