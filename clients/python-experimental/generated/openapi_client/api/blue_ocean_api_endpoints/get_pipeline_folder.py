...
_path = '/blue/rest/organizations/{organization}/pipelines/{folder}/'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = PipelineFolderImpl
...
class GetPipelineFolder(api_client.Api):
