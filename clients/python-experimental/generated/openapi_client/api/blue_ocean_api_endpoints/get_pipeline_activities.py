...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/activities'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = PipelineActivities
...
class GetPipelineActivities(api_client.Api):
