...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = PipelineQueue
...
class GetPipelineQueue(api_client.Api):
