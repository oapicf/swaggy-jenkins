...
_path = '/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories/{repository}'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
...
class GetScmOrganisationRepository(api_client.Api):
