...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = PipelineRunNodeSteps
...
class GetPipelineRunNodeSteps(api_client.Api):
