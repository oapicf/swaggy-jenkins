...
# query params
CredentialIdSchema = StrSchema
PageSizeSchema = IntSchema
PageNumberSchema = IntSchema
...
_path = '/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = ScmOrganisations
...
class GetScmOrganisationRepositories(api_client.Api):
