...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches/{branch}/'
_method = 'GET'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = BranchImpl
...
class GetPipelineBranch(api_client.Api):
