...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/favorite'
_method = 'PUT'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = FavoriteImpl
...
class PutPipelineFavorite(api_client.Api):
