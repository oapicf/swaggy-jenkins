...
# query params
BlockingSchema = StrSchema
TimeOutInSecsSchema = IntSchema
...
_path = '/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/stop'
_method = 'PUT'
_auth = [
    'jenkins_auth',
]
SchemaFor200ResponseBodyApplicationJson = PipelineRun
...
class PutPipelineRun(api_client.Api):
    ...
    def put_pipeline_run(
        ...
        _query_params = []
        for parameter in (
            request_query_blocking,
            request_query_time_out_in_secs,
        ):
