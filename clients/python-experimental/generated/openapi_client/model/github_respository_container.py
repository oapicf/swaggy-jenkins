...
class GithubRespositoryContainer(
    ...
    @classmethod
    @property
    def _links(cls) -> typing.Type['GithubRespositoryContainerlinks']:
        return GithubRespositoryContainerlinks

    @classmethod
    @property
    def repositories(cls) -> typing.Type['GithubRepositories']:
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        _links: typing.Union['GithubRespositoryContainerlinks', Unset] = unset,
        repositories: typing.Union['GithubRepositories', Unset] = unset,
