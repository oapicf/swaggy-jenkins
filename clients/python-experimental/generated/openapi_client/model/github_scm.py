...
class GithubScm(
    ...
    @classmethod
    @property
    def _links(cls) -> typing.Type['GithubScmlinks']:
        return GithubScmlinks
    credentialId = StrSchema
    id = StrSchema
    uri = StrSchema
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict, ],
        ...
        _links: typing.Union['GithubScmlinks', Unset] = unset,
        credentialId: typing.Union[credentialId, Unset] = unset,
