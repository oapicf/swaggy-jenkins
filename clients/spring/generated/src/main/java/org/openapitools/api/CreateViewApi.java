...
public interface CreateViewApi {
    ...
    String PATH_POST_CREATE_VIEW = "/createView";
    /**
     * POST /createView
    ...
    @RequestMapping(
        ...
        value = CreateViewApi.PATH_POST_CREATE_VIEW,
        produces = { "*/*" },
    ...
    default ResponseEntity<Void> postCreateView(
        ...
        @Parameter(name = "body", description = "View configuration in config.xml format") @Valid @RequestBody(required = false) @Nullable String body
    ) {
