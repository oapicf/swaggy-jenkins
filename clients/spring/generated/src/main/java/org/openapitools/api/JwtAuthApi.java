...
public interface JwtAuthApi {
    ...
    default ResponseEntity<String> getJsonWebKey(
        @Parameter(name = "key", description = "Key ID received as part of JWT header field kid", required = true) @PathVariable("key") Integer key
    ) {
    ...
    default ResponseEntity<String> getJsonWebToken(
        @Parameter(name = "expiryTimeInMins", description = "Token expiry time in minutes, default: 30 minutes") @Valid @RequestParam(value = "expiryTimeInMins", required = false) Integer expiryTimeInMins,
        @Parameter(name = "maxExpiryTimeInMins", description = "Maximum token expiry time in minutes, default: 480 minutes") @Valid @RequestParam(value = "maxExpiryTimeInMins", required = false) Integer maxExpiryTimeInMins
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
