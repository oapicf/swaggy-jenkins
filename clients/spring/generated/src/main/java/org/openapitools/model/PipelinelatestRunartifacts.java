...
public class PipelinelatestRunartifacts {
  ...
  public PipelinelatestRunartifacts name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PipelinelatestRunartifacts size(@Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PipelinelatestRunartifacts url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public PipelinelatestRunartifacts propertyClass(@Nullable String propertyClass) {
