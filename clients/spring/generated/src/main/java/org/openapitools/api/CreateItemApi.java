...
public interface CreateItemApi {
    ...
    default ResponseEntity<Void> postCreateItem(
        @NotNull @Parameter(name = "name", description = "Name of the new job", required = true) @Valid @RequestParam(value = "name", required = true) String name,
        @Parameter(name = "from", description = "Existing job to copy from") @Valid @RequestParam(value = "from", required = false) String from,
        @Parameter(name = "mode", description = "Set to 'copy' for copying an existing job") @Valid @RequestParam(value = "mode", required = false) String mode,
        @Parameter(name = "Jenkins-Crumb", description = "CSRF protection token") @RequestHeader(value = "Jenkins-Crumb", required = false) String jenkinsCrumb,
        @Parameter(name = "Content-Type", description = "Content type header application/xml") @RequestHeader(value = "Content-Type", required = false) String contentType,
        @Parameter(name = "body", description = "Job configuration in config.xml format") @Valid @RequestBody(required = false) String body
    ) {
