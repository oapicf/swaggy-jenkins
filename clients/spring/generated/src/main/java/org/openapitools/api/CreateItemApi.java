...
public interface CreateItemApi {
    ...
    default ResponseEntity<Void> postCreateItem(
        ...
        @Parameter(name = "from", description = "Existing job to copy from", in = ParameterIn.QUERY) @Valid @RequestParam(value = "from", required = false) String from,
        @Parameter(name = "mode", description = "Set to 'copy' for copying an existing job", in = ParameterIn.QUERY) @Valid @RequestParam(value = "mode", required = false) String mode,
