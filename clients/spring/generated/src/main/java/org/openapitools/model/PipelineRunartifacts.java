...
public class PipelineRunartifacts {
  ...
  public PipelineRunartifacts name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PipelineRunartifacts size(@Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PipelineRunartifacts url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public PipelineRunartifacts propertyClass(@Nullable String propertyClass) {
