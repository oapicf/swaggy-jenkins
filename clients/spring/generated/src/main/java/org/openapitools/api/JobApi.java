...
public interface JobApi {
    ...
    default ResponseEntity<FreeStyleProject> getJob(
        @Parameter(name = "name", description = "Name of the job", required = true) @PathVariable("name") String name
    ) {
    ...
    default ResponseEntity<Void> getJobProgressiveText(
        @Parameter(name = "name", description = "Name of the job", required = true) @PathVariable("name") String name,
        @Parameter(name = "number", description = "Build number", required = true) @PathVariable("number") String number,
        @NotNull @Parameter(name = "start", description = "Starting point of progressive text output", required = true) @Valid @RequestParam(value = "start", required = true) String start
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> postJobBuild(
        @Parameter(name = "name", description = "Name of the job", required = true) @PathVariable("name") String name,
        @NotNull @Parameter(name = "json", description = "", required = true) @Valid @RequestParam(value = "json", required = true) String json,
        @Parameter(name = "token", description = "") @Valid @RequestParam(value = "token", required = false) String token,
