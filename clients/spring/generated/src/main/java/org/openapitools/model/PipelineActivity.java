...
public class PipelineActivity {
  ...
  public PipelineActivity durationInMillis(@Nullable Integer durationInMillis) {
  ...
  public PipelineActivity estimatedDurationInMillis(@Nullable Integer estimatedDurationInMillis) {
  ...
  public PipelineActivity enQueueTime(@Nullable String enQueueTime) {
  ...
  public PipelineActivity endTime(@Nullable String endTime) {
  ...
  public PipelineActivity id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PipelineActivity organization(@Nullable String organization) {
  ...
  public PipelineActivity pipeline(@Nullable String pipeline) {
  ...
  public PipelineActivity result(@Nullable String result) {
    this.result = result;
    return this;
  }
  ...
  public PipelineActivity runSummary(@Nullable String runSummary) {
  ...
  public PipelineActivity startTime(@Nullable String startTime) {
  ...
  public PipelineActivity state(@Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public PipelineActivity type(@Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public PipelineActivity commitId(@Nullable String commitId) {
