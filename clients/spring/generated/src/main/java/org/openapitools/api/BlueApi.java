...
public interface BlueApi {
    ...
    default ResponseEntity<Void> deletePipelineQueueItem(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "queue", description = "Name of the queue item", required = true) @PathVariable("queue") String queue
    ) {
    ...
    default ResponseEntity<String> getClasses(
        @Parameter(name = "class", description = "Name of the class", required = true) @PathVariable("class") String propertyClass
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<BranchImpl> getPipelineBranch(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "branch", description = "Name of the branch", required = true) @PathVariable("branch") String branch
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<PipelineRun> getPipelineBranchRun(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "branch", description = "Name of the branch", required = true) @PathVariable("branch") String branch,
        @Parameter(name = "run", description = "Name of the run", required = true) @PathVariable("run") String run
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<PipelineFolderImpl> getPipelineFolder(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "folder", description = "Name of the folder", required = true) @PathVariable("folder") String folder
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<String> getPipelineRunLog(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true) @PathVariable("run") String run,
        @Parameter(name = "start", description = "Start position of the log") @Valid @RequestParam(value = "start", required = false) Integer start,
        @Parameter(name = "download", description = "Set to true in order to download the file, otherwise it's passed as a response body") @Valid @RequestParam(value = "download", required = false) Boolean download
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<PipelineRunNode> getPipelineRunNode(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true) @PathVariable("run") String run,
        @Parameter(name = "node", description = "Name of the node", required = true) @PathVariable("node") String node
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<PipelineStepImpl> getPipelineRunNodeStep(
        ...
        @Parameter(name = "run", description = "Name of the run", required = true) @PathVariable("run") String run,
        @Parameter(name = "node", description = "Name of the node", required = true) @PathVariable("node") String node,
        @Parameter(name = "step", description = "Name of the step", required = true) @PathVariable("step") String step
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<GithubScm> getSCM(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "scm", description = "Name of SCM", required = true) @PathVariable("scm") String scm
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<List<GithubOrganization>> getSCMOrganisationRepositories(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "scm", description = "Name of SCM", required = true) @PathVariable("scm") String scm,
        @Parameter(name = "scmOrganisation", description = "Name of the SCM organization", required = true) @PathVariable("scmOrganisation") String scmOrganisation,
        @Parameter(name = "credentialId", description = "Credential ID") @Valid @RequestParam(value = "credentialId", required = false) String credentialId,
        @Parameter(name = "pageSize", description = "Number of items in a page") @Valid @RequestParam(value = "pageSize", required = false) Integer pageSize,
        @Parameter(name = "pageNumber", description = "Page number") @Valid @RequestParam(value = "pageNumber", required = false) Integer pageNumber
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<List<GithubOrganization>> getSCMOrganisationRepository(
        ...
        @Parameter(name = "scm", description = "Name of SCM", required = true) @PathVariable("scm") String scm,
        @Parameter(name = "scmOrganisation", description = "Name of the SCM organization", required = true) @PathVariable("scmOrganisation") String scmOrganisation,
        @Parameter(name = "repository", description = "Name of the SCM repository", required = true) @PathVariable("repository") String repository,
        @Parameter(name = "credentialId", description = "Credential ID") @Valid @RequestParam(value = "credentialId", required = false) String credentialId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<User> getUser(
        @Parameter(name = "organization", description = "Name of the organization", required = true) @PathVariable("organization") String organization,
        @Parameter(name = "user", description = "Name of the user", required = true) @PathVariable("user") String user
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<PipelineRun> putPipelineRun(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true) @PathVariable("run") String run,
        @Parameter(name = "blocking", description = "Set to true to make blocking stop, default: false") @Valid @RequestParam(value = "blocking", required = false) String blocking,
        @Parameter(name = "timeOutInSecs", description = "Timeout in seconds, default: 10 seconds") @Valid @RequestParam(value = "timeOutInSecs", required = false) Integer timeOutInSecs
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<String> search(
        @NotNull @Parameter(name = "q", description = "Query string", required = true) @Valid @RequestParam(value = "q", required = true) String q
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<String> searchClasses(
        @NotNull @Parameter(name = "q", description = "Query string containing an array of class names", required = true) @Valid @RequestParam(value = "q", required = true) String q
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
