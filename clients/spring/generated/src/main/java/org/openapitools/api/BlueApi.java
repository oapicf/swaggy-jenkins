...
public interface BlueApi {
    ...
    default ResponseEntity<Void> deletePipelineQueueItem(
        ...
        @Parameter(name = "queue", description = "Name of the queue item", required = true, schema = @Schema(description = "")) @PathVariable("queue") String queue
    ) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved authenticated user details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  User.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved class names", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  String.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<String> getClasses(
        @Parameter(name = "class", description = "Name of the class", required = true, schema = @Schema(description = "")) @PathVariable("class") String propertyClass
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipeline details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  Organisation.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password"),
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipelines details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  Organisation.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipeline details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  Pipeline.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password"),
            @ApiResponse(responseCode = "404", description = "Pipeline cannot be found on Jenkins instance")
        },
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved all activities details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineActivity.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved branch details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  BranchImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<BranchImpl> getPipelineBranch(
        @Parameter(name = "organization", description = "Name of the organization", required = true, schema = @Schema(description = "")) @PathVariable("organization") String organization,
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true, schema = @Schema(description = "")) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "branch", description = "Name of the branch", required = true, schema = @Schema(description = "")) @PathVariable("branch") String branch
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved run details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineRun.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<PipelineRun> getPipelineBranchRun(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true, schema = @Schema(description = "")) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "branch", description = "Name of the branch", required = true, schema = @Schema(description = "")) @PathVariable("branch") String branch,
        @Parameter(name = "run", description = "Name of the run", required = true, schema = @Schema(description = "")) @PathVariable("run") String run
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved all branches details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  MultibranchPipeline.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved folder details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineFolderImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<PipelineFolderImpl> getPipelineFolder(
        @Parameter(name = "organization", description = "Name of the organization", required = true, schema = @Schema(description = "")) @PathVariable("organization") String organization,
        @Parameter(name = "folder", description = "Name of the folder", required = true, schema = @Schema(description = "")) @PathVariable("folder") String folder
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipeline details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved queue details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  QueueItemImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipeline run log", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  String.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<String> getPipelineRunLog(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true, schema = @Schema(description = "")) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true, schema = @Schema(description = "")) @PathVariable("run") String run,
        @Parameter(name = "start", description = "Start position of the log", schema = @Schema(description = "")) @Valid @RequestParam(value = "start", required = false) Integer start,
        @Parameter(name = "download", description = "Set to true in order to download the file, otherwise it's passed as a response body", schema = @Schema(description = "")) @Valid @RequestParam(value = "download", required = false) Boolean download
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved run node details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineRunNode.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<PipelineRunNode> getPipelineRunNode(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true, schema = @Schema(description = "")) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true, schema = @Schema(description = "")) @PathVariable("run") String run,
        @Parameter(name = "node", description = "Name of the node", required = true, schema = @Schema(description = "")) @PathVariable("node") String node
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved run node step details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineStepImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<PipelineStepImpl> getPipelineRunNodeStep(
        ...
        @Parameter(name = "run", description = "Name of the run", required = true, schema = @Schema(description = "")) @PathVariable("run") String run,
        @Parameter(name = "node", description = "Name of the node", required = true, schema = @Schema(description = "")) @PathVariable("node") String node,
        @Parameter(name = "step", description = "Name of the step", required = true, schema = @Schema(description = "")) @PathVariable("step") String step
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipeline run node step log", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  String.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved run node steps details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineStepImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved run nodes details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineRunNode.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved runs details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineRun.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved pipelines details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  Pipeline.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved SCM details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  GithubScm.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<GithubScm> getSCM(
        @Parameter(name = "organization", description = "Name of the organization", required = true, schema = @Schema(description = "")) @PathVariable("organization") String organization,
        @Parameter(name = "scm", description = "Name of SCM", required = true, schema = @Schema(description = "")) @PathVariable("scm") String scm
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved SCM organization repositories details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  GithubOrganization.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<List<GithubOrganization>> getSCMOrganisationRepositories(
        @Parameter(name = "organization", description = "Name of the organization", required = true, schema = @Schema(description = "")) @PathVariable("organization") String organization,
        @Parameter(name = "scm", description = "Name of SCM", required = true, schema = @Schema(description = "")) @PathVariable("scm") String scm,
        @Parameter(name = "scmOrganisation", description = "Name of the SCM organization", required = true, schema = @Schema(description = "")) @PathVariable("scmOrganisation") String scmOrganisation,
        @Parameter(name = "credentialId", description = "Credential ID", schema = @Schema(description = "")) @Valid @RequestParam(value = "credentialId", required = false) String credentialId,
        @Parameter(name = "pageSize", description = "Number of items in a page", schema = @Schema(description = "")) @Valid @RequestParam(value = "pageSize", required = false) Integer pageSize,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"_links\" : { \"repositories\" : { \"_class\" : \"_class\", \"href\" : \"href\" }, \"self\" : { \"_class\" : \"_class\", \"href\" : \"href\" }, \"_class\" : \"_class\" }, \"name\" : \"name\", \"_class\" : \"_class\", \"jenkinsOrganizationPipeline\" : true }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved SCM organizations details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  GithubOrganization.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<List<GithubOrganization>> getSCMOrganisationRepository(
        ...
        @Parameter(name = "scm", description = "Name of SCM", required = true, schema = @Schema(description = "")) @PathVariable("scm") String scm,
        @Parameter(name = "scmOrganisation", description = "Name of the SCM organization", required = true, schema = @Schema(description = "")) @PathVariable("scmOrganisation") String scmOrganisation,
        @Parameter(name = "repository", description = "Name of the SCM repository", required = true, schema = @Schema(description = "")) @PathVariable("repository") String repository,
        @Parameter(name = "credentialId", description = "Credential ID", schema = @Schema(description = "")) @Valid @RequestParam(value = "credentialId", required = false) String credentialId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved users details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  User.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<User> getUser(
        @Parameter(name = "organization", description = "Name of the organization", required = true, schema = @Schema(description = "")) @PathVariable("organization") String organization,
        @Parameter(name = "user", description = "Name of the user", required = true, schema = @Schema(description = "")) @PathVariable("user") String user
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved users favorites details", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  FavoriteImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully replayed a pipeline run", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  QueueItemImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully started a build", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  QueueItemImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully favorited/unfavorited a pipeline", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  FavoriteImpl.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully stopped a build", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  PipelineRun.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<PipelineRun> putPipelineRun(
        ...
        @Parameter(name = "pipeline", description = "Name of the pipeline", required = true, schema = @Schema(description = "")) @PathVariable("pipeline") String pipeline,
        @Parameter(name = "run", description = "Name of the run", required = true, schema = @Schema(description = "")) @PathVariable("run") String run,
        @Parameter(name = "blocking", description = "Set to true to make blocking stop, default: false", schema = @Schema(description = "")) @Valid @RequestParam(value = "blocking", required = false) String blocking,
        @Parameter(name = "timeOutInSecs", description = "Timeout in seconds, default: 10 seconds", schema = @Schema(description = "")) @Valid @RequestParam(value = "timeOutInSecs", required = false) Integer timeOutInSecs
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    @Operation(
        ...
        tags = { "blueOcean" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved search result", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  String.class))),
            @ApiResponse(responseCode = "401", description = "Authentication failed - incorrect username and/or password"),
            @ApiResponse(responseCode = "403", description = "Jenkins requires authentication - please set username and password")
        },
        security = {
    ...
    default ResponseEntity<String> search(
        @NotNull @Parameter(name = "q", description = "Query string", required = true, schema = @Schema(description = "")) @Valid @RequestParam(value = "q", required = true) String q
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<String> searchClasses(
        @NotNull @Parameter(name = "q", description = "Query string containing an array of class names", required = true, schema = @Schema(description = "")) @Valid @RequestParam(value = "q", required = true) String q
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
