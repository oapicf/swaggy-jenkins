...
class PipelineRunNodeedges(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineRunNodeedges:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineRunNodeedges:
        """Create an instance of PipelineRunNodeedges from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineRunNodeedges.parse_obj(obj)

        _obj = PipelineRunNodeedges.parse_obj({
            "id": obj.get("id"),
