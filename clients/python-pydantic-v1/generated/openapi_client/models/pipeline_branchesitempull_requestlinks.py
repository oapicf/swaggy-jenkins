...
class PipelineBranchesitempullRequestlinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineBranchesitempullRequestlinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineBranchesitempullRequestlinks:
        """Create an instance of PipelineBranchesitempullRequestlinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineBranchesitempullRequestlinks.parse_obj(obj)

        _obj = PipelineBranchesitempullRequestlinks.parse_obj({
