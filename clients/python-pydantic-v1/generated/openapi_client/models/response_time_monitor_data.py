...
class ResponseTimeMonitorData(BaseModel):
    ...
    __properties = ["_class", "timestamp", "average"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseTimeMonitorData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseTimeMonitorData:
        """Create an instance of ResponseTimeMonitorData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseTimeMonitorData.parse_obj(obj)

        _obj = ResponseTimeMonitorData.parse_obj({
