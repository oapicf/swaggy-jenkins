...
class PipelineStepImpllinks(BaseModel):
    ...
    __properties = ["self", "actions", "_class"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineStepImpllinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineStepImpllinks:
        """Create an instance of PipelineStepImpllinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineStepImpllinks.parse_obj(obj)

        _obj = PipelineStepImpllinks.parse_obj({
