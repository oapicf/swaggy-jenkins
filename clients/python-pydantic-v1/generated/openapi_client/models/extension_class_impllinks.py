...
class ExtensionClassImpllinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtensionClassImpllinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtensionClassImpllinks:
        """Create an instance of ExtensionClassImpllinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtensionClassImpllinks.parse_obj(obj)

        _obj = ExtensionClassImpllinks.parse_obj({
