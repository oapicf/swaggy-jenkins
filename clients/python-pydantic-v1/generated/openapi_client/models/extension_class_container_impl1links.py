...
class ExtensionClassContainerImpl1links(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtensionClassContainerImpl1links:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtensionClassContainerImpl1links:
        """Create an instance of ExtensionClassContainerImpl1links from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtensionClassContainerImpl1links.parse_obj(obj)

        _obj = ExtensionClassContainerImpl1links.parse_obj({
