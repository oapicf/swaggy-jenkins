...
class GithubRepositorypermissions(BaseModel):
    ...
    __properties = ["admin", "push", "pull", "_class"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GithubRepositorypermissions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GithubRepositorypermissions:
        """Create an instance of GithubRepositorypermissions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GithubRepositorypermissions.parse_obj(obj)

        _obj = GithubRepositorypermissions.parse_obj({
            "admin": obj.get("admin"),
            "push": obj.get("push"),
            "pull": obj.get("pull"),
