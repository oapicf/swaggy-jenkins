...
class GithubRepositorylinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GithubRepositorylinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GithubRepositorylinks:
        """Create an instance of GithubRepositorylinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GithubRepositorylinks.parse_obj(obj)

        _obj = GithubRepositorylinks.parse_obj({
