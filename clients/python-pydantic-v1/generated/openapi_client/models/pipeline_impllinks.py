...
class PipelineImpllinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineImpllinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineImpllinks:
        """Create an instance of PipelineImpllinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineImpllinks.parse_obj(obj)

        _obj = PipelineImpllinks.parse_obj({
