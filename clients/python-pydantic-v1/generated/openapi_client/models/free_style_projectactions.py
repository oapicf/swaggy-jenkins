...
class FreeStyleProjectactions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FreeStyleProjectactions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FreeStyleProjectactions:
        """Create an instance of FreeStyleProjectactions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FreeStyleProjectactions.parse_obj(obj)

        _obj = FreeStyleProjectactions.parse_obj({
