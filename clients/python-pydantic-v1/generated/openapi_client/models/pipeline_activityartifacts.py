...
class PipelineActivityartifacts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PipelineActivityartifacts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PipelineActivityartifacts:
        """Create an instance of PipelineActivityartifacts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PipelineActivityartifacts.parse_obj(obj)

        _obj = PipelineActivityartifacts.parse_obj({
            "name": obj.get("name"),
            "size": obj.get("size"),
            "url": obj.get("url"),
