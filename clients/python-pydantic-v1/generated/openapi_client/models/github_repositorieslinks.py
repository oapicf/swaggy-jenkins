...
class GithubRepositorieslinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GithubRepositorieslinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GithubRepositorieslinks:
        """Create an instance of GithubRepositorieslinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GithubRepositorieslinks.parse_obj(obj)

        _obj = GithubRepositorieslinks.parse_obj({
