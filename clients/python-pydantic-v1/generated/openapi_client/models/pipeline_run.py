...
class PipelineRun(BaseModel):
    ...
    artifacts: Optional[conlist(PipelineRunartifacts)] = None
    ...
    def from_dict(cls, obj: dict) -> PipelineRun:
        ...
        _obj = PipelineRun.parse_obj({
            ...
            "artifacts": [PipelineRunartifacts.from_dict(_item) for _item in obj.get("artifacts")] if obj.get("artifacts") is not None else None,
