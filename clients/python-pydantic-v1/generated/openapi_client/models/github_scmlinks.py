...
class GithubScmlinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GithubScmlinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GithubScmlinks:
        """Create an instance of GithubScmlinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GithubScmlinks.parse_obj(obj)

        _obj = GithubScmlinks.parse_obj({
