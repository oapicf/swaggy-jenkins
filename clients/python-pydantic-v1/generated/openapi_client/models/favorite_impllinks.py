...
class FavoriteImpllinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FavoriteImpllinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FavoriteImpllinks:
        """Create an instance of FavoriteImpllinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FavoriteImpllinks.parse_obj(obj)

        _obj = FavoriteImpllinks.parse_obj({
