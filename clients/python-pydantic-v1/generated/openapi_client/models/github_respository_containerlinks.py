...
class GithubRespositoryContainerlinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GithubRespositoryContainerlinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GithubRespositoryContainerlinks:
        """Create an instance of GithubRespositoryContainerlinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GithubRespositoryContainerlinks.parse_obj(obj)

        _obj = GithubRespositoryContainerlinks.parse_obj({
