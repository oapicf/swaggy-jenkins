...
public struct PipelineRun: Codable, JSONEncodable, Hashable {
    ...
    public init(_class: String? = nil, artifacts: [PipelineRunartifacts]? = nil, durationInMillis: Int? = nil, estimatedDurationInMillis: Int? = nil, enQueueTime: String? = nil, endTime: String? = nil, id: String? = nil, organization: String? = nil, pipeline: String? = nil, result: String? = nil, runSummary: String? = nil, startTime: String? = nil, state: String? = nil, type: String? = nil, commitId: String? = nil) {
        self._class = _class
...
extension PipelineRun: Identifiable {}
