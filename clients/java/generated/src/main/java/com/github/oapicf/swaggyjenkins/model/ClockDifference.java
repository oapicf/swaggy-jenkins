...
public class ClockDifference {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "diff"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClockDifference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClockDifference is not found in the empty JSON string", ClockDifference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClockDifference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ClockDifference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
