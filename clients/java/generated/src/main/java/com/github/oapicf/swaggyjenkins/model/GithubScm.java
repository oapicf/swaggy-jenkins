...
public class GithubScm {
  ...
  public GithubScm propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public GithubScm links(@javax.annotation.Nullable GithubScmlinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nullable GithubScmlinks links) {
    this.links = links;
  }


  public GithubScm credentialId(@javax.annotation.Nullable String credentialId) {
  ...
  public GithubScm id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GithubScm uri(@javax.annotation.Nullable String uri) {
    this.uri = uri;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "_links", "credentialId", "id", "uri"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GithubScm.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GithubScm is not found in the empty JSON string", GithubScm.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GithubScm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GithubScm` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
