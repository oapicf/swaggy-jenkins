...
public class ExtensionClassContainerImpl1map {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("io.jenkins.blueocean.service.embedded.rest.PipelineImpl", "io.jenkins.blueocean.service.embedded.rest.MultiBranchPipelineImpl", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtensionClassContainerImpl1map.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExtensionClassContainerImpl1map is not found in the empty JSON string", ExtensionClassContainerImpl1map.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtensionClassContainerImpl1map.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExtensionClassContainerImpl1map` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
