...
public class HudsonMasterComputer {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "displayName", "executors", "icon", "iconClassName", "idle", "jnlpAgent", "launchSupported", "loadStatistics", "manualLaunchAllowed", "monitorData", "numExecutors", "offline", "offlineCause", "offlineCauseReason", "temporarilyOffline"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HudsonMasterComputer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HudsonMasterComputer is not found in the empty JSON string", HudsonMasterComputer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HudsonMasterComputer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `HudsonMasterComputer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("executors") != null && !jsonObj.get("executors").isJsonNull()) {
        ...
        if (jsonArrayexecutors != null) {
          ...
          if (!jsonObj.get("executors").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `executors` to be an array in the JSON string but got `%s`", jsonObj.get("executors").toString()));
          }
      ...
      if ((jsonObj.get("iconClassName") != null && !jsonObj.get("iconClassName").isJsonNull()) && !jsonObj.get("iconClassName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `iconClassName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iconClassName").toString()));
      }
      ...
      if ((jsonObj.get("offlineCause") != null && !jsonObj.get("offlineCause").isJsonNull()) && !jsonObj.get("offlineCause").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `offlineCause` to be a primitive type in the JSON string but got `%s`", jsonObj.get("offlineCause").toString()));
      }
      if ((jsonObj.get("offlineCauseReason") != null && !jsonObj.get("offlineCauseReason").isJsonNull()) && !jsonObj.get("offlineCauseReason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `offlineCauseReason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("offlineCauseReason").toString()));
      }
  }
