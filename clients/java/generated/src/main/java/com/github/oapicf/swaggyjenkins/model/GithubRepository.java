...
public class GithubRepository {
  ...
  public GithubRepository propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public GithubRepository links(@javax.annotation.Nullable GithubRepositorylinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nullable GithubRepositorylinks links) {
    this.links = links;
  }


  public GithubRepository defaultBranch(@javax.annotation.Nullable String defaultBranch) {
  ...
  public GithubRepository description(@javax.annotation.Nullable String description) {
  ...
  public GithubRepository name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GithubRepository permissions(@javax.annotation.Nullable GithubRepositorypermissions permissions) {
  ...
  public void setPermissions(@javax.annotation.Nullable GithubRepositorypermissions permissions) {
    this.permissions = permissions;
  }


  public GithubRepository _private(@javax.annotation.Nullable Boolean _private) {
  ...
  public GithubRepository fullName(@javax.annotation.Nullable String fullName) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "_links", "defaultBranch", "description", "name", "permissions", "private", "fullName"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GithubRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GithubRepository is not found in the empty JSON string", GithubRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GithubRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GithubRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("defaultBranch") != null && !jsonObj.get("defaultBranch").isJsonNull()) && !jsonObj.get("defaultBranch").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `defaultBranch` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultBranch").toString()));
      }
