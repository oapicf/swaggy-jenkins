...
public class FavoriteImpl {
  ...
  public FavoriteImpl propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public FavoriteImpl links(@javax.annotation.Nullable FavoriteImpllinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nullable FavoriteImpllinks links) {
    this.links = links;
  }


  public FavoriteImpl item(@javax.annotation.Nullable PipelineImpl item) {
    this.item = item;
    return this;
  }
  ...
  public void setItem(@javax.annotation.Nullable PipelineImpl item) {
    this.item = item;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "_links", "item"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FavoriteImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FavoriteImpl is not found in the empty JSON string", FavoriteImpl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FavoriteImpl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FavoriteImpl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
