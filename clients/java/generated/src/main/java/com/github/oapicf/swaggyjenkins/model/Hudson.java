...
public class Hudson {
  ...
  public Hudson propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public Hudson assignedLabels(@javax.annotation.Nullable List<HudsonassignedLabels> assignedLabels) {
  ...
  public void setAssignedLabels(@javax.annotation.Nullable List<HudsonassignedLabels> assignedLabels) {
    this.assignedLabels = assignedLabels;
  }


  public Hudson mode(@javax.annotation.Nullable String mode) {
    this.mode = mode;
    return this;
  }
  ...
  public Hudson nodeDescription(@javax.annotation.Nullable String nodeDescription) {
  ...
  public void setNodeDescription(@javax.annotation.Nullable String nodeDescription) {
    this.nodeDescription = nodeDescription;
  }


  public Hudson nodeName(@javax.annotation.Nullable String nodeName) {
  ...
  public Hudson numExecutors(@javax.annotation.Nullable Integer numExecutors) {
  ...
  public Hudson description(@javax.annotation.Nullable String description) {
  ...
  public Hudson jobs(@javax.annotation.Nullable List<FreeStyleProject> jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  public void setJobs(@javax.annotation.Nullable List<FreeStyleProject> jobs) {
    this.jobs = jobs;
  }


  public Hudson primaryView(@javax.annotation.Nullable AllView primaryView) {
  ...
  public void setPrimaryView(@javax.annotation.Nullable AllView primaryView) {
    this.primaryView = primaryView;
  }


  public Hudson quietingDown(@javax.annotation.Nullable Boolean quietingDown) {
  ...
  public void setQuietingDown(@javax.annotation.Nullable Boolean quietingDown) {
    this.quietingDown = quietingDown;
  }


  public Hudson slaveAgentPort(@javax.annotation.Nullable Integer slaveAgentPort) {
  ...
  public void setSlaveAgentPort(@javax.annotation.Nullable Integer slaveAgentPort) {
    this.slaveAgentPort = slaveAgentPort;
  }


  public Hudson unlabeledLoad(@javax.annotation.Nullable UnlabeledLoadStatistics unlabeledLoad) {
  ...
  public void setUnlabeledLoad(@javax.annotation.Nullable UnlabeledLoadStatistics unlabeledLoad) {
    this.unlabeledLoad = unlabeledLoad;
  }


  public Hudson useCrumbs(@javax.annotation.Nullable Boolean useCrumbs) {
  ...
  public void setUseCrumbs(@javax.annotation.Nullable Boolean useCrumbs) {
    this.useCrumbs = useCrumbs;
  }


  public Hudson useSecurity(@javax.annotation.Nullable Boolean useSecurity) {
  ...
  public void setUseSecurity(@javax.annotation.Nullable Boolean useSecurity) {
    this.useSecurity = useSecurity;
  }


  public Hudson views(@javax.annotation.Nullable List<AllView> views) {
    this.views = views;
    return this;
  }
  ...
  public void setViews(@javax.annotation.Nullable List<AllView> views) {
    this.views = views;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "assignedLabels", "mode", "nodeDescription", "nodeName", "numExecutors", "description", "jobs", "primaryView", "quietingDown", "slaveAgentPort", "unlabeledLoad", "useCrumbs", "useSecurity", "views"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hudson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Hudson is not found in the empty JSON string", Hudson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hudson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Hudson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("assignedLabels") != null && !jsonObj.get("assignedLabels").isJsonNull()) {
        ...
        if (jsonArrayassignedLabels != null) {
          ...
          if (!jsonObj.get("assignedLabels").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `assignedLabels` to be an array in the JSON string but got `%s`", jsonObj.get("assignedLabels").toString()));
          }
      ...
      if ((jsonObj.get("nodeDescription") != null && !jsonObj.get("nodeDescription").isJsonNull()) && !jsonObj.get("nodeDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nodeDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nodeDescription").toString()));
      }
      ...
      if (jsonObj.get("views") != null && !jsonObj.get("views").isJsonNull()) {
        ...
        if (jsonArrayviews != null) {
          ...
          if (!jsonObj.get("views").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `views` to be an array in the JSON string but got `%s`", jsonObj.get("views").toString()));
          }
