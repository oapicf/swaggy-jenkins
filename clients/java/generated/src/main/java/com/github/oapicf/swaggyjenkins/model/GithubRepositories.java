...
public class GithubRepositories {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "_links", "items", "lastPage", "nextPage", "pageSize"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GithubRepositories.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GithubRepositories is not found in the empty JSON string", GithubRepositories.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GithubRepositories.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GithubRepositories` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
