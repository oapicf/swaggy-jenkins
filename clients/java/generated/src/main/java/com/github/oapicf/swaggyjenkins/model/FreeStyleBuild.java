...
public class FreeStyleBuild {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "number", "url", "actions", "building", "description", "displayName", "duration", "estimatedDuration", "executor", "fullDisplayName", "id", "keepLog", "queueId", "result", "timestamp", "builtOn", "changeSet"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FreeStyleBuild.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FreeStyleBuild is not found in the empty JSON string", FreeStyleBuild.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FreeStyleBuild.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FreeStyleBuild` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("executor") != null && !jsonObj.get("executor").isJsonNull()) && !jsonObj.get("executor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `executor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("executor").toString()));
      }
      ...
      if ((jsonObj.get("builtOn") != null && !jsonObj.get("builtOn").isJsonNull()) && !jsonObj.get("builtOn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `builtOn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("builtOn").toString()));
      }
