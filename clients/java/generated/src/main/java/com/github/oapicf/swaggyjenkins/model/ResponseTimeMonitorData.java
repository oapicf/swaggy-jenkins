...
public class ResponseTimeMonitorData {
  ...
  public ResponseTimeMonitorData propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ResponseTimeMonitorData timestamp(@javax.annotation.Nullable Integer timestamp) {
  ...
  public ResponseTimeMonitorData average(@javax.annotation.Nullable Integer average) {
  ...
  public void setAverage(@javax.annotation.Nullable Integer average) {
    this.average = average;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "timestamp", "average"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseTimeMonitorData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResponseTimeMonitorData is not found in the empty JSON string", ResponseTimeMonitorData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseTimeMonitorData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ResponseTimeMonitorData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
