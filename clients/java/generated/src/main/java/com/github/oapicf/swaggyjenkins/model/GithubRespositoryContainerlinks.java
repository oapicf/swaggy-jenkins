...
public class GithubRespositoryContainerlinks {
  ...
  public GithubRespositoryContainerlinks self(@javax.annotation.Nullable Link self) {
    this.self = self;
    return this;
  }
  ...
  public GithubRespositoryContainerlinks propertyClass(@javax.annotation.Nullable String propertyClass) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GithubRespositoryContainerlinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GithubRespositoryContainerlinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GithubRespositoryContainerlinks is not found in the empty JSON string", GithubRespositoryContainerlinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GithubRespositoryContainerlinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GithubRespositoryContainerlinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
