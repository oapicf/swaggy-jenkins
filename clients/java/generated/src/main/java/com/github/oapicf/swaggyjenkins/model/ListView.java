...
public class ListView {
  ...
  public ListView propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public ListView description(@javax.annotation.Nullable String description) {
  ...
  public ListView jobs(@javax.annotation.Nullable List<FreeStyleProject> jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  public ListView name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ListView url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "description", "jobs", "name", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListView.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListView is not found in the empty JSON string", ListView.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListView.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListView` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
