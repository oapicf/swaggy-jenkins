...
public class DiskSpaceMonitorDescriptorDiskSpace {
  ...
  public DiskSpaceMonitorDescriptorDiskSpace propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public DiskSpaceMonitorDescriptorDiskSpace timestamp(@javax.annotation.Nullable Integer timestamp) {
  ...
  public DiskSpaceMonitorDescriptorDiskSpace path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public DiskSpaceMonitorDescriptorDiskSpace size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "timestamp", "path", "size"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiskSpaceMonitorDescriptorDiskSpace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DiskSpaceMonitorDescriptorDiskSpace is not found in the empty JSON string", DiskSpaceMonitorDescriptorDiskSpace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiskSpaceMonitorDescriptorDiskSpace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DiskSpaceMonitorDescriptorDiskSpace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
