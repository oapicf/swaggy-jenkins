...
public class PipelineRunImpllinks {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("nodes", "log", "self", "actions", "steps", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineRunImpllinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelineRunImpllinks is not found in the empty JSON string", PipelineRunImpllinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineRunImpllinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelineRunImpllinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
