...
public class InputStepImpl {
  ...
  public InputStepImpl propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public InputStepImpl links(@javax.annotation.Nullable InputStepImpllinks links) {
    this.links = links;
    return this;
  }
  ...
  public void setLinks(@javax.annotation.Nullable InputStepImpllinks links) {
    this.links = links;
  }


  public InputStepImpl id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public InputStepImpl message(@javax.annotation.Nullable String message) {
  ...
  public InputStepImpl ok(@javax.annotation.Nullable String ok) {
    this.ok = ok;
    return this;
  }
  ...
  public void setOk(@javax.annotation.Nullable String ok) {
    this.ok = ok;
  }


  public InputStepImpl parameters(@javax.annotation.Nullable List<StringParameterDefinition> parameters) {
  ...
  public InputStepImpl submitter(@javax.annotation.Nullable String submitter) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "_links", "id", "message", "ok", "parameters", "submitter"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputStepImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InputStepImpl is not found in the empty JSON string", InputStepImpl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputStepImpl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InputStepImpl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("submitter") != null && !jsonObj.get("submitter").isJsonNull()) && !jsonObj.get("submitter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `submitter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("submitter").toString()));
      }
  }
