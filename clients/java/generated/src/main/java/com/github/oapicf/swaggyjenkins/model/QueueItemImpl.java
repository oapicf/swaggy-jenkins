...
public class QueueItemImpl {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "expectedBuildNumber", "id", "pipeline", "queuedTime"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueueItemImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in QueueItemImpl is not found in the empty JSON string", QueueItemImpl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueueItemImpl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `QueueItemImpl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
