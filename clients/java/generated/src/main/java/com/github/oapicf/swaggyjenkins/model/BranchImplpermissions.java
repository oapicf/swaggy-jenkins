...
public class BranchImplpermissions {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("create", "read", "start", "stop", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchImplpermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BranchImplpermissions is not found in the empty JSON string", BranchImplpermissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchImplpermissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BranchImplpermissions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
