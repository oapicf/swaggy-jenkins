...
public class Pipeline {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "organization", "name", "displayName", "fullName", "weatherScore", "estimatedDurationInMillis", "latestRun"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Pipeline is not found in the empty JSON string", Pipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Pipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
