...
public class PipelinelatestRun {
  ...
  public PipelinelatestRun artifacts(@javax.annotation.Nullable List<PipelinelatestRunartifacts> artifacts) {
  ...
  public void setArtifacts(@javax.annotation.Nullable List<PipelinelatestRunartifacts> artifacts) {
    this.artifacts = artifacts;
  }


  public PipelinelatestRun durationInMillis(@javax.annotation.Nullable Integer durationInMillis) {
  ...
  public PipelinelatestRun estimatedDurationInMillis(@javax.annotation.Nullable Integer estimatedDurationInMillis) {
  ...
  public PipelinelatestRun enQueueTime(@javax.annotation.Nullable String enQueueTime) {
  ...
  public PipelinelatestRun endTime(@javax.annotation.Nullable String endTime) {
  ...
  public PipelinelatestRun id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PipelinelatestRun organization(@javax.annotation.Nullable String organization) {
  ...
  public PipelinelatestRun pipeline(@javax.annotation.Nullable String pipeline) {
  ...
  public PipelinelatestRun result(@javax.annotation.Nullable String result) {
    this.result = result;
    return this;
  }
  ...
  public PipelinelatestRun runSummary(@javax.annotation.Nullable String runSummary) {
  ...
  public PipelinelatestRun startTime(@javax.annotation.Nullable String startTime) {
  ...
  public PipelinelatestRun state(@javax.annotation.Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public PipelinelatestRun type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public PipelinelatestRun commitId(@javax.annotation.Nullable String commitId) {
  ...
  public PipelinelatestRun propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("artifacts", "durationInMillis", "estimatedDurationInMillis", "enQueueTime", "endTime", "id", "organization", "pipeline", "result", "runSummary", "startTime", "state", "type", "commitId", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelinelatestRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelinelatestRun is not found in the empty JSON string", PipelinelatestRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelinelatestRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelinelatestRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
