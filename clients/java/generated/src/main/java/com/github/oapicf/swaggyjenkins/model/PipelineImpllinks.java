...
public class PipelineImpllinks {
  ...
  public PipelineImpllinks self(@javax.annotation.Nullable Link self) {
    this.self = self;
    return this;
  }
  ...
  public PipelineImpllinks actions(@javax.annotation.Nullable Link actions) {
  ...
  public PipelineImpllinks runs(@javax.annotation.Nullable Link runs) {
    this.runs = runs;
    return this;
  }
  ...
  public PipelineImpllinks queue(@javax.annotation.Nullable Link queue) {
    this.queue = queue;
    return this;
  }
  ...
  public PipelineImpllinks propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineImpllinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelineImpllinks is not found in the empty JSON string", PipelineImpllinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineImpllinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelineImpllinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
