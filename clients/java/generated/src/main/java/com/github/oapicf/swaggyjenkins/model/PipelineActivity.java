...
public class PipelineActivity {
  ...
  public PipelineActivity propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  public PipelineActivity artifacts(@javax.annotation.Nullable List<PipelineActivityartifacts> artifacts) {
  ...
  public void setArtifacts(@javax.annotation.Nullable List<PipelineActivityartifacts> artifacts) {
    this.artifacts = artifacts;
  }


  public PipelineActivity durationInMillis(@javax.annotation.Nullable Integer durationInMillis) {
  ...
  public PipelineActivity estimatedDurationInMillis(@javax.annotation.Nullable Integer estimatedDurationInMillis) {
  ...
  public PipelineActivity enQueueTime(@javax.annotation.Nullable String enQueueTime) {
  ...
  public PipelineActivity endTime(@javax.annotation.Nullable String endTime) {
  ...
  public PipelineActivity id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PipelineActivity organization(@javax.annotation.Nullable String organization) {
  ...
  public PipelineActivity pipeline(@javax.annotation.Nullable String pipeline) {
  ...
  public PipelineActivity result(@javax.annotation.Nullable String result) {
    this.result = result;
    return this;
  }
  ...
  public PipelineActivity runSummary(@javax.annotation.Nullable String runSummary) {
  ...
  public PipelineActivity startTime(@javax.annotation.Nullable String startTime) {
  ...
  public PipelineActivity state(@javax.annotation.Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public PipelineActivity type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public PipelineActivity commitId(@javax.annotation.Nullable String commitId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelineActivity is not found in the empty JSON string", PipelineActivity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineActivity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelineActivity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
