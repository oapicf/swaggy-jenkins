...
public class PipelineBranchesitem {
  ...
  public PipelineBranchesitem displayName(@javax.annotation.Nullable String displayName) {
  ...
  public PipelineBranchesitem estimatedDurationInMillis(@javax.annotation.Nullable Integer estimatedDurationInMillis) {
  ...
  public PipelineBranchesitem name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PipelineBranchesitem weatherScore(@javax.annotation.Nullable Integer weatherScore) {
  ...
  public PipelineBranchesitem latestRun(@javax.annotation.Nullable PipelineBranchesitemlatestRun latestRun) {
  ...
  public void setLatestRun(@javax.annotation.Nullable PipelineBranchesitemlatestRun latestRun) {
    this.latestRun = latestRun;
  }


  public PipelineBranchesitem organization(@javax.annotation.Nullable String organization) {
  ...
  public PipelineBranchesitem pullRequest(@javax.annotation.Nullable PipelineBranchesitempullRequest pullRequest) {
  ...
  public void setPullRequest(@javax.annotation.Nullable PipelineBranchesitempullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }


  public PipelineBranchesitem totalNumberOfPullRequests(@javax.annotation.Nullable Integer totalNumberOfPullRequests) {
  ...
  public PipelineBranchesitem propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("displayName", "estimatedDurationInMillis", "name", "weatherScore", "latestRun", "organization", "pullRequest", "totalNumberOfPullRequests", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineBranchesitem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelineBranchesitem is not found in the empty JSON string", PipelineBranchesitem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineBranchesitem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelineBranchesitem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
