...
public class FreeStyleProjecthealthReport {
  ...
  public FreeStyleProjecthealthReport description(@javax.annotation.Nullable String description) {
  ...
  public FreeStyleProjecthealthReport iconClassName(@javax.annotation.Nullable String iconClassName) {
  ...
  public FreeStyleProjecthealthReport iconUrl(@javax.annotation.Nullable String iconUrl) {
  ...
  public FreeStyleProjecthealthReport score(@javax.annotation.Nullable Integer score) {
    this.score = score;
    return this;
  }
  ...
  public FreeStyleProjecthealthReport propertyClass(@javax.annotation.Nullable String propertyClass) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "iconClassName", "iconUrl", "score", "_class"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FreeStyleProjecthealthReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FreeStyleProjecthealthReport is not found in the empty JSON string", FreeStyleProjecthealthReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FreeStyleProjecthealthReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FreeStyleProjecthealthReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
