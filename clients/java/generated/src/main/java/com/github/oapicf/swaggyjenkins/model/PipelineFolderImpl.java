...
public class PipelineFolderImpl {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_class", "displayName", "fullName", "name", "organization", "numberOfFolders", "numberOfPipelines"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PipelineFolderImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PipelineFolderImpl is not found in the empty JSON string", PipelineFolderImpl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PipelineFolderImpl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PipelineFolderImpl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
