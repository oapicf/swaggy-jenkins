...
- API version: 3.0.2-pre.0
  - Build date: 2025-05-10T02:39:55.130842976Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.github.oapicf:swaggyjenkins:3.1.1-pre.0"
  }
```
...
* `target/swaggyjenkins-3.1.1-pre.0.jar`
* `target/lib/*.jar`
