...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}buildableStartMilliseconds`,
                label: `[${labelPrefix}buildableStartMilliseconds]`,
                type: 'integer',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'buildableStartMilliseconds': bundle.inputData?.[`${keyPrefix}buildableStartMilliseconds`],
        }
    },
}
