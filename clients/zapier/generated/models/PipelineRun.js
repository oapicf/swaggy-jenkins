...
const PipelineRunartifacts = require('../models/PipelineRunartifacts');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                children: PipelineRunartifacts.fields(`${keyPrefix}artifacts${!isInput ? '[]' : ''}`, isInput, true), 
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'artifacts': utils.childMapping(bundle.inputData?.[`${keyPrefix}artifacts`], `${keyPrefix}artifacts`, PipelineRunartifacts),
