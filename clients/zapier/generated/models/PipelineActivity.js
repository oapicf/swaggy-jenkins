...
const PipelineActivityartifacts = require('../models/PipelineActivityartifacts');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                children: PipelineActivityartifacts.fields(`${keyPrefix}artifacts${!isInput ? '[]' : ''}`, isInput, true), 
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'artifacts': utils.childMapping(bundle.inputData?.[`${keyPrefix}artifacts`], `${keyPrefix}artifacts`, PipelineActivityartifacts),
