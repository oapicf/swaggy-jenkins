...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PipelineRunImpl : IEquatable<PipelineRunImpl>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PipelineRunImpl);
        }

        /// <summary>
        /// Returns true if PipelineRunImpl instances are equal
        /// </summary>
        /// <param name="input">Instance of PipelineRunImpl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PipelineRunImpl input)
        {
            if (input == null)
            {
                return false;
