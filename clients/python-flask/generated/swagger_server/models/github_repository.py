...
from swagger_server.models.github_repositorylinks import GithubRepositorylinks
from swagger_server.models.github_repositorypermissions import GithubRepositorypermissions
...
class GithubRepository(Model):
    ...
    """
    def __init__(self, _class: str=None, links: GithubRepositorylinks=None, default_branch: str=None, description: str=None, name: str=None, permissions: GithubRepositorypermissions=None, private: bool=None, full_name: str=None):
        """
    ...
    def from_dict(cls, dikt) -> 'GithubRepository':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The GithubRepository of this GithubRepository.
