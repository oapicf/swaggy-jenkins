...
class PipelineRunImpllinks(Model):
    ...
    def __init__(self, nodes: Link=None, log: Link=None, _self: Link=None, actions: Link=None, steps: Link=None, _class: str=None):  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'PipelineRunImpllinks':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The PipelineRunImpllinks of this PipelineRunImpllinks.  # noqa: E501
