...
from openapi_server.models.input_step_impllinks import InputStepImpllinks  # noqa: E501
...
class InputStepImpl(Model):
    ...
    def __init__(self, _class=None, links=None, id=None, message=None, ok=None, parameters=None, submitter=None):  # noqa: E501
