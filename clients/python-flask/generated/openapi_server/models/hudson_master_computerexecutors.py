...
class HudsonMasterComputerexecutors(Model):
    ...
    def __init__(self, current_executable: FreeStyleBuild=None, idle: bool=None, likely_stuck: bool=None, number: int=None, progress: int=None, _class: str=None):  # noqa: E501
