...
class SwaggyjenkinsPipelineLatestRun 
{
     ...
     * @DTA\Strategy(name="ObjectArray", options={"type":\App\DTO\SwaggyjenkinsPipelineLatestRunartifacts::class})
     * @DTA\Validator(name="Collection", options={"validators":{
     *     {"name":"Dictionary", "options":{"type":\App\DTO\SwaggyjenkinsPipelineLatestRunartifacts::class}}
     * }})
     * @var \App\DTO\SwaggyjenkinsPipelineLatestRunartifacts[]
     */
    public $artifacts;
    /**
