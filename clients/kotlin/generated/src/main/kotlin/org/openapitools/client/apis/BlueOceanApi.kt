...
class BlueOceanApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    ...
    fun deletePipelineQueueItemRequestConfig(organization: kotlin.String, pipeline: kotlin.String, queue: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue/{queue}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"queue"+"}", "$queue"),
    ...
    fun getAuthenticatedUserRequestConfig(organization: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/blue/rest/organizations/{organization}/user/".replace("{"+"organization"+"}", "$organization"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getClassesRequestConfig(propertyClass: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/classes/{class}".replace("{"+"class"+"}", "$propertyClass"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getJsonWebKeyRequestConfig(key: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/jwt-auth/jwks/{key}".replace("{"+"key"+"}", "$key"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getOrganisationRequestConfig(organization: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}".replace("{"+"organization"+"}", "$organization"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRequestConfig(organization: kotlin.String, pipeline: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineActivitiesRequestConfig(organization: kotlin.String, pipeline: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/activities".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineBranchRequestConfig(organization: kotlin.String, pipeline: kotlin.String, branch: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches/{branch}/".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"branch"+"}", "$branch"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineBranchRunRequestConfig(organization: kotlin.String, pipeline: kotlin.String, branch: kotlin.String, run: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches/{branch}/runs/{run}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"branch"+"}", "$branch").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineBranchesRequestConfig(organization: kotlin.String, pipeline: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/branches".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineFolderRequestConfig(organization: kotlin.String, folder: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{folder}/".replace("{"+"organization"+"}", "$organization").replace("{"+"folder"+"}", "$folder"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineFolderPipelineRequestConfig(organization: kotlin.String, pipeline: kotlin.String, folder: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{folder}/pipelines/{pipeline}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"folder"+"}", "$folder"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineQueueRequestConfig(organization: kotlin.String, pipeline: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/queue".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunLogRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, start: kotlin.Int?, download: kotlin.Boolean?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/log".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunNodeRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, node: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run").replace("{"+"node"+"}", "$node"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunNodeStepRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, node: kotlin.String, step: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps/{step}".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run").replace("{"+"node"+"}", "$node").replace("{"+"step"+"}", "$step"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunNodeStepLogRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, node: kotlin.String, step: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps/{step}/log".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run").replace("{"+"node"+"}", "$node").replace("{"+"step"+"}", "$step"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunNodeStepsRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, node: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes/{node}/steps".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run").replace("{"+"node"+"}", "$node"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunNodesRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/nodes".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelineRunsRequestConfig(organization: kotlin.String, pipeline: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getPipelinesRequestConfig(organization: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/pipelines/".replace("{"+"organization"+"}", "$organization"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getSCMRequestConfig(organization: kotlin.String, scm: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/scm/{scm}".replace("{"+"organization"+"}", "$organization").replace("{"+"scm"+"}", "$scm"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getSCMOrganisationRepositoriesRequestConfig(organization: kotlin.String, scm: kotlin.String, scmOrganisation: kotlin.String, credentialId: kotlin.String?, pageSize: kotlin.Int?, pageNumber: kotlin.Int?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories".replace("{"+"organization"+"}", "$organization").replace("{"+"scm"+"}", "$scm").replace("{"+"scmOrganisation"+"}", "$scmOrganisation"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getSCMOrganisationRepositoryRequestConfig(organization: kotlin.String, scm: kotlin.String, scmOrganisation: kotlin.String, repository: kotlin.String, credentialId: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/scm/{scm}/organizations/{scmOrganisation}/repositories/{repository}".replace("{"+"organization"+"}", "$organization").replace("{"+"scm"+"}", "$scm").replace("{"+"scmOrganisation"+"}", "$scmOrganisation").replace("{"+"repository"+"}", "$repository"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getSCMOrganisationsRequestConfig(organization: kotlin.String, scm: kotlin.String, credentialId: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/scm/{scm}/organizations".replace("{"+"organization"+"}", "$organization").replace("{"+"scm"+"}", "$scm"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getUserRequestConfig(organization: kotlin.String, user: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/users/{user}".replace("{"+"organization"+"}", "$organization").replace("{"+"user"+"}", "$user"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getUserFavoritesRequestConfig(user: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/users/{user}/favorites".replace("{"+"user"+"}", "$user"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun getUsersRequestConfig(organization: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/blue/rest/organizations/{organization}/users/".replace("{"+"organization"+"}", "$organization"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun postPipelineRunRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/replay".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun putPipelineFavoriteRequestConfig(organization: kotlin.String, pipeline: kotlin.String, body: kotlin.Boolean) : RequestConfig<kotlin.Boolean> {
        ...
        return RequestConfig(
            ...
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/favorite".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    fun putPipelineRunRequestConfig(organization: kotlin.String, pipeline: kotlin.String, run: kotlin.String, blocking: kotlin.String?, timeOutInSecs: kotlin.Int?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.PUT,
            path = "/blue/rest/organizations/{organization}/pipelines/{pipeline}/runs/{run}/stop".replace("{"+"organization"+"}", "$organization").replace("{"+"pipeline"+"}", "$pipeline").replace("{"+"run"+"}", "$run"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
