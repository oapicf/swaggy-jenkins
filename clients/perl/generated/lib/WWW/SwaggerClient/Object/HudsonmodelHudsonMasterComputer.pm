...
#
package WWW::SwaggerClient::Object::HudsonmodelHudsonMasterComputer;
...
__PACKAGE__->method_documentation({
    ...
    'executors' => {
    	datatype => 'ARRAY[HudsonmodelHudsonMasterComputerexecutors]',
    	base_name => 'executors',
    	description => '',
    	format => '',
    	read_only => '',
    ...
    'monitor_data' => {
    	datatype => 'HudsonmodelHudsonMasterComputerMonitorData',
