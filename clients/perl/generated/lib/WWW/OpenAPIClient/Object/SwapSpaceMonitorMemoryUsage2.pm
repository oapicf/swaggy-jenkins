...
#
package WWW::OpenAPIClient::Object::SwapSpaceMonitorMemoryUsage2;
...
__PACKAGE__->method_documentation({
    ...
    'available_physical_memory' => {
        datatype => 'int',
        base_name => 'availablePhysicalMemory',
        description => '',
        format => '',
        read_only => '',
            },
