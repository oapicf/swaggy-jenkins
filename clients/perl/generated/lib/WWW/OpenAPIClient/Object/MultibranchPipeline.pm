...
#
package WWW::OpenAPIClient::Object::MultibranchPipeline;
...
__PACKAGE__->method_documentation({
    ...
    'number_of_failing_branches' => {
        datatype => 'int',
        base_name => 'numberOfFailingBranches',
        description => '',
        format => '',
        read_only => '',
            },
    'number_of_failing_pull_requests' => {
        datatype => 'int',
        base_name => 'numberOfFailingPullRequests',
        description => '',
        format => '',
        read_only => '',
            },
    'number_of_successful_branches' => {
        datatype => 'int',
        base_name => 'numberOfSuccessfulBranches',
        description => '',
        format => '',
        read_only => '',
            },
    'number_of_successful_pull_requests' => {
        datatype => 'int',
        base_name => 'numberOfSuccessfulPullRequests',
        description => '',
        format => '',
        read_only => '',
            },
    'total_number_of_branches' => {
        datatype => 'int',
        base_name => 'totalNumberOfBranches',
        description => '',
        format => '',
        read_only => '',
            },
    'total_number_of_pull_requests' => {
        datatype => 'int',
        base_name => 'totalNumberOfPullRequests',
        description => '',
        format => '',
        read_only => '',
            },
