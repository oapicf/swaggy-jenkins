...
OAIPipelinelatestRun::init() {
    artifacts = new QList<OAIPipelinelatestRunartifacts*>();
...
OAIPipelinelatestRun::fromJson(QString json) {
...
void
OAIPipelinelatestRun::fromJsonObject(QJsonObject pJson) {
    
    ::OpenAPI::setValue(&artifacts, pJson["artifacts"], "QList", "OAIPipelinelatestRunartifacts");
...
QJsonObject
OAIPipelinelatestRun::asJsonObject() {
    QJsonObject obj;
    if(artifacts->size() > 0){
        toJsonArray((QList<void*>*)artifacts, obj, "artifacts", "OAIPipelinelatestRunartifacts");
    }
...
OAIPipelinelatestRun::getArtifacts() {
    return artifacts;
}
void
OAIPipelinelatestRun::setArtifacts(QList<OAIPipelinelatestRunartifacts*>* artifacts) {
    this->artifacts = artifacts;
    this->m_artifacts_isSet = true;
}

qint32
OAIPipelinelatestRun::getDurationInMillis() {
    return duration_in_millis;
}
void
OAIPipelinelatestRun::setDurationInMillis(qint32 duration_in_millis) {
    this->duration_in_millis = duration_in_millis;
    this->m_duration_in_millis_isSet = true;
}

qint32
OAIPipelinelatestRun::getEstimatedDurationInMillis() {
    return estimated_duration_in_millis;
}
void
OAIPipelinelatestRun::setEstimatedDurationInMillis(qint32 estimated_duration_in_millis) {
    this->estimated_duration_in_millis = estimated_duration_in_millis;
    this->m_estimated_duration_in_millis_isSet = true;
}

QString*
OAIPipelinelatestRun::getEnQueueTime() {
    return en_queue_time;
}
void
OAIPipelinelatestRun::setEnQueueTime(QString* en_queue_time) {
    this->en_queue_time = en_queue_time;
    this->m_en_queue_time_isSet = true;
}

QString*
OAIPipelinelatestRun::getEndTime() {
    return end_time;
}
void
OAIPipelinelatestRun::setEndTime(QString* end_time) {
    this->end_time = end_time;
    this->m_end_time_isSet = true;
}

QString*
OAIPipelinelatestRun::getId() {
    return id;
}
void
OAIPipelinelatestRun::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

QString*
OAIPipelinelatestRun::getOrganization() {
    return organization;
}
void
OAIPipelinelatestRun::setOrganization(QString* organization) {
    this->organization = organization;
    this->m_organization_isSet = true;
}

QString*
OAIPipelinelatestRun::getPipeline() {
    return pipeline;
}
void
OAIPipelinelatestRun::setPipeline(QString* pipeline) {
    this->pipeline = pipeline;
    this->m_pipeline_isSet = true;
}

QString*
OAIPipelinelatestRun::getResult() {
    return result;
}
void
OAIPipelinelatestRun::setResult(QString* result) {
    this->result = result;
    this->m_result_isSet = true;
}

QString*
OAIPipelinelatestRun::getRunSummary() {
    return run_summary;
}
void
OAIPipelinelatestRun::setRunSummary(QString* run_summary) {
    this->run_summary = run_summary;
    this->m_run_summary_isSet = true;
}

QString*
OAIPipelinelatestRun::getStartTime() {
    return start_time;
}
void
OAIPipelinelatestRun::setStartTime(QString* start_time) {
    this->start_time = start_time;
    this->m_start_time_isSet = true;
}

QString*
OAIPipelinelatestRun::getState() {
    return state;
}
void
OAIPipelinelatestRun::setState(QString* state) {
    this->state = state;
    this->m_state_isSet = true;
}

QString*
OAIPipelinelatestRun::getType() {
    return type;
}
void
OAIPipelinelatestRun::setType(QString* type) {
    this->type = type;
    this->m_type_isSet = true;
}

QString*
OAIPipelinelatestRun::getCommitId() {
    return commit_id;
}
void
OAIPipelinelatestRun::setCommitId(QString* commit_id) {
    this->commit_id = commit_id;
    this->m_commit_id_isSet = true;
}

QString*
OAIPipelinelatestRun::getClass() {
    return _class;
}
void
OAIPipelinelatestRun::setClass(QString* _class) {
    this->_class = _class;
