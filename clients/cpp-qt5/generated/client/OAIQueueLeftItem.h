...
#ifndef OAIQueueLeftItem_H_
#define OAIQueueLeftItem_H_
...
public:
    ...
    OAIQueueLeftItem* fromJson(QString jsonString) override;
    ...
    OAIFreeStyleBuild* getExecutable();
    void setExecutable(OAIFreeStyleBuild* executable);
