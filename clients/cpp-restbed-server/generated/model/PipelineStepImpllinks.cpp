...
PipelineStepImpllinks::~PipelineStepImpllinks = default;
...
ptree PipelineStepImpllinks::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PipelineStepImpllinks::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void PipelineStepImpllinks::setSelf(Link value)
{
    m_Self = value;
}
...
void PipelineStepImpllinks::setActions(Link value)
{
    m_Actions = value;
}
