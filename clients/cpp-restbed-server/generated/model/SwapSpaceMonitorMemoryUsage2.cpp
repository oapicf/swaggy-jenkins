...
SwapSpaceMonitorMemoryUsage2::~SwapSpaceMonitorMemoryUsage2 = default;
...
ptree SwapSpaceMonitorMemoryUsage2::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void SwapSpaceMonitorMemoryUsage2::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
