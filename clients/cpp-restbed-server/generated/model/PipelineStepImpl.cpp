...
ptree PipelineStepImpl::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PipelineStepImpl::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m__class = pt.get("_class", "");
	if (pt.get_child_optional("_links")) {
        m__links = fromPt<PipelineStepImpllinks>(pt.get_child("_links"));
	}
	m_DisplayName = pt.get("displayName", "");
	m_DurationInMillis = pt.get("durationInMillis", 0);
	m_Id = pt.get("id", "");
	if (pt.get_child_optional("input")) {
        m_Input = fromPt<InputStepImpl>(pt.get_child("input"));
	}
...
PipelineStepImpllinks PipelineStepImpl::get_Links() const
{
    return m__links;
}

void PipelineStepImpl::set_Links(PipelineStepImpllinks value)
{
    m__links = value;
}
...
void PipelineStepImpl::setInput(InputStepImpl value)
{
    m_Input = value;
}
