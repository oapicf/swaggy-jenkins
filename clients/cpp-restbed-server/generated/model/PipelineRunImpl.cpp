...
ptree PipelineRunImpl::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PipelineRunImpl::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m__class = pt.get("_class", "");
	if (pt.get_child_optional("_links")) {
        m__links = fromPt<PipelineRunImpllinks>(pt.get_child("_links"));
	}
...
PipelineRunImpllinks PipelineRunImpl::get_Links() const
{
    return m__links;
}

void PipelineRunImpl::set_Links(PipelineRunImpllinks value)
{
    m__links = value;
}
