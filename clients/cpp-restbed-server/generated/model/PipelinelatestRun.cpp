...
ptree PipelinelatestRun::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void PipelinelatestRun::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	// push all items of Artifacts into member
	if (pt.get_child_optional("artifacts")) {
        m_Artifacts = fromPt<std::vector<PipelinelatestRunartifacts>>(pt.get_child("artifacts"));
	}
...
void PipelinelatestRun::setArtifacts(std::vector<PipelinelatestRunartifacts> value)
{
    m_Artifacts = value;
}
