...
Protected Class BranchImpl
	...
	#tag Property, Flags = &h0
		parameters() As OpenAPIClient.Models.StringParameterDefinition
	#tag EndProperty


	#tag Property, Flags = &h0
		permissions As OpenAPIClient.Models.BranchImplpermissions
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		pullRequest As Xoson.O.OptionalString
	#tag EndProperty


	#tag Property, Flags = &h0
		_links As OpenAPIClient.Models.BranchImpllinks
	#tag EndProperty


	#tag Property, Flags = &h0
		latestRun As OpenAPIClient.Models.PipelineRunImpl
	#tag EndProperty
