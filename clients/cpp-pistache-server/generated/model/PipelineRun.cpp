...
void PipelineRun::validate() const
{
...
bool PipelineRun::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool PipelineRun::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PipelineRun" : pathPrefix;

             
    if (artifactsIsSet())
    {
        const std::vector<org::openapitools::server::model::PipelineRunartifacts>& value = m_Artifacts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::PipelineRunartifacts& value : value)
            { 
...
bool PipelineRun::operator==(const PipelineRun& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const PipelineRun& o)
{
...
void from_json(const nlohmann::json& j, PipelineRun& o)
{
...
std::vector<org::openapitools::server::model::PipelineRunartifacts> PipelineRun::getArtifacts() const
{
    return m_Artifacts;
}
void PipelineRun::setArtifacts(std::vector<org::openapitools::server::model::PipelineRunartifacts> const& value)
{
    m_Artifacts = value;
