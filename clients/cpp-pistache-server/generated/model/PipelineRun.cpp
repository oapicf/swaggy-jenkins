...
bool PipelineRun::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (artifactsIsSet())
    {
        const std::vector<PipelineRunartifacts>& value = m_Artifacts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const PipelineRunartifacts& value : value)
            { 
...
void PipelineRun::setArtifacts(std::vector<PipelineRunartifacts> const& value)
{
    m_Artifacts = value;
