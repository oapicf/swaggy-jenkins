...
public:
    ...
    void setActions(std::vector<FreeStyleProjectactions> const& value);
    ...
    void setBuilds(std::vector<FreeStyleBuild> const& value);
    ...
    void setHealthReport(std::vector<FreeStyleProjecthealthReport> const& value);
