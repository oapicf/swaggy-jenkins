...
bool FreeStyleProject::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (actionsIsSet())
    {
        const std::vector<FreeStyleProjectactions>& value = m_Actions;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const FreeStyleProjectactions& value : value)
            { 
    ...
    if (buildsIsSet())
    {
        const std::vector<FreeStyleBuild>& value = m_Builds;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const FreeStyleBuild& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<FreeStyleProjecthealthReport>& value = m_HealthReport;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const FreeStyleProjecthealthReport& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
void FreeStyleProject::setActions(std::vector<FreeStyleProjectactions> const& value)
{
    m_Actions = value;
    m_ActionsIsSet = true;
}
...
void FreeStyleProject::setBuilds(std::vector<FreeStyleBuild> const& value)
{
    m_Builds = value;
    m_BuildsIsSet = true;
}
...
void FreeStyleProject::setHealthReport(std::vector<FreeStyleProjecthealthReport> const& value)
{
