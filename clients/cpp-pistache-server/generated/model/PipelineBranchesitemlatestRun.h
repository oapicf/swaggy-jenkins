...
public:
    ...
    bool operator==(const PipelineBranchesitemlatestRun& rhs) const;
    bool operator!=(const PipelineBranchesitemlatestRun& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PipelineBranchesitemlatestRun& o);
    friend  void from_json(const nlohmann::json& j, PipelineBranchesitemlatestRun& o);
protected:
