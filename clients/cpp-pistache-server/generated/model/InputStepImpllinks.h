...
public:
    ...
    bool operator==(const InputStepImpllinks& rhs) const;
    bool operator!=(const InputStepImpllinks& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const InputStepImpllinks& o);
    friend  void from_json(const nlohmann::json& j, InputStepImpllinks& o);
protected:
