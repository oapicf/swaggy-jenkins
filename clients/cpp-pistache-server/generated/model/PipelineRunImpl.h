...
public:
    ...
    bool operator==(const PipelineRunImpl& rhs) const;
    bool operator!=(const PipelineRunImpl& rhs) const;
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::PipelineRunImpllinks getLinks() const;
    void setLinks(org::openapitools::server::model::PipelineRunImpllinks const& value);
    ...
    friend  void to_json(nlohmann::json& j, const PipelineRunImpl& o);
    friend  void from_json(const nlohmann::json& j, PipelineRunImpl& o);
protected:
    std::string m__class;
    bool m__classIsSet;
    org::openapitools::server::model::PipelineRunImpllinks m__links;
    bool m__linksIsSet;
