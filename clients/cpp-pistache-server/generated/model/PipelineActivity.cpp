...
bool PipelineActivity::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (artifactsIsSet())
    {
        const std::vector<PipelineActivityartifacts>& value = m_Artifacts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const PipelineActivityartifacts& value : value)
            { 
...
void PipelineActivity::setArtifacts(std::vector<PipelineActivityartifacts> const& value)
{
    m_Artifacts = value;
