...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::HudsonMasterComputer> getComputer() const;
    void setComputer(std::vector<org::openapitools::server::model::HudsonMasterComputer> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::HudsonMasterComputer> m_Computer;
