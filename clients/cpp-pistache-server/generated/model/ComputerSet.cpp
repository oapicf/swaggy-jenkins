...
bool ComputerSet::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (computerIsSet())
    {
        const std::vector<HudsonMasterComputer>& value = m_Computer;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const HudsonMasterComputer& value : value)
            { 
...
void ComputerSet::setComputer(std::vector<HudsonMasterComputer> const& value)
{
    m_Computer = value;
