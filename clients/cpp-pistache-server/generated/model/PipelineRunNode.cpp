...
bool PipelineRunNode::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (edgesIsSet())
    {
        const std::vector<PipelineRunNodeedges>& value = m_Edges;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const PipelineRunNodeedges& value : value)
            { 
...
void PipelineRunNode::setEdges(std::vector<PipelineRunNodeedges> const& value)
{
    m_Edges = value;
    m_EdgesIsSet = true;
}
