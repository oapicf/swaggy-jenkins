...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::PipelineActivityartifacts> getArtifacts() const;
    void setArtifacts(std::vector<org::openapitools::server::model::PipelineActivityartifacts> const& value);
...
protected:
    std::string m__class;
    bool m__classIsSet;
    std::vector<org::openapitools::server::model::PipelineActivityartifacts> m_Artifacts;
