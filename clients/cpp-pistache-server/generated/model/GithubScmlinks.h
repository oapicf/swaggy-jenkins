...
public:
    ...
    bool operator==(const GithubScmlinks& rhs) const;
    bool operator!=(const GithubScmlinks& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GithubScmlinks& o);
    friend  void from_json(const nlohmann::json& j, GithubScmlinks& o);
protected:
