...
bool PipelinelatestRun::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (artifactsIsSet())
    {
        const std::vector<PipelinelatestRunartifacts>& value = m_Artifacts;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const PipelinelatestRunartifacts& value : value)
            { 
...
void PipelinelatestRun::setArtifacts(std::vector<PipelinelatestRunartifacts> const& value)
{
    m_Artifacts = value;
