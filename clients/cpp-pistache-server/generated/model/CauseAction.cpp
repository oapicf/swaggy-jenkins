...
bool CauseAction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (causesIsSet())
    {
        const std::vector<CauseUserIdCause>& value = m_Causes;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const CauseUserIdCause& value : value)
            { 
...
void CauseAction::setCauses(std::vector<CauseUserIdCause> const& value)
{
    m_Causes = value;
    m_CausesIsSet = true;
}
