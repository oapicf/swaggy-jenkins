...
public:
    ...
    bool operator==(const PipelineRunartifacts& rhs) const;
    bool operator!=(const PipelineRunartifacts& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PipelineRunartifacts& o);
    friend  void from_json(const nlohmann::json& j, PipelineRunartifacts& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
    int32_t m_Size;
