...
public:
    ...
    bool operator==(const GithubRespositoryContainerlinks& rhs) const;
    bool operator!=(const GithubRespositoryContainerlinks& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const GithubRespositoryContainerlinks& o);
    friend  void from_json(const nlohmann::json& j, GithubRespositoryContainerlinks& o);
protected:
