...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::GithubOrganizationlinks getLinks() const;
    void setLinks(org::openapitools::server::model::GithubOrganizationlinks const& value);
...
protected:
    std::string m__class;
    bool m__classIsSet;
    org::openapitools::server::model::GithubOrganizationlinks m__links;
    bool m__linksIsSet;
