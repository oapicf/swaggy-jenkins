...
Rails.application.routes.draw do
  ...
  add_openapi_route 'GET', '//crumbIssuer/api/json', controller_name: 'base_remote_access', action_name: 'get_crumb'
  ...
  add_openapi_route 'GET', '//crumbIssuer/api/json', controller_name: 'remote_access', action_name: 'get_crumb'
