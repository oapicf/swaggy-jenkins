...
export class BlueOceanApi {
     ...
     */
    public getAuthenticatedUser (organisation: string) : JQueryPromise<{ response: JQueryXHR; body: SwaggyjenkinsUser;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/user/'
        ...
        $.ajax(requestOptions).then(
            (data: SwaggyjenkinsUser, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    public getClasses (_class: string) : JQueryPromise<{ response: JQueryXHR; body: string;  }> {
        let localVarPath = this.basePath + '/blue/rest/classes/{class}'
     ...
     * @param organisation Name of the organisation
     */
    public getOrganisation (organisation: string) : JQueryPromise<{ response: JQueryXHR; body: SwaggyjenkinsOrganisation;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}'
            .replace('{' + 'organisation' + '}', String(organisation));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: SwaggyjenkinsOrganisation, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getOrganisations () : JQueryPromise<{ response: JQueryXHR; body: GetOrganisations;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: GetOrganisations, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getPipelineBranchByOrg (organisation: string, pipeline: string, branch: string) : JQueryPromise<{ response: JQueryXHR; body: IojenkinsblueoceanrestimplpipelineBranchImpl;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/{pipeline}/branches/{branch}/'
            .replace('{' + 'organisation' + '}', String(organisation))
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: IojenkinsblueoceanrestimplpipelineBranchImpl, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param pipeline Name of the pipeline
     */
    public getPipelineBranchesByOrg (organisation: string, pipeline: string) : JQueryPromise<{ response: JQueryXHR; body: GetMultibranchPipeline;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/{pipeline}/branches'
            .replace('{' + 'organisation' + '}', String(organisation))
            .replace('{' + 'pipeline' + '}', String(pipeline));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: GetMultibranchPipeline, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param pipeline Name of the pipeline
     */
    public getPipelineByOrg (organisation: string, pipeline: string) : JQueryPromise<{ response: JQueryXHR; body: SwaggyjenkinsPipeline;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/{pipeline}'
            .replace('{' + 'organisation' + '}', String(organisation))
            .replace('{' + 'pipeline' + '}', String(pipeline));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: SwaggyjenkinsPipeline, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getPipelineFolderByOrg (organisation: string, folder: string) : JQueryPromise<{ response: JQueryXHR; body: IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/{folder}/'
            .replace('{' + 'organisation' + '}', String(organisation))
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: IojenkinsblueoceanserviceembeddedrestPipelineFolderImpl, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param folder Name of the folder
     */
    public getPipelineFolderByOrg_1 (organisation: string, pipeline: string, folder: string) : JQueryPromise<{ response: JQueryXHR; body: IojenkinsblueoceanserviceembeddedrestPipelineImpl;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/{folder}/pipelines/{pipeline}'
            .replace('{' + 'organisation' + '}', String(organisation))
            .replace('{' + 'pipeline' + '}', String(pipeline))
            .replace('{' + 'folder' + '}', String(folder));
        let queryParameters: any = {};
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: IojenkinsblueoceanserviceembeddedrestPipelineImpl, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param organisation Name of the organisation
     */
    public getPipelinesByOrg (organisation: string) : JQueryPromise<{ response: JQueryXHR; body: GetPipelines;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/pipelines/'
            .replace('{' + 'organisation' + '}', String(organisation));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: GetPipelines, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getUser (organisation: string, user: string) : JQueryPromise<{ response: JQueryXHR; body: SwaggyjenkinsUser;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/users/{user}'
            .replace('{' + 'organisation' + '}', String(organisation))
     ...
     * @param organisation Name of the organisation
     */
    public getUsers (organisation: string) : JQueryPromise<{ response: JQueryXHR; body: SwaggyjenkinsUser;  }> {
        let localVarPath = this.basePath + '/blue/rest/organizations/{organisation}/users/'
            .replace('{' + 'organisation' + '}', String(organisation));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     */
    public search_2 (q: string) : JQueryPromise<{ response: JQueryXHR; body: string;  }> {
...
export class RemoteAccessApi {
     ...
     */
    public getComputer () : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelComputerSet;  }> {
        let localVarPath = this.basePath + '/computer/api/json?depth=1';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelComputerSet, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getCrumb () : JQueryPromise<{ response: JQueryXHR; body: HudsonsecuritycsrfDefaultCrumbIssuer;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonsecuritycsrfDefaultCrumbIssuer, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getJenkins () : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelHudson;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelHudson, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getJob (name: string) : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelFreeStyleProject;  }> {
        let localVarPath = this.basePath + '/job/{name}/api/json'
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelFreeStyleProject, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param name Name of the job
     */
    public getJobConfig (name: string) : JQueryPromise<{ response: JQueryXHR; body: string;  }> {
        let localVarPath = this.basePath + '/job/{name}/config.xml'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param name Name of the job
     */
    public getJobLastBuild (name: string) : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelFreeStyleBuild;  }> {
        let localVarPath = this.basePath + '/job/{name}/lastBuild/api/json'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelFreeStyleBuild, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getJobProgressiveText (name: string, number: string, start: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/{number}/logText/progressiveText'
            .replace('{' + 'name' + '}', String(name))
     ...
     */
    public getQueue () : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelQueue;  }> {
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelQueue, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     */
    public getQueueItem (number: string) : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelQueue;  }> {
        let localVarPath = this.basePath + '/queue/item/{number}/api/json'
            .replace('{' + 'number' + '}', String(number));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     */
    public getView (name: string) : JQueryPromise<{ response: JQueryXHR; body: HudsonmodelListView;  }> {
        let localVarPath = this.basePath + '/view/{name}/api/json'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        ...
        let dfd = $.Deferred();
        $.ajax(requestOptions).then(
            (data: HudsonmodelListView, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({ response: jqXHR, body: data }),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({ response: xhr, body: errorThrown })
        );
     ...
     * @param name Name of the view
     */
    public getViewConfig (name: string) : JQueryPromise<{ response: JQueryXHR; body: string;  }> {
        let localVarPath = this.basePath + '/view/{name}/config.xml'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     */
    public headJenkins () : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/api/json';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     */
    public postCreateItem (name: string, from?: string, mode?: string, body?: string, jenkinsCrumb?: string, contentType?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     * @param contentType Content type header application/xml
     */
    public postCreateView (name: string, body?: string, jenkinsCrumb?: string, contentType?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobBuild (name: string, json: string, token?: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/build'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobConfig (name: string, body: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/config.xml'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobDelete (name: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/doDelete'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobDisable (name: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/disable'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobEnable (name: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/enable'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postJobLastBuildStop (name: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/job/{name}/lastBuild/stop'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param jenkinsCrumb CSRF protection token
     */
    public postViewConfig (name: string, body: string, jenkinsCrumb?: string) : JQueryPromise<{ response: JQueryXHR; body?: any;  }> {
        let localVarPath = this.basePath + '/view/{name}/config.xml'
            .replace('{' + 'name' + '}', String(name));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
