...
module BlueOceanApiServiceImplementation =
    ...
    type BlueOceanApiServiceImpl() =
      interface IBlueOceanApiService with
        ...
        member this.DeletePipelineQueueItem () =
          if true then
        ...
        member this.GetPipelineActivities () =
          if true then
        ...
        member this.GetPipelineBranchRun () =
          if true then
        ...
        member this.GetPipelineBranches () =
          if true then
        ...
        member this.GetPipelineFolderPipeline () =
          if true then
        ...
        member this.GetPipelineRunNode () =
          if true then
        ...
        member this.GetPipelineRunNodeStep () =
          if true then
        ...
        member this.GetPipelineRunNodeStepLog () =
          if true then
        ...
        member this.GetPipelineRunNodeSteps () =
          if true then
        ...
        member this.GetPipelineRunNodes () =
          if true then
        ...
        member this.GetSCMOrganisationRepositories () =
          if true then
        ...
        member this.GetSCMOrganisationRepository () =
          if true then
        ...
        member this.GetSCMOrganisations () =
          if true then
            let content = "Successfully retrieved SCM organizations details" :> obj :?> GithubOrganization[] // this cast is obviously wrong, and is only intended to allow generated project to compile   
        ...
        member this.PutPipelineFavorite (parameters:PutPipelineFavoriteBodyParams) =
          if true then
