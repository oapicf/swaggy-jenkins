...
void
OAIInputStepImpllinks::fromJson(QString jsonString) {
...
void
OAIInputStepImpllinks::fromJsonObject(QJsonObject json) {
...
QString
OAIInputStepImpllinks::asJson () const {
...
QJsonObject
OAIInputStepImpllinks::asJsonObject() const {
    QJsonObject obj;
	if(self.isSet()){
...
OAILink
OAIInputStepImpllinks::getSelf() const {
    return self;
}
void
OAIInputStepImpllinks::setSelf(const OAILink &self) {
    this->self = self;
    this->m_self_isSet = true;
}

QString
OAIInputStepImpllinks::getClass() const {
    return _class;
}
void
OAIInputStepImpllinks::setClass(const QString &_class) {
    this->_class = _class;
...
bool
OAIInputStepImpllinks::isSet() const {
