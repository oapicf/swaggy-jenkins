...
void OAIBlueOceanApiHandler::getClasses(QString _class) {
    Q_UNUSED(_class);
    auto reqObj = qobject_cast<OAIBlueOceanApiRequest*>(sender());
    if( reqObj != nullptr ) 
    { 
...
void OAIBlueOceanApiHandler::putPipelineFavorite(QString organization, QString pipeline, OAIBody oai_body) {
    Q_UNUSED(organization);
    Q_UNUSED(pipeline);
    Q_UNUSED(oai_body);
    auto reqObj = qobject_cast<OAIBlueOceanApiRequest*>(sender());
