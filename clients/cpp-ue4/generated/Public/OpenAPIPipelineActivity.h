...
/*
 * OpenAPIPipelineActivity
 *
 * 
 */
class OPENAPI_API OpenAPIPipelineActivity : public Model
{
public:
    virtual ~OpenAPIPipelineActivity() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	TOptional<FString> _Class;
	TOptional<TArray<OpenAPIPipelineActivityartifacts>> Artifacts;
