...
#include "OpenAPIPipelinelatestRunartifacts.h"

namespace OpenAPI
{

/*
 * OpenAPIPipelinelatestRun
 *
 * 
 */
class OPENAPI_API OpenAPIPipelinelatestRun : public Model
{
public:
    virtual ~OpenAPIPipelinelatestRun() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	TOptional<TArray<OpenAPIPipelinelatestRunartifacts>> Artifacts;
