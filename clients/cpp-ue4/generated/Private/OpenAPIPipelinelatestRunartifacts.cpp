...
void OpenAPIPipelinelatestRunartifacts::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPipelinelatestRunartifacts::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
