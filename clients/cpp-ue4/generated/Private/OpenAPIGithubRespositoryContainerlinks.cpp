...
void OpenAPIGithubRespositoryContainerlinks::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGithubRespositoryContainerlinks::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
