...
void OpenAPIExtensionClassImpllinks::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIExtensionClassImpllinks::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
