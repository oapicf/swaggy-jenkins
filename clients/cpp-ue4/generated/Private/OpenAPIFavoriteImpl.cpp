...
void OpenAPIFavoriteImpl::WriteJson(JsonWriter& Writer) const
{
	...
	if (Item.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("item")); WriteJsonValue(Writer, Item.GetValue());
	}
	Writer->WriteObjectEnd();
}

bool OpenAPIFavoriteImpl::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
