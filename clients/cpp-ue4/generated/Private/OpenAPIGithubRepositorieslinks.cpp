...
void OpenAPIGithubRepositorieslinks::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGithubRepositorieslinks::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
