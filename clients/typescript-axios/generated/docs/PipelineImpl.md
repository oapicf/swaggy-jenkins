...
**latestRun** | **string** |  | [optional] [default to undefined]
**name** | **string** |  | [optional] [default to undefined]
**organization** | **string** |  | [optional] [default to undefined]
**weatherScore** | **number** |  | [optional] [default to undefined]
**_links** | [**PipelineImpllinks**](PipelineImpllinks.md) |  | [optional] [default to undefined]

## Example

```typescript
import { PipelineImpl } from './api';

const instance: PipelineImpl = {
    _class,
    displayName,
