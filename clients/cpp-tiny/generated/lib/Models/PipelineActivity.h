...
#ifndef TINY_CPP_CLIENT_PipelineActivity_H_
#define TINY_CPP_CLIENT_PipelineActivity_H_
...
public:
	 ...
	 */
    PipelineActivity();
    PipelineActivity(std::string jsonString);
	...
	/*! \brief Get 
	 */
	std::list<PipelineActivityartifacts> getArtifacts();

	/*! \brief Set 
	 */
	void setArtifacts(std::list <PipelineActivityartifacts> artifacts);
	/*! \brief Get 
	 */
    ...
    private:
    std::string _class{};
    std::list<PipelineActivityartifacts> artifacts;
...
#endif /* TINY_CPP_CLIENT_PipelineActivity_H_ */
