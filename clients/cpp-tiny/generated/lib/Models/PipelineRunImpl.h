...
#ifndef TINY_CPP_CLIENT_PipelineRunImpl_H_
#define TINY_CPP_CLIENT_PipelineRunImpl_H_
...
public:
	 ...
	 */
    PipelineRunImpl();
    PipelineRunImpl(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PipelineRunImpl_H_ */
