...
public class CreateViewApiServiceImpl extends CreateViewApiService {
    @Override
    public Response postCreateView( @NotNull String name, String body, String jenkinsCrumb, String contentType, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
