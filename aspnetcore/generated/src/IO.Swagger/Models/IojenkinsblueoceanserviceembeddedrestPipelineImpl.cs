...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IojenkinsblueoceanserviceembeddedrestPipelineImpl :  IEquatable<IojenkinsblueoceanserviceembeddedrestPipelineImpl>
    {
        ...
        public IojenkinsblueoceanserviceembeddedrestPipelineImpl(string Class = default(string), string DisplayName = default(string), int? EstimatedDurationInMillis = default(int?), string FullName = default(string), string LatestRun = default(string), string Name = default(string), string Organization = default(string), int? WeatherScore = default(int?))
        {
            this.Class = Class;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((IojenkinsblueoceanserviceembeddedrestPipelineImpl)obj);
        }
