...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IojenkinsblueoceanresthalLink :  IEquatable<IojenkinsblueoceanresthalLink>
    {
        ...
        public IojenkinsblueoceanresthalLink(string Class = default(string), string Href = default(string))
        {
            this.Class = Class;
            this.Href = Href;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((IojenkinsblueoceanresthalLink)obj);
        }
