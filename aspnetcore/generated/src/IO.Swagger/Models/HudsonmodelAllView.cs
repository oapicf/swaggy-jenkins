...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class HudsonmodelAllView :  IEquatable<HudsonmodelAllView>
    {
        ...
        public HudsonmodelAllView(string Class = default(string), string Name = default(string), string Url = default(string))
        {
            this.Class = Class;
            this.Name = Name;
            this.Url = Url;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((HudsonmodelAllView)obj);
        }
